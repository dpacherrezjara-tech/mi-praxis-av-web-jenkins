 ...
 * @author lremicio
 */
public class A1933 implements Serializable {
    ...
    public String MDACPN = "";
    public float VCPN = 0;
    public float VCPNMXN = 0;
    public float VCPNUSD = 0;
    public int SEATS = 0;
    //public int SEATS = 0;
    ...
    public String getFOPERZUL() {
        return FOPERZUL;
    }

    public void setFOPERZUL(String FOPERZUL) {
        this.FOPERZUL = FOPERZUL;
    }
    ...
    public String getMDACPN() {
        return MDACPN;
    }

    public void setMDACPN(String MDACPN) {
        this.MDACPN = MDACPN;
    }

    public float getVCPN() {
        return VCPN;
    }

    public void setVCPN(float VCPN) {
        this.VCPN = VCPN;
    }
