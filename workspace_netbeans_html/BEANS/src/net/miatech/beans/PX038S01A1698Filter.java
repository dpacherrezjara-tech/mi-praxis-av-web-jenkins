 ...
 * @author rmayta
 */
public class PX038S01A1698Filter extends A1698 {
    ...
    public double ARC_TAX = 0;
    public double ARC_COMM = 0;
    ...
    public double TOT_CASH_ARC = 0;
    public double TOT_CREDIT_ARC = 0;
