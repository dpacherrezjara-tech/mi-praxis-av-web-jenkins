...
//import net.miatech.praxis.logic.payments.LoadControlLogic;
...
//        return "sales/LoadControl/form_index";
//    }
//
//    @RequestMapping(value = "search")
//    public @ResponseBody
//    String search(ModelMap map, HttpServletRequest request) {
//        System.out.println("-------------- LoadControl : Search-------------");
...
////        System.out.println("LoadControl : getXLSX");
////
////        String fileNameDownload = String.format("LoadControl - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
////
////        try {
////
////            Workbook workbook;
...
////        
////        System.out.println("-------------- LoadControl : MaintenanceA2353-------------");
////        
////        String option;
////        String beanString;
////        Gson gson = new Gson();
...
////        System.out.println("-------------- LoadControl : searchCompleteDetail-------------");
////
////        Gson gson = new Gson();
////        A2353Filter filter = new A2353Filter();
