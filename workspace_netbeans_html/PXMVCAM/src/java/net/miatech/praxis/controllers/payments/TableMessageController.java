...
public class TableMessageController extends BaseController {
    ...
    private TableMessageLogic logic;
    ...
    public String index(ModelMap map) {
        ...
        return "sales/TableMessage/form_index";
    }

    @RequestMapping(value = "search")
    public @ResponseBody
    String search(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- TableMessage : Search-------------");
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("TableMessage : getXLSX");

        String fileNameDownload = String.format("TableMessage - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
...
//            sheet.autoSizeColumn(6, true);
    ...
    String MaintenanceA2353(ModelMap map, HttpServletRequest request) {
        ...
        System.out.println("-------------- TableMessage : MaintenanceA2353-------------");
