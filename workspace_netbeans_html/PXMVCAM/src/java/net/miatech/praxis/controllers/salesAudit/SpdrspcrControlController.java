...
import net.miatech.praxis.logic.salesAudit.SpdrspcrControlLogic;
...
@Controller
@Scope("request")
@RequestMapping("/SpdrspcrControl")
public class SpdrspcrControlController extends BaseController{
    ...
    String Search(ModelMap map, HttpServletRequest request) {
        A3540Filter filter = new A3540Filter();
        try {
            ...
            List<A3540Filter> lst_search = logic.Search(filter);
    ...
    String SearchDebitosDetail(ModelMap map, HttpServletRequest request) {
        ...
        try {
            ...
            SpdrspcrControlLogic logic = new SpdrspcrControlLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3540Filter> lst_search = logic.SearchDetail(filter);
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            Sheet sheet = workbook.createSheet("ControlRobotsSpcrSpdr");
...
//            headerStyle.setFillForegroundColor(IndexedColors.BLUE_GREY.getIndex());
            ...
            CH_03.setCellValue("Issue Date");
            CH_04.setCellValue("TDNR");
            CH_05.setCellValue("Related <br> TDNR");
            CH_06.setCellValue("currency");
            CH_07.setCellValue("Amount");
            CH_08.setCellValue("Reason");
            ...
            while (iter.hasNext()) {
                ...
                CH_00.setCellValue(listaData.get(vi).A3540TYPE);
                CH_01.setCellValue(listaData.get(vi).A3540FREGI);
                CH_02.setCellValue(listaData.get(vi).A3540PAIS);
                CH_03.setCellValue(listaData.get(vi).A3540FMEMO);
                CH_04.setCellValue(listaData.get(vi).A3540NMEMO);

                CH_05.setCellValue(listaData.get(vi).A3540RMEMO);
                CH_06.setCellValue(listaData.get(vi).A3540CUR);
                CH_07.setCellValue(listaData.get(vi).A3540NETO);
                CH_08.setCellValue(listaData.get(vi).A3540DESCR);
                CH_09.setCellValue(listaData.get(vi).A3540STATU);
            ...
            String fileNameDownload = String.format("ControlRobotsSpcrSpdr - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
