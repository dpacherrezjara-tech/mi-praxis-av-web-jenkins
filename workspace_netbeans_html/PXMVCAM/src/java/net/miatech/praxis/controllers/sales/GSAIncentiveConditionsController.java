...
import net.miatech.praxis.logic.sales.GSAIncentiveConditionsLogic;
...
@Controller
@Scope("request")
@RequestMapping("/GSAIncentiveConditions")
public class GSAIncentiveConditionsController extends BaseController {

    private GSAIncentiveConditionsLogic logic;
    private PX132S01A1774Filter filter;
    private MasterDAO masterDAO;
    
    @RequestMapping(value = "/loadSearch")
    public @ResponseBody
    String loadSearch(ModelMap map, HttpServletRequest request) {
        List<PX132S01A1774Filter> listaData;
        filter = new PX132S01A1774Filter();
        ...
        try {
            ...
            logic = new GSAIncentiveConditionsLogic();
            logic.setSession((IServerSession) serverSession.getServerSession());
            listaData = logic.loadPX132S01A1774(filter);
...
//            headerStyle.setFillForegroundColor(IndexedColors.BLUE_GREY.getIndex());
            ...
            CH1_03.setCellValue("Range");
            Cell CH1_05 = row.createCell(5);
            CH1_05.setCellValue("Commision %");
            Cell CH1_07 = row.createCell(7);
            CH1_07.setCellValue("Aplication");
            Cell CH1_09 = row.createCell(9);
            CH1_09.setCellValue("Net Exclude");
            Cell CH1_10 = row.createCell(10);
            CH1_10.setCellValue("Validity Date");
...
//            sheet.autoSizeColumn(4, true);
            ...
            CH2_03.setCellValue("Initial");
            Cell CH2_04 = row2.createCell(4);
            CH2_04.setCellValue("Final");
            Cell CH2_05 = row2.createCell(5);
            CH2_05.setCellValue("Annual");
            Cell CH2_06 = row2.createCell(6);
            CH2_06.setCellValue("Monthly");
            Cell CH2_07 = row2.createCell(7);
            CH2_07.setCellValue("Year");
            Cell CH2_08 = row2.createCell(8);
            CH2_08.setCellValue("Month");
            Cell CH2_10 = row2.createCell(10);
            CH2_10.setCellValue("Initial");
            Cell CH2_11 = row2.createCell(11);
            CH2_11.setCellValue("Final");
            ...
            while (iter.hasNext()) {
                ...
                cell50.setCellValue(listaData.get(vi).A1774GSA);
                cell51.setCellValue(listaData.get(vi).A1774PAIS);
                cell52.setCellValue(listaData.get(vi).A1774CITY);
                cell53.setCellValue(listaData.get(vi).A1774RINI);
                cell54.setCellValue(listaData.get(vi).A1774RFIN);
                cell55.setCellValue(listaData.get(vi).A1774COMA);
                cell56.setCellValue(listaData.get(vi).A1774COMM);
                cell57.setCellValue(listaData.get(vi).A1774APLA);
                cell58.setCellValue(listaData.get(vi).A1774APLM);
                cell59.setCellValue(listaData.get(vi).A1774EXC);
                cell60.setCellValue(listaData.get(vi).A1774FIVIG);
                cell61.setCellValue(listaData.get(vi).A1774FFVIG);
