...
public class RobotPostbillingControlController extends BaseController {
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            RobotPostbillingControlLogic logic = new RobotPostbillingControlLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3536Filter> listaData = logic.SearchPostbillingControl(filter);

            // <editor-fold defaultstate="collapsed" desc="Estilo del Excel">
            //Workbook workbook = new XSSFWorkbook();
            int limite = 300;
            SXSSFWorkbook workbook = new SXSSFWorkbook(limite);
            Sheet sheet = workbook.createSheet("RobotPostbilling");
...
//            headerStyle.setFillForegroundColor(IndexedColors.BLUE_GREY.getIndex());
            ...
            CH_06.setCellValue("Disputable Amount");
            CH_07.setCellValue("PBD Amount");
            CH_08.setCellValue("PBD Date");
            CH_09.setCellValue("Resolution Date");

            CH_10.setCellValue("Area");
            CH_11.setCellValue("Audit");
            CH_12.setCellValue("Days");
            ...
            while (iter.hasNext()) {
                ...
                CH_00.setCellValue(listaData.get(vi).A3536MODO);
                CH_01.setCellValue(listaData.get(vi).A3536FREGI);
                CH_02.setCellValue(listaData.get(vi).A3536PAIS);
                CH_03.setCellValue(listaData.get(vi).A3536TRNCU);
                CH_04.setCellValue(listaData.get(vi).A3536NMEMO);

                CH_05.setCellValue(listaData.get(vi).A3536MDA);
                CH_06.setCellValue(listaData.get(vi).A3537NMAX);
                CH_07.setCellValue(listaData.get(vi).A3536NETO);
                CH_08.setCellValue(listaData.get(vi).A3536FPBD);
                CH_09.setCellValue(listaData.get(vi).A3536RDSTE);

                CH_10.setCellValue(listaData.get(vi).A3536AREA);
                CH_11.setCellValue(listaData.get(vi).A3536REGIS);
                CH_12.setCellValue((listaData.get(vi).A3536DIAS));

                CH_13.setCellValue(listaData.get(vi).A3536FLAG);
