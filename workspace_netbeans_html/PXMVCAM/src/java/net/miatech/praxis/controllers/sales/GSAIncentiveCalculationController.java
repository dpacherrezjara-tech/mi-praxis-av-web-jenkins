...
import net.miatech.praxis.logic.sales.GSAIncentiveCalculationLogic;
...
@Controller
@Scope("request")
@RequestMapping("/GSAIncentiveCalculation")
public class GSAIncentiveCalculationController extends BaseController {

    private GSAIncentiveCalculationLogic logic;
    private PX134S01A1778Filter filter;
    private MasterDAO masterDAO;
    
    @RequestMapping(value = "/loadSearch")
    public @ResponseBody
    String loadSearch(ModelMap map, HttpServletRequest request) {
        List<PX134S01A1778Filter> listaData;
        filter = new PX134S01A1778Filter();
        ...
        try {
            ...
            filter.IN_YEAR_F = request.getParameter("IN_YEAR_F").trim();
            filter.IN_YEAR_T = request.getParameter("IN_YEAR_T").trim();
            ...
            logic = new GSAIncentiveCalculationLogic();
            logic.setSession((IServerSession) serverSession.getServerSession());
            listaData = logic.loadPX134S01A1778(filter);
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        String fileNameDownload = String.format("GSA Incentive Calculation - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
        ...
        try {
            ...
            Sheet sheet = workbook.createSheet("GSA Incentive Calculation");
