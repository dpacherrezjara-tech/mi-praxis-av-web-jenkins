...
import net.miatech.praxis.logic.payments.StatementRulesLogic;
...
@Controller
@Scope("request")
@RequestMapping("/StatementRules")
public class StatementRulesController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private StatementRulesLogic logic;
    ...
    public String index(ModelMap map) {
        ...
        return "sales/StatementRules/form_index";
    }

    @RequestMapping(value = "search")
    public @ResponseBody
    String search(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- StatementRules : Search-------------");
    ...
    public List<A2353Filter> getList(HttpServletRequest request, Boolean bExcel) {
        ...
        try {
            ...
            lst = logic.loadPX285MPS102(filter);
        } catch (Exception e) {
    ...
    String searchCompleteDetail(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- StatementRules : searchCompleteDetail-------------");
        ...
        logic.setSession(this.serverSession.getServerSession());
        try {
            result = logic.loadPX285MPS103(filter);
    ...
    @RequestMapping(value = "MaintenanceMPF071")
    public @ResponseBody
    String MaintenanceA2353(ModelMap map, HttpServletRequest request) {
        
        System.out.println("-------------- StatementRules : MaintenanceMPF071-------------");
        ...
        try {
            ...
            logic = new StatementRulesLogic();
            logic.setSession(this.serverSession.getServerSession());
            msj = logic.loadPX285MPS104(filter, option);
