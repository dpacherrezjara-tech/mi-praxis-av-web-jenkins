...
import net.miatech.praxis.logic.payments.InputsDesignLogic;
...
@Controller
@Scope("request")
@RequestMapping("/InputsDesign")
public class InputsDesignController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private InputsDesignLogic logic;
    ...
    public String index(ModelMap map) {
        ...
        return "sales/InputsDesign/form_index";
    }

    @RequestMapping(value = "search")
    public @ResponseBody
    String search(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- InputsDesign : Search-------------");
    ...
    public List<A2353Filter> getList(HttpServletRequest request, Boolean bExcel) {
        ...
        try {
            ...
            lst = logic.loadPX285SQPMULTISEARCH(filter);
        } catch (Exception e) {
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("InputsDesign : getXLSX");

        String fileNameDownload = String.format("InputsDesign - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
...
//            sheet.autoSizeColumn(6, true);
    ...
    @RequestMapping(value = "MaintenanceMPFUNI")
    public @ResponseBody
    String MaintenanceA2353(ModelMap map, HttpServletRequest request) {

        System.out.println("-------------- InputsDesign : MaintenanceMPFUNI-------------");
        ...
        try {
            ...
            logic = new InputsDesignLogic();
            logic.setSession(this.serverSession.getServerSession());
            msj = logic.loadPX285SQPMULTIUPDATE(filter);
    ...
    String searchCompleteDetail(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- InputsDesign : searchCompleteDetail-------------");
        ...
        logic.setSession(this.serverSession.getServerSession());
        try {
            result = logic.loadPX285SQPMULTIENTRY(filter);
