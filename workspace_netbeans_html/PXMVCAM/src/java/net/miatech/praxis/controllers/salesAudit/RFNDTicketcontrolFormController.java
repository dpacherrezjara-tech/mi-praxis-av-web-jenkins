...
import net.miatech.praxis.logic.salesAudit.RFNDTicketcontrolFormLogic;
...
@Controller
@Scope("request")
@RequestMapping("/RFNDTicketcontrolForm")
public class RFNDTicketcontrolFormController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private RFNDTicketcontrolFormLogic logic;

    @RequestMapping(value = "searchRefundTicketControl")
    public @ResponseBody
    String SearchQueryRefund(ModelMap map, HttpServletRequest request) {
        List<A3648Filter> lst;
        A3648Filter filter = new A3648Filter();
        try {
            logic = new RFNDTicketcontrolFormLogic();
    ...
    String SearchListDocument(ModelMap map, HttpServletRequest request) {
        ...
        try {
            ...
            logic = new RFNDTicketcontrolFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3648Filter> lst_search = logic.SearchListDocument(filter);
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            filter = new Gson().fromJson(request.getParameter("beanString"), filter.getClass());
             ...
             logic = new RFNDTicketcontrolFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3648Filter> listaData = logic.searchRefundTicketControl(filter);
...
//            headerStyle.setFillForegroundColor(IndexedColors.BLUE_GREY.getIndex());
            ...
            CH_01.setCellValue("Application date");
            CH_02.setCellValue("Authorise/Reject date");
            CH_03.setCellValue("Folio");
            CH_04.setCellValue("Ticket");
            CH_05.setCellValue("Auditor");
            CH_06.setCellValue("Sales Audit");
            CH_07.setCellValue("Status RFND");
            CH_08.setCellValue("Status Praxis");
