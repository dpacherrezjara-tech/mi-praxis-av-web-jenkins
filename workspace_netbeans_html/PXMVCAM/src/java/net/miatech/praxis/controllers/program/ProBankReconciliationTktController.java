...
@Controller
@Scope("request")
@RequestMapping("/ProBankReconciliationTkt")
public class ProBankReconciliationTktController extends BaseController {
    ...
    String obtainDataCombo(ModelMap map, HttpServletRequest request) {
        try {
            ...
            List<A1248> lstCampos = logic.loadColumns("A2291");
    ...
    String search(ModelMap map, HttpServletRequest request) {
        ...
        try {
            ...
            logic.setSession(this.serverSession.getServerSession());
            List<A2290Filter> listaData = logic.loadSQP03985(filter);
