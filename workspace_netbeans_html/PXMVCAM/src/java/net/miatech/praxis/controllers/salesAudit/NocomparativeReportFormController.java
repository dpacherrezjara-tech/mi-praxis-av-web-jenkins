...
import net.miatech.praxis.logic.salesAudit.NocomparativeReportFormLogic;
...
@Controller
@Scope("request")
@RequestMapping("/NocomparativeReportForm")
public class NocomparativeReportFormController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private NocomparativeReportFormLogic logic;

    @RequestMapping(value = "Search")
    public @ResponseBody
    String Search(ModelMap map, HttpServletRequest request) {
        List<A3951Filter> lst;
        A3951Filter filter = new A3951Filter();
        try {
            logic = new NocomparativeReportFormLogic();
