...
@Controller
@Scope("request")
@RequestMapping("/RulesatpcoForm")
public class RulesatpcoFormController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private RulesatpcoFormLogic logic;
    ...
    String loadRulesSearch(ModelMap map, HttpServletRequest request) {
        ...
        try {
            ...
            lst = logic.loadRulesSearch(filter);
        } catch (Exception e) {
            throw new SpringException(e);
        }
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logic = new RulesatpcoFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A2393Filter> listaData = logic.lst_search(filter);

            // <editor-fold defaultstate="collapsed" desc="Estilo del Excel">
            Workbook workbook = new XSSFWorkbook();
            Sheet sheet = workbook.createSheet("ROULES ATPCO");
...
//            headerStyle.setFillForegroundColor(IndexedColors.BLUE_GREY.getIndex());
            ...
            CH_07.setCellValue("Fare Type");
            CH_08.setCellValue("General Rule");
            CH_09.setCellValue("EFF");
            CH_10.setCellValue("DISC");
            CH_11.setCellValue("Season Type");
            CH_12.setCellValue("Day Type");
            CH_13.setCellValue("OW/RT");
            CH_14.setCellValue("Routing Number");
            CH_15.setCellValue("Foot Note");
            CH_16.setCellValue("Data Table");
            CH_17.setCellValue("RECTY");
            CH_18.setCellValue("ACTIO");
            CH_19.setCellValue("TARNO");
            CH_20.setCellValue("SEQNO");
            CH_21.setCellValue("EFF");
            ...
            while (iter.hasNext()) {
                ...
                CH_00.setCellValue(listaData.get(vi).A2393CXRCO);
                CH_01.setCellValue(listaData.get(vi).A2393TARNO);
                CH_02.setCellValue(listaData.get(vi).A2393RULNO);
                CH_03.setCellValue(listaData.get(vi).A2393CATNO);
                CH_04.setCellValue(listaData.get(vi).A2393LOC1);
                CH_05.setCellValue(listaData.get(vi).A2393LOC2);
                CH_06.setCellValue(listaData.get(vi).A2393FCLAS);
                CH_07.setCellValue(listaData.get(vi).A2393FTYPE);
                CH_08.setCellValue(listaData.get(vi).A2393GEAPP);
                CH_09.setCellValue(listaData.get(vi).A2393EFFE);
                CH_10.setCellValue(listaData.get(vi).A2393DISC);
                CH_11.setCellValue(listaData.get(vi).A2393STYPE);
                CH_12.setCellValue(listaData.get(vi).A2393DTYPE);
                CH_13.setCellValue(listaData.get(vi).A2393DTYPE);
                CH_14.setCellValue(listaData.get(vi).A2393RTGNO);
                CH_15.setCellValue(listaData.get(vi).A2393FTNT);
                CH_16.setCellValue(listaData.get(vi).A2393INTBLS);
                CH_17.setCellValue(listaData.get(vi).A2393RECTY);
                CH_18.setCellValue(listaData.get(vi).A2393ACTIO);
                CH_19.setCellValue(listaData.get(vi).A2393TARNO1);
                CH_20.setCellValue(listaData.get(vi).A2393SEQNO);
                CH_21.setCellValue(listaData.get(vi).A2393EFFE1);
            ...
            String fileNameDownload = String.format("ROULES ATPCO - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
