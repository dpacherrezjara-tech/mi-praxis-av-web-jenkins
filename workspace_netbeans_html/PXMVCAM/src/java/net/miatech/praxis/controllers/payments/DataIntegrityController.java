...
//            Cell CH1_29 = row1.createCell(29);
            ...
            CH1_4.setCellValue("");
            CH1_5.setCellValue("");
            CH1_6.setCellValue("Audit Settlement");
            CH1_7.setCellValue("");
            CH1_8.setCellValue("");
            CH1_9.setCellValue("Differences");
            CH1_10.setCellValue("");
            CH1_11.setCellValue("");
...
//                Cell rcell29 = row1.createCell(29);
                ...
                rcell3.setCellValue(df_2.format(listaData.get(vi).COMPAMO));
                rcell4.setCellValue(df_2.format(listaData.get(vi).TCONAMO));
//                rcell5.setCellValue(df_2.format(listaData.get(vi).COMMAMO));
//                rcell6.setCellValue(df_2.format(listaData.get(vi).IVAAMOU));
//                rcell7.setCellValue(df_2.format(listaData.get(vi).PROPAMO));
//                rcell8.setCellValue(df_2.format(listaData.get(vi).RIVAAMO));
//                rcell9.setCellValue(df_2.format(listaData.get(vi).RICAAMO));
//                rcell10.setCellValue(df_2.format(listaData.get(vi).RFTEAMO));
                rcell5.setCellValue(df_2.format(listaData.get(vi).NETOAMO));
                rcell6.setCellValue(df_2.format(listaData.get(vi).COMPAMOC));
                rcell7.setCellValue(df_2.format(listaData.get(vi).TCONAMOC));
//                rcell14.setCellValue(df_2.format(listaData.get(vi).COMMAMOC));
//                rcell15.setCellValue(df_2.format(listaData.get(vi).IVAAMOUC));
//                rcell16.setCellValue(df_2.format(listaData.get(vi).PROPAMOC));
//                rcell17.setCellValue(df_2.format(listaData.get(vi).RIVAAMOC));
//                rcell18.setCellValue(df_2.format(listaData.get(vi).RICAAMOC));
//                rcell19.setCellValue(df_2.format(listaData.get(vi).RFTEAMOC));
                rcell8.setCellValue(df_2.format(listaData.get(vi).NETOAMOC));
                rcell9.setCellValue(df_2.format(listaData.get(vi).DIFF_COMPAMO));
                rcell10.setCellValue(df_2.format(listaData.get(vi).DIFF_TCONAMO));
//                rcell23.setCellValue(df_2.format(listaData.get(vi).DIFF_COMMAMO));
//                rcell24.setCellValue(df_2.format(listaData.get(vi).DIFF_IVAAMOU));
//                rcell25.setCellValue(df_2.format(listaData.get(vi).DIFF_PROPAMO));
//                rcell26.setCellValue(df_2.format(listaData.get(vi).DIFF_RIVAAMO));
//                rcell27.setCellValue(df_2.format(listaData.get(vi).DIFF_RICAAMO));
//                rcell28.setCellValue(df_2.format(listaData.get(vi).DIFF_RFTEAMO));
                rcell11.setCellValue(df_2.format(listaData.get(vi).DIFF_NETOAMO));
                iter.next();
                ++vi;
                ++vj;
            }
...
//            Cell CH1_29_T = rowTotal.createCell(29);
            ...
            CH1_3_T.setCellValue(df_2.format(listaData.get(0).TOT_COMPAMO));
            CH1_4_T.setCellValue(df_2.format(listaData.get(0).TOT_TCONAMO));
//            CH1_5_T.setCellValue(df_2.format(listaData.get(0).TOT_COMMAMO));
//            CH1_6_T.setCellValue(df_2.format(listaData.get(0).TOT_IVAAMOU));
//            CH1_7_T.setCellValue(df_2.format(listaData.get(0).TOT_PROPAMO));
//            CH1_8_T.setCellValue(df_2.format(listaData.get(0).TOT_RIVAAMO));
//            CH1_9_T.setCellValue(df_2.format(listaData.get(0).TOT_RICAAMO));
//            CH1_10_T.setCellValue(df_2.format(listaData.get(0).TOT_RFTEAMO));
            CH1_5_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMO));
            CH1_6_T.setCellValue(df_2.format(listaData.get(0).TOT_COMPAMOC));
            CH1_7_T.setCellValue(df_2.format(listaData.get(0).TOT_TCONAMOC));
//            CH1_14_T.setCellValue(df_2.format(listaData.get(0).TOT_COMMAMOC));
//            CH1_15_T.setCellValue(df_2.format(listaData.get(0).TOT_IVAAMOUC));
//            CH1_16_T.setCellValue(df_2.format(listaData.get(0).TOT_PROPAMOC));
//            CH1_17_T.setCellValue(df_2.format(listaData.get(0).TOT_RIVAAMOC));
//            CH1_18_T.setCellValue(df_2.format(listaData.get(0).TOT_RICAAMOC));
//            CH1_19_T.setCellValue(df_2.format(listaData.get(0).TOT_RFTEAMOC));
            CH1_8_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMOC));
            CH1_9_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_COMPAMO));
            CH1_10_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_TCONAMO));
//            CH1_23_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_COMMAMO));
//            CH1_24_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_IVAAMOU));
//            CH1_25_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_PROPAMO));
//            CH1_26_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RIVAAMO));
//            CH1_27_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RICAAMO));
//            CH1_28_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RFTEAMO));
            CH1_11_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_NETOAMO));
...
//            sheet.autoSizeColumn(29, true);
    ...
    void getXLSXDaySummaryMPF101(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                rcell4.setCellValue(df_2.format(listaData.get(vi).COMPAMO));
                rcell5.setCellValue(df_2.format(listaData.get(vi).TCONAMO));
                rcell6.setCellValue(df_2.format(listaData.get(vi).COMMAMO));
                rcell7.setCellValue(df_2.format(listaData.get(vi).IVAAMOU));
                rcell8.setCellValue(df_2.format(listaData.get(vi).PROPAMO));
                rcell9.setCellValue(df_2.format(listaData.get(vi).RIVAAMO));
                rcell10.setCellValue(df_2.format(listaData.get(vi).RICAAMO));
                rcell11.setCellValue(df_2.format(listaData.get(vi).RFTEAMO));
                rcell12.setCellValue(df_2.format(listaData.get(vi).NETOAMO));
                rcell13.setCellValue(df_2.format(listaData.get(vi).COMPAMOC));
                rcell14.setCellValue(df_2.format(listaData.get(vi).TCONAMOC));
                rcell15.setCellValue(df_2.format(listaData.get(vi).COMMAMOC));
                rcell16.setCellValue(df_2.format(listaData.get(vi).IVAAMOUC));
                rcell17.setCellValue(df_2.format(listaData.get(vi).PROPAMOC));
                rcell18.setCellValue(df_2.format(listaData.get(vi).RIVAAMOC));
                rcell19.setCellValue(df_2.format(listaData.get(vi).RICAAMOC));
                rcell20.setCellValue(df_2.format(listaData.get(vi).RFTEAMOC));
                rcell21.setCellValue(df_2.format(listaData.get(vi).NETOAMOC));
                rcell22.setCellValue(df_2.format(listaData.get(vi).DIFF_COMPAMO));
                rcell23.setCellValue(df_2.format(listaData.get(vi).DIFF_TCONAMO));
                rcell24.setCellValue(df_2.format(listaData.get(vi).DIFF_COMMAMO));
                rcell25.setCellValue(df_2.format(listaData.get(vi).DIFF_IVAAMOU));
                rcell26.setCellValue(df_2.format(listaData.get(vi).DIFF_PROPAMO));
                rcell27.setCellValue(df_2.format(listaData.get(vi).DIFF_RIVAAMO));
                rcell28.setCellValue(df_2.format(listaData.get(vi).DIFF_RICAAMO));
                rcell29.setCellValue(df_2.format(listaData.get(vi).DIFF_RFTEAMO));
                rcell30.setCellValue(df_2.format(listaData.get(vi).DIFF_NETOAMO));
                iter.next();
                ++vi;
                ++vj;
            }
            ...
            CH1_4_T.setCellValue(df_2.format(listaData.get(0).TOT_COMPAMO));
            CH1_5_T.setCellValue(df_2.format(listaData.get(0).TOT_TCONAMO));
            CH1_6_T.setCellValue(df_2.format(listaData.get(0).TOT_COMMAMO));
            CH1_7_T.setCellValue(df_2.format(listaData.get(0).TOT_IVAAMOU));
            CH1_8_T.setCellValue(df_2.format(listaData.get(0).TOT_PROPAMO));
            CH1_9_T.setCellValue(df_2.format(listaData.get(0).TOT_RIVAAMO));
            CH1_10_T.setCellValue(df_2.format(listaData.get(0).TOT_RICAAMO));
            CH1_11_T.setCellValue(df_2.format(listaData.get(0).TOT_RFTEAMO));
            CH1_12_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMO));
            CH1_13_T.setCellValue(df_2.format(listaData.get(0).TOT_COMPAMOC));
            CH1_14_T.setCellValue(df_2.format(listaData.get(0).TOT_TCONAMOC));
            CH1_15_T.setCellValue(df_2.format(listaData.get(0).TOT_COMMAMOC));
            CH1_16_T.setCellValue(df_2.format(listaData.get(0).TOT_IVAAMOUC));
            CH1_17_T.setCellValue(df_2.format(listaData.get(0).TOT_PROPAMOC));
            CH1_18_T.setCellValue(df_2.format(listaData.get(0).TOT_RIVAAMOC));
            CH1_19_T.setCellValue(df_2.format(listaData.get(0).TOT_RICAAMOC));
            CH1_20_T.setCellValue(df_2.format(listaData.get(0).TOT_RFTEAMOC));
            CH1_21_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMOC));
            CH1_22_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_COMPAMO));
            CH1_23_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_TCONAMO));
            CH1_24_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_COMMAMO));
            CH1_25_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_IVAAMOU));
            CH1_26_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_PROPAMO));
            CH1_27_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RIVAAMO));
            CH1_28_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RICAAMO));
            CH1_29_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RFTEAMO));
            CH1_30_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_NETOAMO));
    ...
    void getXLSXDaySummaryMerchant(HttpServletRequest request, HttpServletResponse response) {
        ...
        MPF100Filter objResult = new MPF100Filter();
        MPF100Filter filter = new MPF100Filter();
//        String rutaFile = currentSession.getServerSession().getPropertySession().get("RUTA_DOWNLOAD_FILE").toString();
        String rutaFile = serverSession.getServerSession().getPropertySession().get("RUTA_DOWNLOAD").toString();

        String fileNameDownloadx = String.format("Report Summary Merchant - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
        String fileNameDownloadt = String.format("Report Summary Merchant - " + Functions.getFechaActual() + ".csv", UUID.randomUUID().toString().toLowerCase());
        try {
            Workbook workbook;
            File file = File.createTempFile(fileNameDownloadx, ".xlsx");
            List<MPF100Filter> listaData = this.getListDaySummaryMerchant(request, true);
            System.out.println("Tamaño de lista devuelta : " + listaData.size());
            if (listaData.size() < 2000) {
                ...
                while (iter.hasNext()) {
                    ...
                    rcell6.setCellValue(df_2.format(listaData.get(vi).COMPAMO));
                    rcell7.setCellValue(df_2.format(listaData.get(vi).TCONAMO));
                    rcell8.setCellValue(df_2.format(listaData.get(vi).COMMAMO));
                    rcell9.setCellValue(df_2.format(listaData.get(vi).IVAAMOU));
                    rcell10.setCellValue(df_2.format(listaData.get(vi).PROPAMO));
                    rcell11.setCellValue(df_2.format(listaData.get(vi).RIVAAMO));
                    rcell12.setCellValue(df_2.format(listaData.get(vi).RICAAMO));
                    rcell13.setCellValue(df_2.format(listaData.get(vi).RFTEAMO));
                    rcell14.setCellValue(df_2.format(listaData.get(vi).NETOAMO));
                    rcell15.setCellValue(df_2.format(listaData.get(vi).COMPAMOC));
                    rcell16.setCellValue(df_2.format(listaData.get(vi).TCONAMOC));
                    rcell17.setCellValue(df_2.format(listaData.get(vi).COMMAMOC));
                    rcell18.setCellValue(df_2.format(listaData.get(vi).IVAAMOUC));
                    rcell19.setCellValue(df_2.format(listaData.get(vi).PROPAMOC));
                    rcell20.setCellValue(df_2.format(listaData.get(vi).RIVAAMOC));
                    rcell21.setCellValue(df_2.format(listaData.get(vi).RICAAMOC));
                    rcell22.setCellValue(df_2.format(listaData.get(vi).RFTEAMOC));
                    rcell23.setCellValue(df_2.format(listaData.get(vi).NETOAMOC));
                    rcell24.setCellValue(df_2.format(listaData.get(vi).DIFF_COMPAMO));
                    rcell25.setCellValue(df_2.format(listaData.get(vi).DIFF_TCONAMO));
                    rcell26.setCellValue(df_2.format(listaData.get(vi).DIFF_COMMAMO));
                    rcell27.setCellValue(df_2.format(listaData.get(vi).DIFF_IVAAMOU));
                    rcell28.setCellValue(df_2.format(listaData.get(vi).DIFF_PROPAMO));
                    rcell29.setCellValue(df_2.format(listaData.get(vi).DIFF_RIVAAMO));
                    rcell30.setCellValue(df_2.format(listaData.get(vi).DIFF_RICAAMO));
                    rcell31.setCellValue(df_2.format(listaData.get(vi).DIFF_RFTEAMO));
                    rcell32.setCellValue(df_2.format(listaData.get(vi).DIFF_NETOAMO));
                    iter.next();
                    ++vi;
                    ++vj;
                }
                ...
                CH1_6_T.setCellValue(df_2.format(listaData.get(0).TOT_COMPAMO));
                CH1_7_T.setCellValue(df_2.format(listaData.get(0).TOT_TCONAMO));
                CH1_8_T.setCellValue(df_2.format(listaData.get(0).TOT_COMMAMO));
                CH1_9_T.setCellValue(df_2.format(listaData.get(0).TOT_IVAAMOU));
                CH1_10_T.setCellValue(df_2.format(listaData.get(0).TOT_PROPAMO));
                CH1_11_T.setCellValue(df_2.format(listaData.get(0).TOT_RIVAAMO));
                CH1_12_T.setCellValue(df_2.format(listaData.get(0).TOT_RICAAMO));
                CH1_13_T.setCellValue(df_2.format(listaData.get(0).TOT_RFTEAMO));
                CH1_14_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMO));
                CH1_15_T.setCellValue(df_2.format(listaData.get(0).TOT_COMPAMOC));
                CH1_16_T.setCellValue(df_2.format(listaData.get(0).TOT_TCONAMOC));
                CH1_17_T.setCellValue(df_2.format(listaData.get(0).TOT_COMMAMOC));
                CH1_18_T.setCellValue(df_2.format(listaData.get(0).TOT_IVAAMOUC));
                CH1_19_T.setCellValue(df_2.format(listaData.get(0).TOT_PROPAMOC));
                CH1_20_T.setCellValue(df_2.format(listaData.get(0).TOT_RIVAAMOC));
                CH1_21_T.setCellValue(df_2.format(listaData.get(0).TOT_RICAAMOC));
                CH1_22_T.setCellValue(df_2.format(listaData.get(0).TOT_RFTEAMOC));
                CH1_23_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMOC));
                CH1_24_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_COMPAMO));
                CH1_25_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_TCONAMO));
                CH1_26_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_COMMAMO));
                CH1_27_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_IVAAMOU));
                CH1_28_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_PROPAMO));
                CH1_29_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RIVAAMO));
                CH1_30_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RICAAMO));
                CH1_31_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_RFTEAMO));
                CH1_32_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_NETOAMO));
                ...
                //============================================
                response.setContentType("application/vnd.openxml");
                response.setHeader("Content-Disposition", "attachment; filename=\"" + fileNameDownloadx + "\"");
...
//                File filet = File.createTempFile(fileNameDownloadt, ".txt");
                File filet = new File(rutaFile + "\\" + fileNameDownloadt);
                PrintWriter writer = new PrintWriter(filet, "UTF-8");
                DecimalFormat df_2 = new DecimalFormat("#,###,##0.00");
                DecimalFormatSymbols otherSymbols = new DecimalFormatSymbols(Locale.ENGLISH);
                otherSymbols.setDecimalSeparator('.');
                otherSymbols.setGroupingSeparator(',');
                ...
                String cadena;
                cadena = "Processing Date|Country|Credit Card Code|Credit Card Number|Credit Card Auth.|Curr.|"
                        + "Settlement Valor Compras|Settlement Valor Tot.Liquidacion|Settlement Valor Com.Estableci|Settlement Valor IVA|Settlement Valor Propina|Settlement Valor Retencion IVA|Settlement Valor Retencion ICA|Settlement Valor Retencion Fte|Settlement Valor Neto Consigma|"
                        + "Audit Settlement Valor Compras|Audit Settlement Valor Tot.Liquidacion|Audit Settlement Valor Com.Estableci|Audit Valor IVA|Audit Settlement Valor Propina|Audit Settlement Valor Retencion IVA|Audit Valor Retencion ICA|Audit Valor Retencion Fte|Audit Valor Neto Consigma|"
                        + "Differences Valor Compras|Differences Valor Tot.Liquidacion|Differences Valor Com.Estableci|Differences Valor IVA|Differences Valor Propina|Differences Valor Retencion IVA|Differences Valor Retencion ICA|Differences Valor Retencion Fte|Differences Valor Neto Consigma";
                writer.println("" + cadena);

                for (int vi = 0; vi < listaData.size(); vi++) {
                    cadena = "";
                    cadena += "" + listaData.get(vi).strFecFiltro + "|";
                    ...
                    cadena += "" + df_2.format(listaData.get(vi).COMPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).TCONAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).COMMAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).IVAAMOU) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).PROPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).RIVAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).RICAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).RFTEAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).NETOAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).COMPAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).TCONAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).COMMAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).IVAAMOUC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).PROPAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).RIVAAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).RICAAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).RFTEAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).NETOAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_COMPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_TCONAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_COMMAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_IVAAMOU) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_PROPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_RIVAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_RICAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_RFTEAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(vi).DIFF_NETOAMO);
                    writer.println("" + cadena);
                }
                    ...
                    cadena += "" +  "|";
                    cadena += "" +  "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_COMPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_TCONAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_COMMAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_IVAAMOU) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_PROPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_RIVAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_RICAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_RFTEAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_NETOAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_COMPAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_TCONAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_COMMAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_IVAAMOUC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_PROPAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_RIVAAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_RICAAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_RFTEAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_NETOAMOC) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_COMPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_TCONAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_COMMAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_IVAAMOU) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_PROPAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_RIVAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_RICAAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_RFTEAMO) + "|";
                    cadena += "" + df_2.format(listaData.get(0).TOT_DIFF_NETOAMO);
                    writer.println("" + cadena);
                ...
                response.setHeader("Content-Disposition", "attachment;filename=\"" + rutaFile + "\\" + fileNameDownloadt + "\"");
                InputStream is = new FileInputStream(rutaFile + "\\" + fileNameDownloadt);
