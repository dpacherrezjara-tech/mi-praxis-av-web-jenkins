...
//                rcell10.setCellValue(listaData.get(vi).RFTEAMO));
                rcell5.setCellValue(listaData.get(vi).NETOAMO);
                rcell6.setCellValue(listaData.get(vi).COMPAMOC);
                rcell7.setCellValue(listaData.get(vi).TCONAMOC);
...
//                rcell19.setCellValue(listaData.get(vi).RFTEAMOC));
                rcell8.setCellValue(listaData.get(vi).NETOAMOC);
                rcell9.setCellValue(listaData.get(vi).DIFF_COMPAMO);
                rcell10.setCellValue(listaData.get(vi).DIFF_TCONAMO);
...
//                rcell28.setCellValue(listaData.get(vi).DIFF_RFTEAMO));
                rcell11.setCellValue(listaData.get(vi).DIFF_NETOAMO);
...
//            CH1_10_T.setCellValue(listaData.get(0).TOT_RFTEAMO));
            CH1_5_T.setCellValue(listaData.get(0).TOT_NETOAMO);
            CH1_6_T.setCellValue(listaData.get(0).TOT_COMPAMOC);
            CH1_7_T.setCellValue(listaData.get(0).TOT_TCONAMOC);
...
//            CH1_19_T.setCellValue(listaData.get(0).TOT_RFTEAMOC));
            CH1_8_T.setCellValue(listaData.get(0).TOT_NETOAMOC);
            CH1_9_T.setCellValue(listaData.get(0).TOT_DIFF_COMPAMO);
            CH1_10_T.setCellValue(listaData.get(0).TOT_DIFF_TCONAMO);
...
//            CH1_28_T.setCellValue(listaData.get(0).TOT_DIFF_RFTEAMO));
            CH1_11_T.setCellValue(listaData.get(0).TOT_DIFF_NETOAMO);
    ...
    void getXLSXDaySummaryMPF101(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                rcell15.setCellStyle(data);
                rcell16.setCellStyle(data);
                rcell17.setCellStyle(data);
                rcell18.setCellStyle(data);
                rcell19.setCellStyle(data);
                rcell20.setCellStyle(data);
                rcell21.setCellStyle(data);
                rcell22.setCellStyle(data);
                rcell23.setCellStyle(data);
                rcell24.setCellStyle(data);
                rcell25.setCellStyle(data);
                rcell26.setCellStyle(data);
                rcell27.setCellStyle(data);
                rcell28.setCellStyle(data);
                rcell29.setCellStyle(data);
                rcell30.setCellStyle(data);
            ...
            CH1_13_T.setCellValue(listaData.get(0).TOT_COMPAMO);
...
//                    cadena += "" + listaData.get(vi).COMPAMO + "|";
//                    cadena += "" + listaData.get(vi).TCONAMO + "|";
//                    cadena += "" + listaData.get(vi).COMMAMO + "|";
//                    cadena += "" + listaData.get(vi).IVAAMOU + "|";
//                    cadena += "" + listaData.get(vi).PROPAMO + "|";
//                    cadena += "" + listaData.get(vi).RIVAAMO + "|";
//                    cadena += "" + listaData.get(vi).RICAAMO + "|";
//                    cadena += "" + listaData.get(vi).RFTEAMO + "|";
//                    cadena += "" + listaData.get(vi).NETOAMO + "|";
//                    cadena += "" + listaData.get(vi).COMPAMOC + "|";
//                    cadena += "" + listaData.get(vi).TCONAMOC + "|";
//                    cadena += "" + listaData.get(vi).COMMAMOC + "|";
//                    cadena += "" + listaData.get(vi).IVAAMOUC + "|";
//                    cadena += "" + listaData.get(vi).PROPAMOC + "|";
//                    cadena += "" + listaData.get(vi).RIVAAMOC + "|";
//                    cadena += "" + listaData.get(vi).RICAAMOC + "|";
//                    cadena += "" + listaData.get(vi).RFTEAMOC + "|";
//                    cadena += "" + listaData.get(vi).NETOAMOC + "|";
//                    cadena += "" + listaData.get(vi).DIFF_COMPAMO + "|";
//                    cadena += "" + listaData.get(vi).DIFF_TCONAMO + "|";
//                    cadena += "" + listaData.get(vi).DIFF_COMMAMO + "|";
//                    cadena += "" + listaData.get(vi).DIFF_IVAAMOU + "|";
//                    cadena += "" + listaData.get(vi).DIFF_PROPAMO + "|";
//                    cadena += "" + listaData.get(vi).DIFF_RIVAAMO + "|";
//                    cadena += "" + listaData.get(vi).DIFF_RICAAMO + "|";
//                    cadena += "" + listaData.get(vi).DIFF_RFTEAMO + "|";
//                    cadena += "" + listaData.get(vi).DIFF_NETOAMO;
//                    writer.println("" + cadena);
//                }
//                
//                    cadena = "";
...
//                    cadena += "" +  "|";
//                    cadena += "" +  "|";
//                    cadena += "" + listaData.get(0).TOT_COMPAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_TCONAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_COMMAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_IVAAMOU + "|";
//                    cadena += "" + listaData.get(0).TOT_PROPAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_RIVAAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_RICAAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_RFTEAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_NETOAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_COMPAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_TCONAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_COMMAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_IVAAMOUC + "|";
//                    cadena += "" + listaData.get(0).TOT_PROPAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_RIVAAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_RICAAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_RFTEAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_NETOAMOC + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_COMPAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_TCONAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_COMMAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_IVAAMOU + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_PROPAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_RIVAAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_RICAAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_RFTEAMO + "|";
//                    cadena += "" + listaData.get(0).TOT_DIFF_NETOAMO;
//                    writer.println("" + cadena);
//                    
//                writer.flush();
//                writer.close();
...
//    }
    ...
    public @ResponseBody
    void getXLSXDaySummaryMerchant(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("Report : getXLSXDaySummaryMerchant");
        String fileNameDownload = String.format("Report Day Summary Merchant - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
        try {
            Workbook workbook;
            File file = File.createTempFile(fileNameDownload, ".xlsx");
            List<MPF100Filter> listaData = this.getListDaySummaryMerchant(request, true);
            ...
            // ====== CREANDO TITULOS ======================================
                ...
                while (iter.hasNext()) {
                    ...
                    rcell29.setCellStyle(data);
                    rcell30.setCellStyle(data);
                    rcell31.setCellStyle(data);
                    rcell32.setCellStyle(data);
