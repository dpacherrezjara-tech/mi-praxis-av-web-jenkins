    ...
    void getXLSXMainSummary(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                rcell11.setCellValue(df_2.format(listaData.get(vi).NETOAMO));
                rcell12.setCellValue(df_2.format(listaData.get(vi).COMPAMOC));
                rcell13.setCellValue(df_2.format(listaData.get(vi).TCONAMOC));
                ...
                rcell20.setCellValue(df_2.format(listaData.get(vi).NETOAMOC));
                rcell21.setCellValue(df_2.format(listaData.get(vi).DIFF_COMPAMO));
                rcell22.setCellValue(df_2.format(listaData.get(vi).DIFF_TCONAMO));
                ...
                rcell29.setCellValue(df_2.format(listaData.get(vi).DIFF_NETOAMO));
                iter.next();
                ++vi;
                ++vj;
            }
            ...
            CH1_11_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMO));
            CH1_12_T.setCellValue(df_2.format(listaData.get(0).TOT_COMPAMOC));
            CH1_13_T.setCellValue(df_2.format(listaData.get(0).TOT_TCONAMOC));
            ...
            CH1_20_T.setCellValue(df_2.format(listaData.get(0).TOT_NETOAMOC));
            CH1_21_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_COMPAMO));
            CH1_22_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_TCONAMO));
            ...
            CH1_29_T.setCellValue(df_2.format(listaData.get(0).TOT_DIFF_NETOAMO));
