...
public class DataIntegrityController extends BaseController {
    ...
    void getXLSXDaySummaryMPF101(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("Report : getXLSXMainSummary");
        String fileNameDownload = String.format("Report Day Summary - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
        try {
            Workbook workbook;
            File file = File.createTempFile(fileNameDownload, ".xlsx");
            ...
            CH1_4.setCellValue("TCONAMO");
            CH1_5.setCellValue("COMMANO");
            CH1_6.setCellValue("IVAAMOU");
            CH1_7.setCellValue("PROPAMO");
            CH1_8.setCellValue("RIVAAMO");
            CH1_9.setCellValue("RICAAMO");
            CH1_10.setCellValue("RFTEAMO");
            CH1_11.setCellValue("NETOAMO");
            CH1_12.setCellValue("TCONAMOC");
            CH1_13.setCellValue("COMMAMOC");
            CH1_14.setCellValue("IVAAMOUC");
            CH1_15.setCellValue("PROPAMOC");
            CH1_16.setCellValue("RIVAAMOC");
            CH1_17.setCellValue("RICAAMOC");
            CH1_18.setCellValue("RFTEAMOC");
            CH1_19.setCellValue("NETOAMOC");
            CH1_20.setCellValue("DIFF_TCONAMO");
            CH1_21.setCellValue("DIFF_COMMAMO");
            CH1_22.setCellValue("DIFF_IVAAMOU");
            CH1_23.setCellValue("DIFF_PROPAMO");
            CH1_24.setCellValue("DIFF_RIVAAMO");
            CH1_25.setCellValue("DIFF_RICAAMO");
            CH1_26.setCellValue("DIFF_RFTEAMO");
            CH1_27.setCellValue("DIFF_NETOAMO");
            ...
            while (iter.hasNext()) {
                ...
                rcell10.setCellValue(listaData.get(vi).RFTEAMO);
                rcell11.setCellValue(listaData.get(vi).NETOAMO);
                rcell12.setCellValue(listaData.get(vi).TCONAMOC);
                rcell13.setCellValue(listaData.get(vi).COMMAMOC);
                rcell14.setCellValue(listaData.get(vi).IVAAMOUC);
                rcell15.setCellValue(listaData.get(vi).PROPAMOC);
                rcell16.setCellValue(listaData.get(vi).RIVAAMOC);
                rcell17.setCellValue(listaData.get(vi).RICAAMOC);
                rcell18.setCellValue(listaData.get(vi).RFTEAMOC);
                rcell19.setCellValue(listaData.get(vi).NETOAMOC);
                rcell20.setCellValue(listaData.get(vi).DIFF_TCONAMO);
                rcell21.setCellValue(listaData.get(vi).DIFF_COMMAMO);
                rcell22.setCellValue(listaData.get(vi).DIFF_IVAAMOU);
                rcell23.setCellValue(listaData.get(vi).DIFF_PROPAMO);
                rcell24.setCellValue(listaData.get(vi).DIFF_RIVAAMO);
                rcell25.setCellValue(listaData.get(vi).DIFF_RICAAMO);
                rcell26.setCellValue(listaData.get(vi).DIFF_RFTEAMO);
                rcell27.setCellValue(listaData.get(vi).DIFF_NETOAMO);
                iter.next();
                ++vi;
                ++vj;
            }
            ...
            CH1_10_T.setCellValue(listaData.get(0).TOT_RFTEAMO);
            CH1_11_T.setCellValue(listaData.get(0).TOT_NETOAMO);
            CH1_12_T.setCellValue(listaData.get(0).TOT_TCONAMOC);
            CH1_13_T.setCellValue(listaData.get(0).TOT_COMMAMOC);
            CH1_14_T.setCellValue(listaData.get(0).TOT_IVAAMOUC);
            CH1_15_T.setCellValue(listaData.get(0).TOT_PROPAMOC);
            CH1_16_T.setCellValue(listaData.get(0).TOT_RIVAAMOC);
            CH1_17_T.setCellValue(listaData.get(0).TOT_RICAAMOC);
            CH1_18_T.setCellValue(listaData.get(0).TOT_RFTEAMOC);
            CH1_19_T.setCellValue(listaData.get(0).TOT_NETOAMOC);
            CH1_20_T.setCellValue(listaData.get(0).TOT_DIFF_TCONAMO);
            CH1_21_T.setCellValue(listaData.get(0).TOT_DIFF_COMMAMO);
            CH1_22_T.setCellValue(listaData.get(0).TOT_DIFF_IVAAMOU);
            CH1_23_T.setCellValue(listaData.get(0).TOT_DIFF_PROPAMO);
            CH1_24_T.setCellValue(listaData.get(0).TOT_DIFF_RIVAAMO);
            CH1_25_T.setCellValue(listaData.get(0).TOT_DIFF_RICAAMO);
            CH1_26_T.setCellValue(listaData.get(0).TOT_DIFF_RFTEAMO);
            CH1_27_T.setCellValue(listaData.get(0).TOT_DIFF_NETOAMO);
    ...
    void getXLSXDaySummaryMerchant(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            CH1_6.setCellValue("TCONAMO");
            CH1_7.setCellValue("COMMANO");
            CH1_8.setCellValue("IVAAMOU");
            CH1_9.setCellValue("PROPAMO");
            CH1_10.setCellValue("RIVAAMO");
            CH1_11.setCellValue("RICAAMO");
            CH1_12.setCellValue("RFTEAMO");
            CH1_13.setCellValue("NETOAMO");
            CH1_14.setCellValue("TCONAMOC");
            CH1_15.setCellValue("COMMAMOC");
            CH1_16.setCellValue("IVAAMOUC");
            CH1_17.setCellValue("PROPAMOC");
            CH1_18.setCellValue("RIVAAMOC");
            CH1_19.setCellValue("RICAAMOC");
            CH1_20.setCellValue("RFTEAMOC");
            CH1_21.setCellValue("NETOAMOC");
            CH1_22.setCellValue("DIFF_TCONAMO");
            CH1_23.setCellValue("DIFF_COMMAMO");
            CH1_24.setCellValue("DIFF_IVAAMOU");
            CH1_25.setCellValue("DIFF_PROPAMO");
            CH1_26.setCellValue("DIFF_RIVAAMO");
            CH1_27.setCellValue("DIFF_RICAAMO");
            CH1_28.setCellValue("DIFF_RFTEAMO");
            CH1_29.setCellValue("DIFF_NETOAMO");
            ...
            while (iter.hasNext()) {
                ...
                rcell6.setCellValue(listaData.get(vi).TCONAMO);
                rcell7.setCellValue(listaData.get(vi).COMMAMO);
                rcell8.setCellValue(listaData.get(vi).IVAAMOU);
                rcell9.setCellValue(listaData.get(vi).PROPAMO);
                rcell10.setCellValue(listaData.get(vi).RIVAAMO);
                rcell11.setCellValue(listaData.get(vi).RICAAMO);
                rcell12.setCellValue(listaData.get(vi).RFTEAMO);
                rcell13.setCellValue(listaData.get(vi).NETOAMO);
            ...
            CH1_6_T.setCellValue(listaData.get(0).TOT_TCONAMO);
            CH1_7_T.setCellValue(listaData.get(0).TOT_COMMAMO);
            CH1_8_T.setCellValue(listaData.get(0).TOT_IVAAMOU);
            CH1_9_T.setCellValue(listaData.get(0).TOT_PROPAMO);
            CH1_10_T.setCellValue(listaData.get(0).TOT_RIVAAMO);
            CH1_11_T.setCellValue(listaData.get(0).TOT_RICAAMO);
            CH1_12_T.setCellValue(listaData.get(0).TOT_RFTEAMO);
            CH1_13_T.setCellValue(listaData.get(0).TOT_NETOAMO);
