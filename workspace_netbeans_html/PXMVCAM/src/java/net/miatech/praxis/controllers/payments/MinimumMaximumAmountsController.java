...
import net.miatech.praxis.logic.payments.MinimumMaximumAmountsLogic;
...
@Controller
@Scope("request")
@RequestMapping("/MinimumMaximumAmounts")
public class MinimumMaximumAmountsController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private MinimumMaximumAmountsLogic logic;
    ...
    public String index(ModelMap map) {
        ...
        return "sales/MinimumMaximumAmounts/form_index";
    }

    @RequestMapping(value = "search")
    public @ResponseBody
    String search(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- MinimumMaximumAmounts : Search-------------");
...
//
//        logic = new MinimumMaximumAmountsLogic();
//        logic.setSession(this.serverSession.getServerSession());
//        try {
//            result = logic.loadPX620SQP05107_MPF112(filter);
...
//    }
    ...
    public List<A2353Filter> getList(HttpServletRequest request, Boolean bExcel) {
        ...
        try {
            ...
            lst = logic.loadPX285SQP00827(filter);
        } catch (Exception e) {
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        String fileNameDownload = String.format("Maximun Minimun Amount Report - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
        try {
            Workbook workbook;
...
//            CellStyle bodyStyle = workbook.createCellStyle();
            ...
            CH1_3.setCellValue("Max.Fase I");
            CH1_4.setCellValue("Min.FaseI");
            CH1_5.setCellValue("Max.FaseII");
            CH1_6.setCellValue("Min.FaseII");
...
//            ++vj;
            ...
            while (iter.hasNext()) {
                ...
                rcell1.setCellValue(listaData.get(vi).descCurrency);
                rcell2.setCellValue(listaData.get(vi).descCountry);
                rcell3.setCellValue(listaData.get(vi).MAXF1);
                rcell4.setCellValue(listaData.get(vi).MINF1);
                rcell5.setCellValue(listaData.get(vi).MAXF2);
                rcell6.setCellValue(listaData.get(vi).MINF2);
                iter.next();
                ++vi;
                ++vj;
            }
    ...
    @RequestMapping(value = "MaintenanceA2353")
    public @ResponseBody
    String MaintenanceA2353(ModelMap map, HttpServletRequest request) {
        
        System.out.println("-------------- MinimumMaximumAmounts : MaintenanceA2353-------------");
...
//            filter.SCOUNTRY = request.getParameter("SCOUNTRY").trim();
            ...
            logic = new MinimumMaximumAmountsLogic();
            logic.setSession(this.serverSession.getServerSession());
            msj = logic.loadPX285SQP00828(filter, option);
    ...
    String searchCompleteDetail(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- MinimumMaximumAmounts : searchCompleteDetail-------------");
