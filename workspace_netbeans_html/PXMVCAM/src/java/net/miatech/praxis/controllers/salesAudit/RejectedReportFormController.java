...
import net.miatech.praxis.logic.salesAudit.RejectedReportFormLogic;
...
@Controller
@Scope("request")
@RequestMapping("/RejectedReportForm")
public class RejectedReportFormController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private RejectedReportFormLogic logic;

    @RequestMapping(value = "searchDowloadFiles")
    public @ResponseBody
    String searchDowloadFiles(ModelMap map, HttpServletRequest request) {
        A3456Filter filter = new A3456Filter();
        try {
            Functions.msjConsola("PRAXIS", this.serverSession.getServerSession().getUserView().getUserInfo().USR, getClass().getSimpleName() + " : " + Thread.currentThread().getStackTrace()[1].getMethodName());
            filter = new Gson().fromJson(request.getParameter("beanString"), filter.getClass());

            logic = new RejectedReportFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3456Filter> lst_search = logic.searchDowloadFiles(filter);
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logic = new RejectedReportFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3456Filter> lst = logic.searchDowloadFiles(filter);

            Workbook workbook = new XSSFWorkbook();
            Sheet sheet = workbook.createSheet("RejectedDoc");
            ...
            while (iter.hasNext()) {
                ...
                CH_02.setCellValue(lst.get(vi).A3456PAIS);
    ...
    @RequestMapping(value = "SearchRejectedDocDetail")
    public @ResponseBody
    String SearchRejectedDocDetail(ModelMap map, HttpServletRequest request) {
        A3456Filter filter = new A3456Filter();
        try {
            Functions.msjConsola("PRAXIS", this.serverSession.getServerSession().getUserView().getUserInfo().USR, getClass().getSimpleName() + " : " + Thread.currentThread().getStackTrace()[1].getMethodName());
            filter = new Gson().fromJson(request.getParameter("beanString"), filter.getClass());
            ...
            logic = new RejectedReportFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3456Filter> lst_search = logic.SearchRejectedDocDetail(filter);
    ...
    @RequestMapping(value = "/getXLSXDetaill")
    public @ResponseBody
    void getXLSXDetaill(HttpServletRequest request, HttpServletResponse response) {
        A3456Filter filter = new A3456Filter();
        try {
            Functions.msjConsola("PRAXIS", this.serverSession.getServerSession().getUserView().getUserInfo().USR, getClass().getSimpleName() + " : " + Thread.currentThread().getStackTrace()[1].getMethodName());
            filter = new Gson().fromJson(request.getParameter("beanString"), filter.getClass());
            ...
            logic = new RejectedReportFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3456Filter> lst = logic.SearchRejectedDocDetail(filter);

            Workbook workbook = new XSSFWorkbook();
            Sheet sheet = workbook.createSheet("RejectedDocDetaill");
            XSSFCellStyle headerStyle = (XSSFCellStyle) workbook.createCellStyle();
            ...
            CH_01.setCellValue("Period");
            CH_02.setCellValue("Country");
            CH_03.setCellValue("Cia");
            CH_04.setCellValue("Ticket");
            CH_05.setCellValue("Trnc");
            CH_06.setCellValue("Error");
            CH_07.setCellValue("IATA");
            CH_08.setCellValue("Agency");
            CH_09.setCellValue("Reason for rejection");
            CH_10.setCellValue("Associated");
            CH_11.setCellValue("GDS");
            CH_12.setCellValue("Period");
            CH_13.setCellValue("Date");
            CH_14.setCellValue("Billing");
            ...
            while (iter.hasNext()) {
                ...
                CH_01.setCellValue(lst.get(vi).A3456FDATE);
                CH_02.setCellValue(lst.get(vi).A3456PAIS);
                CH_03.setCellValue(lst.get(vi).A3456CIA);
                CH_04.setCellValue(lst.get(vi).A3456TKT);
                CH_05.setCellValue(lst.get(vi).A3456TRN);
                CH_06.setCellValue(lst.get(vi).A3456FLAG);
                CH_07.setCellValue(lst.get(vi).A3456IATA);
                CH_08.setCellValue(lst.get(vi).A3456DESIATA);
                CH_09.setCellValue(lst.get(vi).A3456DESCR);
                CH_10.setCellValue(lst.get(vi).A3456TKTAS);
                CH_11.setCellValue(lst.get(vi).A3456GDSNA);
                CH_12.setCellValue(lst.get(vi).A3456PERIO);
                CH_13.setCellValue(lst.get(vi).A3456DATE);
                CH_14.setCellValue(lst.get(vi).A3456FBILL);
                CH_15.setCellValue(lst.get(vi).A3456ESTAD);
            ...
            String fileNameDownload = String.format("RejectedDocDetaill - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
            response.setContentType("application/vnd.openxml");
            response.setHeader("Content-Disposition", "attachment; filename=\"" + fileNameDownload + "\"");
