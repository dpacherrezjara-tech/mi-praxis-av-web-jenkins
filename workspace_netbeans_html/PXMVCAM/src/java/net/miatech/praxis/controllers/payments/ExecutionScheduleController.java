...
import net.miatech.praxis.logic.payments.ExecutionScheduleLogic;
...
@Controller
@Scope("request")
@RequestMapping("/ExecutionSchedule")
public class ExecutionScheduleController extends BaseController {

    private ExecutionScheduleLogic logic;

    @RequestMapping(value = "SearchCalendar")
    public @ResponseBody
    String SearchCalendar(ModelMap map, HttpServletRequest request) {
        List<A4718Filter> lst;
        A4718Filter filter = new A4718Filter();
        try {
            logic = new ExecutionScheduleLogic();
            ...
            lst = logic.SearchCalendar(filter);
        } catch (Exception e) {
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logic = new ExecutionScheduleLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A4718Filter> lst = logic.SearchCalendar(filter);
            ...
            String fileNameDownload = String.format("ExecutionscheduleForm - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
    ...
    @RequestMapping(value = "mantenimientoCalendar")
    public @ResponseBody
    String mantenimientoCalendar(ModelMap map, HttpServletRequest request) {
        String result = "";
        A4718Filter filter = new A4718Filter();
        try {
            ...
            logic = new ExecutionScheduleLogic();
            logic.setSession(this.serverSession.getServerSession());
            result = logic.mantenimientoCalendar(filter);
