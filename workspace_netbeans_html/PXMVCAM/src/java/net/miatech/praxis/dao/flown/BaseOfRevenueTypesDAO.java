 ...
 * @author gsanchez
 */
public class BaseOfRevenueTypesDAO {
    ...
    public String BaseOfRevenueTypesMaintance(A051 filter, String strOption) throws SQLException, Exception {
