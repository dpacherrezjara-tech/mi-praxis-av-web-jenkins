...
public class TAXTTBSDAO {
    ...
    public TAXTTBSDAO(IServerSession ss) {
        session = ss;
    }
    ...
    public List<PX036S01A1549Filter> loadPX036S01A1549(PX036S01A1549Filter filter) throws SQLException, Exception {
        List<PX036S01A1549Filter> lstRtn = new ArrayList<>(0);
        PX036S01A1549Filter objRtn;
        CallableStatement cstmt01 = null;
        ResultSet rs01 = null;

        try {
            String SQLCLL01 = "{CALL PX036S02A1549(?,?,?,?,?,?,?)}";
            ...
            while (rs01.next()) {
                objRtn = new PX036S01A1549Filter();
