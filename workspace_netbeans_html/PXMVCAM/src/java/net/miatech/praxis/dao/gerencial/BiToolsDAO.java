...
public class BiToolsDAO {
    ...
    public BiToolsDAO(IServerSession ss) {
        session = ss;
    }
    ...
    public List<A1248> loadFiles(String tabla) throws Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00835_ULT(?,?)}";
    ...
    public List<A1248> loadPX275SQP01033(String tabla1, String tabla2) throws Exception {
        ...
        ResultSet rs01 = null;
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP01033_ULT(?,?,?)}";
    ...
    public List<SQP00768> loadPX275SQP01034(String tabla1) throws Exception {
        ...
        CallableStatement cstmt01 = null;
        ResultSet rs01 = null;
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP01034_ULT(?,?,?)}";
    ...
    public List<SQP00768> loadPXPRUEBA(SQP00768 filter) throws Exception {
        ...
        SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00768_ULT(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public List<SQP00768> loadPXPRUEBA2(SQP00768 filter) throws Exception {
        ...
        SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00825_ULT(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public String loadPX282SQP00777(SQP00768 filter) {
        ...
        Connection cnx = null;
        try {
            String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00777_ULT(?,?,?,?,?,?,?,?,?,?,?,?)}";
            cnx = session.getCNXIBMDB2().getIBMDB2Connection();
            cstmt = cnx.prepareCall(SQLCLL01);
            ...
            try {
                ...
                System.out.println(">>" + mensaje);
                java.util.logging.Logger.getLogger(BiToolsDAO.class.getName()).log(Level.SEVERE, null, ex);
            }
            pasarGarbageCollector();
        }
    ...
    public List<SQP00768> loadPX282SQP00808(String tabla, String codigo) throws Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00808_ULT(?,?,?,?)}";
    ...
    public List<A1248> loadOperadores() throws Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP02860_ULT(?)}";
    ...
    public SQP00768 executeValuation(SQP00768 filter) throws SQLException,Exception {
        ...
        String SQLCLL01 = "";
        SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00768U_ULT(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
