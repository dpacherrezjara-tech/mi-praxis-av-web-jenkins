...
public class BSPFileDownloadDAO {
    ...
    public List<A2354Filter> loadPX305SQP00933(A2354Filter filter) throws SQLException, Exception {
        ...
        try {
            ...
            cstmt.setString(1, session.getUserView().getCustomerInfo().CCUST);
            cstmt.setString(2, filter.IN_FROM_SETT.trim());
            cstmt.setString(3, filter.IN_TO_SETT.trim());
            cstmt.setString(4, filter.IN_FROM_UP.trim());
            cstmt.setString(5, filter.IN_TO_UP.trim());
            cstmt.setString(6, filter.IN_SOCIETY.trim());
            cstmt.setString(7, filter.IN_COUNTRY.trim());
            cstmt.setString(8, filter.IN_FILE_NAME.trim());
