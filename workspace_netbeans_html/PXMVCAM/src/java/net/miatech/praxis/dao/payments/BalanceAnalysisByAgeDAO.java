...
//        objRtn.MESSAGE = strMsj;
    ...
    public List<A2356Filter> getListTotalConciliation(A2356Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQPMPF115_REPORT_ST(?,?,?,?)}";
    ...
    public List<A2356Filter> getListTotalConciliation_Bard(A2356Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQPMPF115_REPORT_ST_BARD(?,?,?,?)}";
...
//                    bean.FCHILD = rst.getString("FCHILD").trim();
    ...
    public List<A2356Filter> load_MPS400(A2356Filter filter) throws SQLException, Exception {
        ...
        try {
            ...
            cstmt.setString(13, filter.IN_IDCONT);
            ...
            cstmt.setString(18, filter.IN_RETURN_ERROR);
            ...
            while (rst.next()) {
                ...
                bean.SCOUNTRY = rst.getString("SCOUNTRY").trim();
                bean.SCURRENCY = rst.getString("SCURRENCY").trim();
                bean.DAYS_PENDING = rst.getString("DAYS_PENDING").trim();
                bean.CERROR = rst.getString("CERROR").trim();
                bean.DESCRIPTION_CERROR = rst.getString("DESCRIPTION_CERROR").trim();
                ...
                bean.CODREC = rst.getString("CODREC").trim();
                bean.OBSERV = rst.getString("OBSERV").trim();
        ...
        try {
            ...
            for (A2356Filter f : filter) {
                try {
                    ...
                    cs.setString(4, f.CODPRO_ERROR.trim());
