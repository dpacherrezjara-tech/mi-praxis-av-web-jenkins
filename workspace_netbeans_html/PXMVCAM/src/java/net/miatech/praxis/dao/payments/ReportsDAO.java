...
//            rst.close();
     ...
     public List<A2356Filter> loadSQP05120_SMChgbck(A2356Filter filter) throws SQLException, Exception {
        ...
        int QTY_TOTAL_REVERSE = 0; double AMOUNT_TOTAL_REVERSE_USD = 0, AMOUNT_TOTAL_REVERSE_SEND = 0, AMOUNT_TOTAL_REVERSE_SAP = 0,AMOUNT_TOTAL_REVERSE_PENDING_USD = 0;
...
//            rst.close();
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    QTY_TOTAL_REVERSE += rst.getInt("QTY_REVERSE_CHGBACK");
                    AMOUNT_TOTAL_REVERSE_USD += rst.getDouble("AMOUNT_REVERSE_CHGBACK_USD");
                    AMOUNT_TOTAL_REVERSE_SEND += rst.getDouble("AMOUNT_REVERSE_CHGBACK_SEND");
                    AMOUNT_TOTAL_REVERSE_SAP += rst.getDouble("AMOUNT_REVERSE_CHGBACK_SAP");
                    AMOUNT_TOTAL_REVERSE_PENDING_USD += rst.getDouble("AMOUNT_REVERSE_PENDING_CHGBACK_SAP");
                    ...
                    bean.AMOUNT_TOTAL_CHGBACK_PENDING_USD_IDM = AMOUNT_TOTAL_CHGBACK_PENDING_USD_IDM;
                     ...
                     bean.QTY_TOTAL_REVERSE = QTY_TOTAL_REVERSE;
                    bean.AMOUNT_TOTAL_REVERSE_USD = AMOUNT_TOTAL_REVERSE_USD;
                    bean.AMOUNT_TOTAL_REVERSE_SEND = AMOUNT_TOTAL_REVERSE_SEND;
                    bean.AMOUNT_TOTAL_REVERSE_SAP = AMOUNT_TOTAL_REVERSE_SAP;
                    bean.AMOUNT_TOTAL_REVERSE_PENDING_USD = AMOUNT_TOTAL_REVERSE_PENDING_USD;
