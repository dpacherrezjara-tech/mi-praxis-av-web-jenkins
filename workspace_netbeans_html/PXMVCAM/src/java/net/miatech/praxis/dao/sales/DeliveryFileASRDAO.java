 ...
 * @author lmendoza
 */
public class DeliveryFileASRDAO {
    ...
    public DeliveryFileASRDAO(IServerSession ss) {
        session = ss;
    }
    ...
    public List<PX019S01A1536Filter> loadPX019S01A1536(PX019S01A1536Filter filter) throws SQLException, Exception {
        List<PX019S01A1536Filter> lstRtn = new ArrayList<>(0);
        PX019S01A1536Filter objRtn;

        CallableStatement cstmt01 = null;
        ResultSet rs01 = null;

        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".PX019S01A1536(?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt01.setString(2, filter.IN_PRDA);
