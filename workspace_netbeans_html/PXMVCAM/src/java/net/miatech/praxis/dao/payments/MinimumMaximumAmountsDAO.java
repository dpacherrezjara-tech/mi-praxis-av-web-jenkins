 ...
 * @author lmendoza
 */
public class MinimumMaximumAmountsDAO {
    ...
    public MinimumMaximumAmountsDAO() {
    }
    ...
    public MinimumMaximumAmountsDAO(IServerSession ss) {
        session = ss;
    }
    ...
    public A2353Filter loadPX620SQP05107_MPF112(A2353Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQMP_MPF112(?,?,?)}";
        ...
        try {
            ...
            cstmt01.setString(2, filter.IN_SCOUNTRY.trim());
            cstmt01.setString(3, filter.IN_SCURRENCY.trim());
            cstmt01.execute();
    ...
    public String loadPX305SQP00934(A2354Filter filter, String option) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00934_1(?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public List<A2353Filter> loadPX285SQP00827(A2353Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP0MPF102(?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(1, session.getUserView().getCustomerInfo().CCUST);
            cstmt.setString(2, filter.IN_SCURRENCY.trim());
            ...
            while (rst.next()) {
                ...
                bean.MINF2 = rst.getDouble("MINF2");
    ...
    public String loadPX285SQP00828(A2353Filter filter, String option) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00829_MPF112_CRUD(?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setDouble(5, filter.MAXF1);
            cstmt.setDouble(6, filter.MINF1);
            cstmt.setDouble(7, filter.MAXF2);
            cstmt.setDouble(8, filter.MINF2);
    ...
    public A2353Filter loadPX285SQP00829(A2353Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00829_MPF112DETAIL(?,?,?)}";
