        ...
        try {
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.lngQTOTSAL = rst.getLong("QSALES") + rst.getLong("QMATCH")+ rst.getLong("QMANUAL") + rst.getLong("QPEND");
                    ...
                    beanTkt.lngTotQTOTSAL = lngTotQSALES + lngTotQMATCH + lngTotQMANUAL + lngTotQPEND;
