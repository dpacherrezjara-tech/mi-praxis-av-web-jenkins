...
public class LoadConciliationDAO {
    ...
    public List<A2290Filter> loadPX263SQP00652(A2290Filter filter) throws SQLException, Exception {
        ...
        A2290Filter beanTkt;
        long lngTotQSALES = 0, lngTotQMATCH = 0, lngTotQMANUAL = 0, lngTotQDIFF = 0, lngTotQPEND = 0, lngTotQPOLIC = 0, lngTotQPOLIPE = 0, lngTotQEXT = 0;
        String Fec = "";
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00652_V1(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public List<A2290Filter> loadPX263SQP00652CORE(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00652CORE(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(14, filter.IN_ADYEN.trim());
            cstmt.setString(15, filter.IN_SCAR.trim());
            cstmt.setString(16, filter.IN_EXT.trim());
            cstmt.setString(17, "");
...
//                    beanTkt.lngTotQMATCHPercent = (lngTotQSALES > 0) ? (lngTotQMATCH * 100.0) / lngTotQSALES : 0.00;
    ...
    public List<A2290Filter> loadPX263SQP00655(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00655_1(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public HashMap<String, List<A2290Filter>> loadPX263SQP01828(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP01828_10(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(19, filter.IN_SCAR);
            cstmt.setString(20, filter.IN_EXT.trim());
    ...
    public HashMap<String, List<A2290Filter>> loadPX263SQP01828_REFND(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP01828_REFND(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(16, filter.IN_STVAL);
            cstmt.setString(17, filter.IN_strSVFOP);
            cstmt.setString(18, filter.IN_DEBTYPE);
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.IN_ADYEN = filter.IN_ADYEN.trim();
                    beanTkt.strPEM = "Refund";
                    beanTkt.TYPE = rst.getString("TYPE").trim();
...
//                    beanTkt.STCNTR = rst.getString("STCNTR").trim();
    ...
    public HashMap<String, List<A2290Filter>> loadPX263SQP01828_CHGBAK(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP01828_CHGBAK(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
...
//                    beanTkt.SAUTHOC = rst.getString("SAUTHOC").trim();
    ...
    public HashMap<String, List<A2290Filter>> loadPX263SQP01828_ACREDIT(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP01828_ACREDIT(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
...
//                    beanTkt.SERIE = rst.getString("SERIE").trim();
                    ...
                    beanTkt.TDOC = "A";
                    beanTkt.DATABASE = rst.getString("DATABASE").trim();
                    beanTkt.CASOCVS = rst.getString("CASOCVS").trim();
//                    beanTkt.SEQ = rst.getString("SEQ").trim();
                    if (hmDescEstados.containsKey(rst.getString("STVAL").trim().toUpperCase())) {
                        beanTkt.STVAL = hmDescEstados.get(rst.getString("STVAL").trim()).toString();
                    } else {
...
//                    beanTkt.STCNTR = rst.getString("STCNTR").trim();
    ...
    public HashMap<String, List<A2290Filter>> loadPX263SQP01828_ALLDEBITS(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP01828_ALLDEBITS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.IN_AUTHNBR = filter.IN_AUTHNBR.trim();
                    beanTkt.IN_ADYEN = filter.IN_ADYEN.trim();
                    beanTkt.strPEM = rst.getString("TDOC").trim();
                    beanTkt.TYPE = rst.getString("TYPE").trim();
                    beanTkt.strTicket = !rst.getString("TKT").trim().equals("") ? rst.getString("CCIA").trim() + " " + rst.getString("TKT").trim() : "without ticket";
                    beanTkt.CCIA = rst.getString("CCIA").trim();
                    beanTkt.TKT = rst.getString("TKT").trim();
//                    beanTkt.FORMA = rst.getString("FORMA").trim();
//                    beanTkt.SERIE = rst.getString("SERIE").trim();
...
//                    beanTkt.STCNTR = rst.getString("STCNTR").trim();
    ...
    public List<A2290Filter> loadPX263SQP00658(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00658_V2(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
...
//                    }
    ...
    public List<A2290Filter> loadPX263SQP00658_IBT(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00658_IBT(?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(6, filter.IN_BANDOC);
            cstmt.setString(7, filter.IN_TICKET);
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.TDOC = rst.getString("TDOC").trim();
                    beanTkt.SCOUNTRY = rst.getString("SCOUNTRY").trim();
                    beanTkt.DESC_SCOUNTRY = rst.getString("NAMES").trim();
                    beanTkt.SAGENT = rst.getString("SAGENT").trim();
                    beanTkt.SDATE = rst.getString("SDATE").trim();
                    beanTkt.SPAYMENT = rst.getString("SPAYMENT").trim();
                    beanTkt.SCARCOD = rst.getString("SCARCOD").trim();
    ...
    public A2290Filter loadPX263SQP00659_REFND(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00659_REFND(?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(2, filter.CCIA.trim());
            cstmt.setString(3, filter.TKT.trim());
            cstmt.setString(4, filter.SCARDN.trim());
            cstmt.setString(5, filter.SAUTHOC.trim());
            cstmt.setDouble(6, filter.SVFOP);
            cstmt.execute();
...
//                beanTkt.INSTPLA = rst.getString("INSTPLA").trim();
                ...
                beanTkt.SDATEL = safeTrim(rst, "SDATEL");
                beanTkt.SCARDNL = safeTrim(rst, "SCARDNL");
                beanTkt.MERCHNCL = safeTrim(rst, "MERCHNCL");
                beanTkt.SCARCODL = safeTrim(rst, "SCARCODL");
                beanTkt.SCOUNTRYL = safeTrim(rst, "SCOUNTRYL");
                beanTkt.SAUTHOCL = safeTrim(rst, "SAUTHOCL");
                beanTkt.SPNRL = safeTrim(rst, "SPNRL");
                beanTkt.SAGENTL = safeTrim(rst, "SAGENTL");
                beanTkt.SEQL = safeTrim(rst, "SEQL");
                beanTkt.NETOL = rst.getDouble("NETOL");  
    ...
    public String safeTrim(ResultSet rs, String column) throws SQLException {
    ...
    public A2290Filter loadPX263SQP00659_CHGBAK(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00659_CHGBAK(?,?)}";
        ...
        try {
            ...
            cstmt.setString(1, session.getUserView().getCustomerInfo().CCUST);
            cstmt.setString(2, filter.IDDEB.trim());
...
//                beanTkt.STCNTR = rst.getString("STCNTR").trim();
                beanTkt.SCURRENCY = rst.getString("CURRLOCAL").trim();
                beanTkt.SVFOP = rst.getDouble("VALLOCAL");
                beanTkt.SCARDN = rst.getString("SCARDN").trim();
                beanTkt.strSCARDN = Functions.enmascararNumTarjeta(rst.getString("SCARDN").trim(), rst.getString("SCARDN").trim());
//                beanTkt.SDATEXP = Functions.FormatFecha(rst.getString("SDATEXP").trim(), "MMyy", "yyyyMM");
...
//                beanTkt.INSTPLA = rst.getString("INSTPLA").trim();
    ...
    public A2290Filter loadPX263SQP00659_ACREDIT(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00659_ACREDIT(?,?)}";
        ...
        try {
            ...
            cstmt.setString(1, session.getUserView().getCustomerInfo().CCUST);
            cstmt.setString(2, filter.CASOCVS.trim());
...
//                beanTkt.INSTPLA = rst.getString("INSTPLA").trim();
    ...
    public List<A2290Filter> loadPX263SQP00676(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00676_1(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(17, filter.IN_SCAR.trim());
            cstmt.setString(18, filter.IN_EXT.trim());
...
//                    }
                    ...
                    //Armando Título del Detalle
                    if (beanTkt.strFecFiltro.equals("DATEC")) {
                        beanTkt.strTitulo = "Refund - Conciliation Date : ";
                    } else if (beanTkt.IN_TDOC.equals("R")) {
                        beanTkt.strTitulo = "Refund - Process Date : ";
                    } else {
                        beanTkt.strTitulo = "Refund - Process Date : ";
                    }
                    try {
                        beanTkt.strTitulo += filter.strFormatDate.trim() + " - Country : " + filter.strDescCountry.trim() + " **" + hmDescEstados.get(beanTkt.IN_STVAL).toString() + "** " + " Currency: " + filter.SCURRENCY;
                    } catch (Exception e) {
                    }
...
//                    }
                    ...
                    //Armando Título del Detalle
                    if (beanTkt.strFecFiltro.equals("DATEC")) {
                        beanTkt.strTitulo = "Chargeback - Conciliation Date : ";
                    } else if (beanTkt.IN_TDOC.equals("R")) {
                        beanTkt.strTitulo = "Chargeback - Process Date : ";
                    } else {
                        beanTkt.strTitulo = "Chargeback - Process Date : ";
                    }
                    try {
...
//                    }
                    ...
                    if (beanTkt.strFecFiltro.equals("DATEC")) {
                        beanTkt.strTitulo = "Acredit. - Conciliation Date : ";
                    } else if (beanTkt.IN_TDOC.equals("R")) {
                        beanTkt.strTitulo = "Acredit. - Process Date : ";
                    } else {
                        beanTkt.strTitulo = "Acredit. - Process Date : ";
                    }
                    try {
...
//                    }
    ...
    public List<MPF100Filter> loadPX263SQP00XXXJT2(MPF100Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00XXXJT2(?,?,?,?)}";
    ...
    public String loadPX263loadADM(List<MPF100Filter> filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00656ADM_V1(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public String loadPX263loadWithoutADM(List<MPF100Filter> filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00656WITHOUTADM_V1(?,?,?,?,?,?,?,?,?,?)}";
    ...
    public List<A2290Filter> loadPX269SQP00698DetalleSettl(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00698DETALLESETTL(?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.STCON = rst.getString("STCON").trim();
                    beanTkt.COREP = rst.getString("COREP").trim();
                    beanTkt.desCOREP = rst.getString("COREPN").trim();
