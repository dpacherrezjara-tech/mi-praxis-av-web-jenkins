 ...
 * @author jmeiggs
 */
public class CouponRegistrationDAO {
    ...
    public CouponRegistrationDAO(IServerSession ss) {
        session = ss;
    }
    ...
    public List<PX549S01A1747Filter> loadPX549S01A1747(PX549S01A1747Filter filter) throws SQLException, Exception {
        List<PX549S01A1747Filter> lstRtn = new ArrayList<>(0);
        PX549S01A1747Filter objRtn;
        ...
        try {
            ...
            while (rs01.next()) {
                objRtn = new PX549S01A1747Filter();
