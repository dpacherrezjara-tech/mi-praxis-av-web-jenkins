...
public class BankReconciliationDAO {
    ...
    //////////////////////
    ///////CASH  LIQ I 
    public List<A2290Filter> loadMPS629(A2290Filter filter)
        ...
        String SQLCLL01 = "{CALL PRAXISMP.MPS629(?,?,?)}";
         ...
         * DETALLE
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.lngQPEND = rst.getLong("QPEND");
                    beanTkt.lngTOTALE = rst.getLong("TOTALE");
                    beanTkt.lngQSALES = beanTkt.lngTOTALE;

                    beanTkt.lngQMATCHPercent
                            = beanTkt.lngTOTALE > 0
                                    ? (beanTkt.lngQMATCH * 100.0)
                                    / beanTkt.lngTOTALE
                                    : 0.00;

                    /*
                 * Totales para la fila TOTAL
                     */
                    beanTkt.lngTotQMATCH = lngTotQMATCH;
                    beanTkt.lngTotQMANUAL = lngTotQMANUAL;
                    beanTkt.lngTotQPEND = lngTotQPEND;
                    ...
                    beanTkt.lngTotQMATCHPercent
                            = lngTotTOTALE > 0
                                    ? (lngTotQMATCH * 100.0)
                                    / lngTotTOTALE
                                    : 0.00;
                    beanTkt.lngTotQSALES = lngTotTOTALE;
            ...
            session.getCNXIBMDB2()
                    .closeIBMDB2Connection(cnx);
        }
    ...
    //////////////////////
    ///////CASH  LIQ I DOWN
    public List<A2290Filter> loadMPS628(A2290Filter filter)
            throws SQLException, Exception {

        List<A2290Filter> lstTkts = new ArrayList<>();
        A2290Filter beanTkt;

        long lngTotQTMATCH = 0;
        long lngTotQTMANUAL = 0;
        long lngTotQTPEND = 0;
        long lngTotTOTALL = 0;
        ...
        String SQLCLL01 = "{CALL PRAXISMP.MPS628(?,?,?)}";
         ...
         * TOTALES
            ...
            while (rst.next()) {
                ...
                lngTotQTMATCH = rst.getLong("QMATCH");
                lngTotQTMANUAL = rst.getLong("QMANUAL");
                lngTotQTPEND = rst.getLong("QPEND");
                lngTotTOTALL = rst.getLong("TOTALE");
            }
         ...
         * DETALLE
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.SDATE = rst.getString("DATE").trim();
                    beanTkt.strFormatDate = Functions.getMonthConvert(beanTkt.SDATE);
                    beanTkt.lngQTMATCH = rst.getLong("QMATCH");
                    beanTkt.lngQTMANUAL = rst.getLong("QMANUAL");
                    beanTkt.lngQTPEND = rst.getLong("QPEND");
                    beanTkt.lngTOTALL = rst.getLong("TOTALE");
                    //beanTkt.lngQSALES = beanTkt.lngTOTALL;
                 ...
                 * Totales para la fila TOTAL
                    ...
                    beanTkt.lngQTMATCHPercent
                            = beanTkt.lngTOTALL > 0
                                    ? (beanTkt.lngQTMATCH * 100.0)
                                    / beanTkt.lngTOTALL
                                    : 0.00;

                    beanTkt.lngTotQTMATCHPercent
                            = lngTotTOTALL > 0
                                    ? (lngTotQTMATCH * 100.0) / lngTotTOTALL
                                    : 0.00;
    ...
    //////////////////////
    ///////CASH  LIQ II
    public List<A2290Filter> loadMPS626(A2290Filter filter)
            throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL PRAXISMP.MPS626(?,?,?)}";
    ...
    //////////////////////
    //CASH  LIQ II DOWN
    public List<A2290Filter> loadMPS627(A2290Filter filter)
            throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL PRAXISMP.MPS627(?,?,?)}";
...
//            A2290Filter filter = filters.get(0);
    ...
    public String loadPX269SQP05117_REFND(A2290Filter filter, UserView user) throws SQLException, Exception {

        //REALIZA EL INSERT, UPDATE O DELETE DE UN REGISTRO EN LA TABLA A2291.
        String strMsj = "", strCardn = "";
        CallableStatement cstmt = null;
        CallableStatement cstmt2 = null;
        Connection cnx = null;
        Connection cnx2 = null;

        String SQLCLL01 = "{CALL PRAXISMP.MPS216(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(8, filter.SAUTHOC.trim());
            cstmt.setString(9, filter.SEQ);
            cstmt.setDouble(10, filter.SVFOP);
            cstmt.setString(11, filter.BANDOC);
            cstmt.setString(12, filter.DATEC);
            cstmt.setString(13, filter.TRANC);
            cstmt.setString(14, user.getUserInfo().USR);
            cstmt.setString(15, Functions.getFechaActual());
            cstmt.setString(16, Functions.getHoraActual());
//            cstmt.setString(17, "");
...
//                    lngTotCant = lngTotCant + beanTkt.lngQACCB;
 ...
 /*if (!rst.getString("NCARDS").trim().isEmpty()) {
    ...
    public List<A2290Filter> loadPX269SQP00833_MDP_DETAIL(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP00956(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
...
//                beanTkt.CFUENTE = rst.getString("CFUENTE").trim();
    ...
    public List<A2290Filter> loadPX269SQP00833_MDP_SCAN(A2290Filter filter) throws SQLException, Exception {
        ...
        try {
            ...
            cstmt.setString(6, filter.SDATE_FROM.trim());
            cstmt.setString(7, filter.SDATE_TO.trim());
    ...
    public List<A2290Filter> loadPX269SQP00833_MDP_SCAN_PENDING(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS620(?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            int recordCount = 0; // NUEVO CONTADOR

            while (rst.next()) {
                recordCount++;

                // Solo instanciamos y agregamos a la lista los primeros 500
                if (recordCount <= 500) {
                    beanTkt = new A2290Filter();
            ...
            // NUEVA VALIDACIÓN: Si superó los 500, lanzamos la excepción con la cantidad
            if (recordCount > 500) {
                throw new Exception("EXCEDE_LIMITE|" + recordCount);
            }
    ...
    public List<A2290Filter> loadPXBeanTicketAgent(A2290Filter filter) throws SQLException, Exception {
        ...
        try {
            ...
            cstmt.setString(7, filter.IN_STRDATE.trim());
            cstmt.setString(8, filter.IN_ENDDATE.trim());
...
//            cstmt = cnx.prepareCall(SQLCLL01);
    ...
    public List<A2290Filter> loadPX269SQPMPF100(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS654(?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.CCUST_MPF100 = rst.getString("CCUST").trim();
                    beanTkt.CCIA_MPF100 = rst.getString("CCIA").trim();
                    beanTkt.FORMA_MPF100 = rst.getString("FORMA").trim();
                    beanTkt.SERIE_MPF100 = rst.getString("SERIE").trim();
                    beanTkt.TDOC_MPF100 = rst.getString("TDOC").trim();
                    beanTkt.SCARCOD_MPF100 = rst.getString("SCARCOD").trim();
                    beanTkt.SCARDNCOR_MPF100 = rst.getString("SCARDNCOR").trim();
                    beanTkt.SAUTHOC_MPF100 = rst.getString("SAUTHOC").trim();
                    beanTkt.SEQ_MPF100 = rst.getString("SEQ").trim();
                    beanTkt.CORRL_MPF100 = rst.getString("CORRL").trim();
        ...
        try {
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.IN_SDATE = rst.getString("DATE").trim();
                    beanTkt.strFormatDate = Functions.getMonthConvert(rst.getString("DATE").trim());
                    beanTkt.TINPUT = rst.getString("TINPUT").trim();
    ...
    public List<A2290Filter> loadPX269SQP00698CountryCash(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS324(?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(3, filter.IN_TDOC);
            cstmt.setString(4, filter.IN_COUNTRY);
            cstmt.setString(5, filter.IN_TINPUT);
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.IN_COUNTRY = filter.IN_COUNTRY.trim();
                    beanTkt.IN_TDOC = filter.IN_TDOC.trim();
                    beanTkt.IN_TINPUT = filter.IN_TINPUT.trim();
                    beanTkt.strFormatDate = Functions.getMonthConvert(beanTkt.IN_SDATE);
                    beanTkt.SCOUNTRY = rst.getString("SCOUNTRY").trim();
                    beanTkt.NAME = rst.getString("NAME").trim();
...
//            cstmt.setString(1, session.getUserView().getCustomerInfo().CCUST.trim());
            ...
            cstmt.setString(8, filter.O_SCONSOL.trim());
            cstmt.setString(9, filter.O_SCURRENCY.trim());
            cstmt.setString(10, filter.O_INVOICE.trim());
            cstmt.setString(11, filter.O_CBATCH.trim());
            cstmt.setString(12, filter.O_SEQ.trim());
            cstmt.setString(13, filter.REFERENCE.trim());
            cstmt.setString(14, filter.INVOICE.trim());
            cstmt.setString(15, filter.O_PRDA.trim());
...
//            cstmt.setString(1, filter.O_CCUST.trim());
    ...
    public List<A2290Filter> loadPX269SQP00698DayCash(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS325(?,?,?,?,?,?,?,?,?)}";
...
//                    beanTkt.NAME = rst.getString("NAME").trim();
    ...
    public List<A2290Filter> loadPX269SQP00698DetalleCash(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS326(?,?,?,?,?,"
                + "?,?,?,?,?,"
                + "?,?,?,?,?,"
                + "?)}";
        ...
        try {
            ...
            cstmt.setString(7, filter.IN_AGENCY.trim());
            cstmt.setString(8, filter.IN_FTE.trim());
            cstmt.setString(9, filter.IN_DATEC.trim());
            cstmt.setString(10, filter.IN_TRANC.trim());
            cstmt.setString(11, filter.IN_BANDOC.trim());
            cstmt.setString(12, filter.IN_TINPUT.trim());
            ...
            if (cstmt.getMoreResults()) {
                ...
                while (rst.next()) {
                    ...
                    beanTkt.SAGENT = rst.getString("SAGENT").trim();
                    // Consulta por el momento porque en el formateo tenemos que agregar el SCOONSOL
                    beanTkt.SCONSOL = rst.getString("SCONSOL").trim();
                    beanTkt.ADATE = rst.getString("ADATE").trim();
                    beanTkt.TINPUT = rst.getString("TINPUT").trim();
                    beanTkt.CBATCH = rst.getString("CBATCH").trim();
                    beanTkt.FECR = rst.getString("FECR").trim();
                    beanTkt.SCURRENCY = rst.getString("SCURRENCY").trim();
                    ...
                    beanTkt.CERROR = rst.getString("CERROR").trim();
                    beanTkt.STVAL = rst.getString("STVAL").trim();
                    beanTkt.CHEADER = rst.getString("CHEADER").trim();
                    beanTkt.NEGOC = rst.getString("NEGOC").trim();
                    if (beanTkt.NEGOC.equals("1")) {
                        beanTkt.NEGOC = "PASAJES";
                    }
    ...
    public A2290Filter loadPX269SQPXXXCash(A2290Filter filter) throws SQLException, Exception {
        ...
        // CALL
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS394(?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt01.setString(9, filter.FECR.trim());
            cstmt01.setString(10, filter.CHEADER.trim());
            cstmt01.execute();
            ...
            while (rs01.next()) {
                ...
                // STVAL + descripción mapeada
                objRtn.STVAL = rs01.getString("STVAL_FASE2");
                objRtn.descSTVAL = hmDescEstados.getOrDefault(
                        objRtn.STVAL.trim(),
                        objRtn.STVAL.trim()
                );
                ...
                // Datos MPF191
                objRtn.SCOUNTRY_191 = rs01.getString("SCOUNTRY_191").trim();
                objRtn.SCURRENCY_191 = rs01.getString("SCURRENCY_191").trim();
                objRtn.SCONSOL_191 = rs01.getString("SCONSOL_191").trim();
                objRtn.STARDATE_191 = rs01.getString("STARDATE_191").trim();
                objRtn.ENDDATE_191 = rs01.getString("ENDDATE_191").trim();
                objRtn.NETO_191 = rs01.getDouble("NETO_191");
                objRtn.PAYAMOU_191 = rs01.getDouble("PAYAMOU_191");
                objRtn.QTYTKT_191 = rs01.getString("QTYTKT_191").trim();
                objRtn.COMISION_191 = rs01.getDouble("COMISION_191");

                objRtn.lngPayamou = rs01.getLong("TOTAL_PAYAMOU");
                objRtn.lngPayamouPending = rs01.getLong("TOTAL_PAYAMOU_STVAL3");
                objRtn.lngPayamouMatch = rs01.getLong("DIF_PAYAMOU");
            }
    ...
    public List<A2290Filter> loadPX269SQP00833_MDP_DETAILCASH(A2290Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS395(?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(7, filter.FECR.trim());
            cstmt.setInt(8, filter.QTYDOC);
    ...
    public List<MPF100Filter> loadMPS306_AMDP_SCANCASH(MPF100Filter filter) throws SQLException, Exception {
        ...
        List<MPF100Filter> lstData = new ArrayList<MPF100Filter>(0);
        ...
        try {
            ...
            cstmt.setString(1, session.getUserView().getCustomerInfo().CCUST);
            cstmt.setString(2, filter.TICKET.trim());
            cstmt.setString(3, filter.SDATE_MIN.trim());
            cstmt.setString(4, filter.SDATE_MAX.trim());
            cstmt.setString(5, filter.SAGENT.trim());
            cstmt.setString(6, filter.SCOUNTRY.trim());
    ...
    public MPF100Filter ConciliationManualCash(MPF100Filter filter) throws SQLException, Exception {
        ...
        List<MPF100Filter> listaAgent = filter.getAgentList();
        int totalTkt = (listaAgent != null) ? listaAgent.size() : 0;
...
//                    cstmt.setString(6, mainC.SCOUNTRY != null ? mainC.SCOUNTRY.trim() : "");
    ...
    public Map<String, Object> reversaFaseDos(A2290Filter filter) throws Exception {
    ...
    public String executeCreateADM(List<A2290Filter> filters) throws Exception {
        String strMsj = "ADM created successfully.";
        CallableStatement cstmt = null;
        Connection cnx = null;
        ...
        try {
            ...
            String SQLCLL = "{CALL " + session.getMainLibrary() + "MP.MPS652(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";

            for (int i = 0; i < filters.size(); i++) {
                cstmt = cnx.prepareCall(SQLCLL);
                A2290Filter filter = filters.get(i);

                cstmt.setString(1, filter.CCUST_MPF100 != null ? filter.CCUST_MPF100.trim() : "");
                cstmt.setString(2, filter.CCIA_MPF100 != null ? filter.CCIA_MPF100.trim() : "");
                cstmt.setString(3, filter.FORMA_MPF100 != null ? filter.FORMA_MPF100.trim() : "");
                cstmt.setString(4, filter.SERIE_MPF100 != null ? filter.SERIE_MPF100.trim() : "");
                cstmt.setString(5, filter.TDOC_MPF100 != null ? filter.TDOC_MPF100.trim() : "");
                cstmt.setString(6, filter.SCARCOD_MPF100 != null ? filter.SCARCOD_MPF100.trim() : "");
                cstmt.setString(7, filter.SCARDNCOR_MPF100 != null ? filter.SCARDNCOR_MPF100.trim() : "");
                cstmt.setString(8, filter.SAUTHOC_MPF100 != null ? filter.SAUTHOC_MPF100.trim() : "");
                cstmt.setString(9, filter.SEQ_MPF100 != null ? filter.SEQ_MPF100.trim() : "");
                cstmt.setString(10, filter.CORRL_MPF100 != null ? filter.CORRL_MPF100.trim() : "");
                cstmt.setString(11, filter.ADJTYPE != null ? filter.ADJTYPE.trim() : "");
                cstmt.setString(12, filter.COMENT != null ? filter.COMENT.trim() : "");
                cstmt.setString(13, session.getUserView().getUserInfo().USR.trim());
                ...
                String outCode = cstmt.getString(14);
                String outMsg = cstmt.getString(15);

                if (!"00".equals(outCode)) {
                    throw new Exception("Error processing record: " + outMsg);
                }
            ...
            if (cstmt != null) {
                try {
                    ...
                    logError.error("SQLException -> User:" + session.getUserView().getUserInfo().USR.trim() + " Message: " + e.getMessage(), e);
                }
            }
            if (cnx != null) {
                session.getCNXIBMDB2().closeIBMDB2Connection(cnx);
    ...
    public List<A2290Filter> loadPX269SQPMPS653(A2290Filter filter) throws Exception {
        ...
        // Llamamos al Stored Procedure nuevo con solo 5 parámetros de entrada
        String SQLCLL = "{CALL " + session.getMainLibrary() + "MP.MPS653(?,?,?,?,?)}";
        ...
        try {
            ...
            // ==========================================
            // 1. Procesar el Primer ResultSet (Sumatorias)
            // ==========================================
            rst = cstmt.getResultSet();
            while (rst.next()) {
                dblTotSVFOP = rst.getDouble("SVFOP");
            ...
            // ==========================================
            // 2. Procesar el Segundo ResultSet (Datos Tickets)
            // ==========================================
            if (cstmt.getMoreResults()) {
                rst = cstmt.getResultSet();
                ...
                while (rst.next()) {
                    ...
                    // Capturar el Row Number generado en SQL
                    ...
                    // ==========================================
                    // 3. Mapeo específico para crear el ADM (_MPF100)
                    // ==========================================
                    beanTkt.CCUST_MPF100 = rst.getString("CCUST").trim();
                    beanTkt.CCIA_MPF100 = rst.getString("CCIA").trim();
                    beanTkt.FORMA_MPF100 = rst.getString("FORMA").trim();
