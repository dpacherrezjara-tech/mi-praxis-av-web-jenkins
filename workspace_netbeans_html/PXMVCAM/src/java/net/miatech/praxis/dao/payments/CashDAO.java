...
//    CREDITO
    ...
    public List<MPF300> loadMPS521(MPF108Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS521(?,?,?,?,?,?,?)}";
    ...
    public List<MPF300> loadMPS522(MPF108Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS522(?,?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public List<MPF300> loadMPS523(MPF108Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS523(?,?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public List<MPF300> loadMPS524(MPF108Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + "MP.MPS524(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
        ...
        try {
            ...
            cstmt.setString(8, filter.IN_TDOC);
            cstmt.setString(9, filter.IN_TICKET);
            cstmt.setString(10, filter.IN_PNR);
            cstmt.setString(11, filter.IN_SCARDN);
            cstmt.setString(12, filter.IN_SCARDNCOR);
            cstmt.setString(13, filter.IN_AUTHORIZATION);
            cstmt.setString(14, filter.IN_CCTYPE);
            cstmt.setString(15, filter.IN_AGENT);
            cstmt.setDouble(16, filter.IN_AMOUNT);
            cstmt.setString(17, filter.IN_CURRENCY);
            ...
            System.err.println("🔥 ERROR REAL en loadMPS524:");
            e.printStackTrace();
            throw e;
        } finally {
            if (rst != null) {
