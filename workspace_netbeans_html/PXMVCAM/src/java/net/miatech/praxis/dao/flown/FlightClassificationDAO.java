 ...
 * @author gsanchez
 */
public class FlightClassificationDAO {
    ...
    public FlightClassificationDAO() {
    }
    ...
    public String FlightClassificationMaintance(A051 filter, String strOption) throws SQLException, Exception {
