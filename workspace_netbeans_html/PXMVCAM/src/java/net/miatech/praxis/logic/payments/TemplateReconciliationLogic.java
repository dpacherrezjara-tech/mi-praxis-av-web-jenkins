...
public class TemplateReconciliationLogic {
    ...
    public MPS419Response searchPendingDepositsSalesReview(A2290Filter filter) throws SQLException, Exception {
        return objDAO.searchPendingDepositsSalesReview(filter);
    }

    public String MaintenanceA2280(A2290Filter bean) throws Exception {
        return objDAO.MaintenanceA2280(bean);
    }
