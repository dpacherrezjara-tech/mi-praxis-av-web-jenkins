...
import net.miatech.praxis.dao.salesAudit.BwrRefundTicketControlDAO;

/**
 *
 * @author lremicio
 */
public class BwrRefundTicketControlLogic {
    
    private BwrRefundTicketControlDAO objDAO = new BwrRefundTicketControlDAO();
