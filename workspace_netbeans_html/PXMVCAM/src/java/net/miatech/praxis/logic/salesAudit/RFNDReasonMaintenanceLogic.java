...
import net.miatech.praxis.dao.salesAudit.RFNDReasonMaintenanceDAO;

/**
 *
 * @author zperez
 */
public class RFNDReasonMaintenanceLogic {
    
    private RFNDReasonMaintenanceDAO objDAO = new RFNDReasonMaintenanceDAO();
