...
import net.miatech.praxis.dao.sales.AccountingMasterProcessAdjDAO;
 ...
 * @author gsanchez
 */
public class AccountingMasterProcessAdjLogic {

    private AccountingMasterProcessAdjDAO objDAO = new AccountingMasterProcessAdjDAO();
