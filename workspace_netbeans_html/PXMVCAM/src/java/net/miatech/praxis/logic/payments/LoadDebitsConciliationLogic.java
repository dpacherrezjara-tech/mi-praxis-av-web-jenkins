 ...
 * @author anthonyBash
 */
public class LoadDebitsConciliationLogic {

    private final LoadDebitsConciliationDAO terminalsCatalogDAO = new LoadDebitsConciliationDAO();
    ...
    public String SQP05099(List<A2290Filter> lstData, UserView user) throws Exception {
        return terminalsCatalogDAO.SQP05099(lstData,user );
    }
