...
import static net.miatech.praxis.classes.ReportADMARCPDF.RESOURCES;

/**
 *
 * @author zperez
 */
public class ReportMasivoADMARCPDF {

    private String FILE = "ARCPDF.pdf";
    ...
    public File createReport(SQP00911Filter obj, File directorio) {
        ...
        try {
            //fileTmp01 = File.createTempFile(Data.NUMBERADM, FILE);
            fileTmp01 = new File(directorio, obj.A2548NMEMO.trim() + FILE);
            ...
            ReportMasivoADMARCPDF.TableHeader event = new ReportMasivoADMARCPDF.TableHeader();
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548NMEMO, subFont)), 395, PYi + 2, 0);
            PYi = 795;

            colorRectangle(under, GrayColor.GRAYWHITE, PosX1 + 270, PYi, 95, 13);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("MEMO DATE: ", subFont)), PosX1 + 275, PYi + 2, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 380, PYi, 185, 13);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548FCONT.substring(0, 4) + "-" + net.miatech.utils.Functions.getAbreviaturaMes(obj.A2548FCONT.substring(4, 6)) + "-" + obj.A2548FCONT.substring(6, 8), subFont)), 395, PYi + 2, 0);

            PYi = 822;
            PYi = PYi - 55; //10            
            if (obj.A2548TRNCU.equals("ACM")) {
            ...
            colorRectangle(under, GrayColor.GRAYWHITE, 380, PYi, 185, 13);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548IATA, subFont)), 395, PYi + 2, 0);
            ...
            if (obj.lst_TKT.size() > 0) {
                if (obj.A2548CATNNTD > 1) {
                    ...
                    VL_CntTKT = obj.lst_TKT.get(0).A2548TIKET;
                    VL_PAX = obj.lst_TKT.get(0).A2548PAX;
                    VL_DATESALE = obj.lst_TKT.get(0).A2548FVTA.substring(0, 4) + "-" + net.miatech.utils.Functions.getAbreviaturaMes(obj.lst_TKT.get(0).A2548FVTA.substring(4, 6)) + "-" + obj.lst_TKT.get(0).A2548FVTA.substring(6, 8);
                    //getAbreviaturaMes
                }
            } else {
                VL_CntTKT = obj.lst_TKT.get(0).A2548TIKET;
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.lst_TKT.get(0).A2548CODIT, subFont)), PosX1 + 75, PYi - 1, 0);
            PYi = PYi - (Hlng + 10);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548MDA, subFont)), PosX1 + 3, PYi, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548TARIF), subFont)), 195 - (((formato_numero(obj.A2548TARIF)).length() <= 4 ? 4 : (formato_numero(obj.A2548TARIF)).length() * 3) - 8), PYi, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548TARIA), subFont)), 365 - (((formato_numero(obj.A2548TARIA)).length() <= 4 ? 4 : (formato_numero(obj.A2548TARIA)).length() * 3) - 8), PYi, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548TARID), subFont)), 538 - (((formato_numero(obj.A2548TARID)).length() <= 4 ? 4 : (formato_numero(obj.A2548TARID)).length() * 3) - 8), PYi, 0);
            PYi = PYi - (Hlng + 3);
            colorRectangle(under, GrayColor.GRAYWHITE, PosX1, PYi - 4, 35, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548MDA, subFont)), PosX1 + 3, PYi, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 50, PYi - 4, 70, 15);
            ...
            colorRectangle(under, GrayColor.GRAYWHITE, 120, PYi - 4, 100, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548TTAX), subFont)), 195 - (((formato_numero(obj.A2548TTAX)).length() <= 4 ? 4 : (formato_numero(obj.A2548TTAX)).length() * 3) - 8), PYi, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 220, PYi - 4, 75, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("TOTAL TAX:", subFont)), 225, PYi, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 295, PYi - 4, 95, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548TTAXA), subFont)), 365 - (((formato_numero(obj.A2548TTAXA)).length() <= 4 ? 4 : (formato_numero(obj.A2548TTAXA)).length() * 3) - 8), PYi, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 390, PYi - 4, 75, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("TOTAL TAX:", subFont_1)), 395, PYi, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 465, PYi - 4, 100, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548TTAXD), subFont)), 538 - (((formato_numero(obj.A2548TTAXD)).length() <= 4 ? 4 : (formato_numero(obj.A2548TTAXD)).length() * 3) - 8), PYi, 0);

            PYi = PYi - (Hlng + 8);
            for (int i = 0; i < obj.lstImpues.size(); i++) {
                colorRectangle(under, GrayColor.GRAYWHITE, 80, PYi, 50, 15);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.lstImpues.get(i).A1673CDTAX, subFont)), 85, PYi + 5, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 120, PYi, 100, 15);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.lstImpues.get(i).A1673TXMIA), subFont)), 195 - (((formato_numero(obj.lstImpues.get(i).A1673TXMIA)).length() <= 4 ? 4 : (formato_numero(obj.lstImpues.get(i).A1673TXMIA)).length() * 3) - 8), PYi + 5, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 250, PYi, 50, 15);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.lstImpues.get(i).A1673CDTAX, subFont)), 255, PYi + 5, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 295, PYi, 95, 15);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.lstImpues.get(i).A1673TXORI), subFont)), 365 - (((formato_numero(obj.lstImpues.get(i).A1673TXORI)).length() <= 4 ? 4 : (formato_numero(obj.lstImpues.get(i).A1673TXORI)).length() * 3) - 8), PYi + 5, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 425, PYi, 50, 15);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.lstImpues.get(i).A1673CDTAX, subFont)), 430, PYi + 5, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 465, PYi, 100, 15);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.lstImpues.get(i).A1673TXDIF), subFont)), 538 - (((formato_numero(obj.lstImpues.get(i).A1673TXDIF)).length() <= 4 ? 4 : (formato_numero(obj.lstImpues.get(i).A1673TXDIF)).length() * 3) - 8), PYi + 5, 0);
                PYi = PYi - Hlng;
            }
            PYi = PYi - 4;
            ...
            colorRectangle(under, GrayColor.GRAYWHITE, 120, PYi, 100, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548PENAL), subFont)), 195 - (((formato_numero(obj.A2548PENAL)).length() <= 4 ? 4 : (formato_numero(obj.A2548PENAL)).length() * 3) - 8), PYi + 5, 0);
            ...
            colorRectangle(under, GrayColor.GRAYWHITE, 295, PYi, 95, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548PENAA), subFont)), 365 - (((formato_numero(obj.A2548PENAA)).length() <= 4 ? 4 : (formato_numero(obj.A2548PENAA)).length() * 3) - 8), PYi + 5, 0);
            ...
            colorRectangle(under, GrayColor.GRAYWHITE, 465, PYi, 100, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548PENAD), subFont)), 538 - (((formato_numero(obj.A2548PENAD)).length() <= 4 ? 4 : (formato_numero(obj.A2548PENAD)).length() * 3) - 8), PYi + 5, 0);
            PYi = PYi - (Hlng + 4);
            colorRectangle(under, GrayColor.GRAYWHITE, 50, PYi, 70, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Commission:", subFont)), 55, PYi + 5, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 120, PYi, 100, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548COMIS + obj.A2548SCOM), subFont)), 195 - (((formato_numero(obj.A2548COMIS + obj.A2548SCOM)).length() <= 4 ? 4 : (formato_numero(obj.A2548COMIS + obj.A2548SCOM)).length() * 3) - 8), PYi + 5, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 220, PYi, 75, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Commission:", subFont)), 225, PYi + 5, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 295, PYi, 95, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548COMIA + obj.A2548SCOMA), subFont)), 365 - (((formato_numero(obj.A2548COMIA + obj.A2548SCOMA)).length() <= 4 ? 4 : (formato_numero(obj.A2548COMIA + obj.A2548SCOMA)).length() * 3) - 8), PYi + 5, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 390, PYi, 75, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Commission:", subFont)), 395, PYi + 5, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 465, PYi, 100, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548COMID + obj.A2548SCOMD), subFont)), 538 - (((formato_numero(obj.A2548COMID + obj.A2548SCOMD)).length() <= 4 ? 4 : (formato_numero(obj.A2548COMID + obj.A2548SCOMD)).length() * 3) - 8), PYi + 5, 0);
            PYi = PYi - (Hlng + 4);
            colorRectangle(under, GrayColor.GRAYWHITE, 390, PYi, 75, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("NET :", subFont)), 395, PYi + 5, 0);
            colorRectangle(under, GrayColor.GRAYWHITE, 465, PYi, 100, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548NETO), subFont)), 538 - (((formato_numero(obj.A2548NETO)).length() <= 4 ? 4 : (formato_numero(obj.A2548NETO)).length() * 3) - 8), PYi + 5, 0);
            PYi = PYi - (Hlng + 3);
            PosX1 = 15;
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548FCONT.substring(0, 4) + "-" + net.miatech.utils.Functions.getAbreviaturaMes(obj.A2548FCONT.substring(4, 6)) + "-" + obj.A2548FCONT.substring(6, 8), subFont)), PosX1 + 3, PYi + 2, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548NETO), subFont)), 150 - (((formato_numero(obj.A2548NETO)).length() <= 4 ? 4 : (formato_numero(obj.A2548NETO)).length() * 3) - 8), PYi + 2, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548MDA, subFont)), 210, PYi + 2, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strNombreAgente, subFont_negr)), PosX1 + 3, PYi + 70, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strDirecAgente, subFont_negr)), PosX1 + 3, PYi + 60, 0);
            if (obj.strZIPCOD.length() > 5) {
                vl_ZIPCOD = obj.strZIPCOD.substring(0, 5) + "-" + obj.strZIPCOD.substring(5, obj.strZIPCOD.length());
            } else {
                vl_ZIPCOD = obj.strZIPCOD;
            }
            //
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strDISTRI + " " + obj.strDEPART + " " + vl_ZIPCOD, subFont_negr)), PosX1 + 3, PYi + 50, 0);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strCOUNTRY + "A", subFont_negr)), 20, PYi + 40, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548NMEMO, subFont)), 312, PYi + 5, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548IATA, subFont)), 410, PYi + 5, 0);
            ...
            document.add(img4);
            PYi = PYi - (Hlng + 30);
            if (obj.beanFacsimil.AGTN.equals("")) {
                VL_PAX = "MULTI";
            }
            if (VL_PAX.equals("MULTI")) {
                ...
                PYi = PYi - 12;
                for (int i = 0; i < obj.lst_TKT.size(); i++) {
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.lst_TKT.get(i).A2548TIKET, subFont)), 16, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.lst_TKT.get(i).A2548FVTA.substring(0, 4) + "-" + net.miatech.utils.Functions.getAbreviaturaMes(obj.lst_TKT.get(i).A2548FVTA.substring(4, 6)) + "-" + obj.lst_TKT.get(i).A2548FVTA.substring(6, 8), subFont)), PosXTO, PYi, 0);
                    ...
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.lst_TKT.get(i).A2548NETO), subFont)), 220 - (((formato_numero(obj.lst_TKT.get(i).A2548NETO)).length() <= 4 ? 4 : (formato_numero(obj.lst_TKT.get(i).A2548NETO)).length() * 3) - 8), PYi + 3, 0);
                    PYi = PYi - Hlng;
                }
                ...
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.A2548NETO), subFont)), 225, PYi + 5, 0);
                ...
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("ISSUEDx BY: " + obj.STRNOMAEREO, subFont)), PosX1 + 2, PYi + 3, 0);
                ...
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.lst_TKT.get(0).A2548TIKET, subFont)), 175, PYi + 2, 0);
                ...
                if(!obj.beanFacsimil.TODC.trim().equals("")){
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.TODC.substring(0, 3) + " - " + obj.beanFacsimil.TODC.substring(3), subFont)), 340, PYi + 3, 0);
                }
                ...
                colorRectangle(under, GrayColor.GRAYWHITE, 170, PYi, 70, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548FTE, subFont)), 175, PYi + 2, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 240, PYi, 95, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("PNR", subFont)), 245, PYi + 3, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 335, PYi, 85, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.PNRR, subFont)), 340, PYi + 3, 0);
                PYi = PYi - (Hlng + 2);
                PYi = PYi - (Hlng + 2);

                for (int i = 0; i < obj.beanFacsimil.lstReg46Restrict.size(); i++) {
                    strRestrict += obj.beanFacsimil.lstReg46Restrict.get(i).toString();
                }

                colorRectangle(under, GrayColor.GRAYWHITE, PosX1, PYi, 270, 26);
                if (strRestrict.length() > 53) {
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(strRestrict.substring(0, 53), subFont)), PosX1 + 2, PYi + 15, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(strRestrict.substring(57, strRestrict.length()), subFont)), PosX1 + 2, PYi + 5, 0);

                } else {
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(strRestrict, subFont)), PosX1 + 2, PYi + 10, 0);
                }

                colorRectangle(under, GrayColor.GRAYWHITE, 285, PYi, 95, 26);//240
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("TOUR CODE", subFont)), 290, PYi + 15, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 335, PYi, 85, 26);
                if (obj.beanFacsimil.TOUR.length() > 53) {
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.TOUR.substring(0, 53), subFont)), 340, PYi + 15, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.TOUR.substring(57, obj.beanFacsimil.TOUR.length()), subFont)), 340, PYi + 5, 0);

                } else {
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.TOUR, subFont)), 340, PYi + 10, 0);
                }
                ...
                PYi = PYi - (Hlng + 2);
                colorRectangle(under, GrayColor.GRAYWHITE, PosX1, PYi, 154, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.PXNM, subFont)), PosX1 + 1, PYi + 3, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 170, PYi, 70, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.DAIS, subFont)), 175, PYi + 3, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 240, PYi, 180, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.strIssExc, subFont)), 246, PYi + 3, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 420, PYi, 155, 97);

                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strNombreAgente, subFont)), 425, PYi + 75, 0);
                if (obj.strDirecAgente.length() <= 29) {
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strDirecAgente, subFont)), 425, PYi + 65, 0);
                } else {
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strDirecAgente.substring(0, 29), subFont)), 425, PYi + 65, 0);
                    if ((obj.strDirecAgente.length() - 29) <= 29) {
                        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strDirecAgente.substring(29, obj.strDirecAgente.length()), subFont)), 425, PYi + 55, 0);
                    } else {
                        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strDirecAgente.substring(58, 87), subFont)), 425, PYi + 45, 0);
                        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.strDirecAgente.substring(116, obj.strDirecAgente.length()), subFont)), 425, PYi + 45, 0);
                    }
                }
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Country " + obj.strCOUNTRY + " District " + obj.strDISTRI, subFont)), 425, PYi + 40, 0);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("County " + obj.strDEPART + " Zipcode " + obj.strZIPCOD, subFont)), 425, PYi + 30, 0);

                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548IATA, subFont)), 480, PYi + 10, 0);
                ...
                PYi = PYi - 12;
                for (int i = 0; i < obj.beanFacsimil.lstReg63.size(); i++) {
                    ...
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).STPO, subFont)), 17, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).ORAC, subFont)), PosXFROM, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).DSTC, subFont)), PosXTO, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).CARR, subFont)), PosXCARRI + 10, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).FTNR, subFont)), PosXFLIGHT + 5, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).RBKD, subFont)), PosXCL + 5, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).FTDA, subFont)), PosXDATE, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).FTDT, subFont)), PosXTIME, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).FBST, subFont)), PosXST, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).FBTD, subFont)), PosXFAREB, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).NBDA, subFont)), PosXVALIDB + 10, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).NADA, subFont)), PosXVALIDA + 10, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).strUso, subFont)), PosXUSE + 5, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).strFecUso, subFont)), PosXDATE2, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(obj.beanFacsimil.lstReg63.get(i).dblMontoUso), subFont)), PosXVALUE + 5, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstReg63.get(i).strLeg, subFont)), PosXLEG + 5, PYi, 0);
                    PYi = PYi - Hlng;
                }
                PYi = PYi - (Hlng - 7);
                PosX1 = 15;
                ...
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.CUTP1 + " " + formato_numero(Double.parseDouble(obj.beanFacsimil.FARE)), subFont)), 120, PYi + 2, 0);
                PYi = PYi - (Hlng + 2);
                colorRectangle(under, GrayColor.GRAYWHITE, PosX1, PYi, 100, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("EQUIV", subFont)), PosX1 + 2, PYi + 3, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 116, PYi, 125, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.EQFR.replaceAll("}", "").substring(0, 3).trim() + " " + formato_numero(Double.parseDouble(obj.beanFacsimil.EQFR.replaceAll("}", "").substring(3))), subFont)), 145, PYi + 2, 0);
                ...
                for (int i = 0; i < obj.beanFacsimil.lstFC.size(); i++) {
                    strFC += obj.beanFacsimil.lstFC.get(i).toString().trim();
                }//64 tamaño normal
                if (strFC.length() <= 58) {
                ...
                PYi = PYi - (Hlng + 3);
                for (int i = 0; i < obj.beanFacsimil.lstFOP.size(); i++) {
                    strTexto += obj.beanFacsimil.lstFOP.get(i).toString().trim();
                }//64 tamaño normal
                ...
                for (int i = 0; i < obj.beanFacsimil.lstTaxes.size(); i++) {
                    colorRectangle(under, GrayColor.GRAYWHITE, 40, PYi, 75, 15);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.lstTaxes.get(i), subFont)), 100, PYi + 5, 0);
                ...
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.CUTP1 + " " + formato_numero(Double.parseDouble(obj.beanFacsimil.TOTL)), subFont)), 145, PYi + 2, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 240, PYi, 95, 13);
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.A2548TIKET, subFont)), 255, PYi + 3, 0);
                colorRectangle(under, GrayColor.GRAYWHITE, 335, PYi, 85, 13);
                ...
                ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(obj.beanFacsimil.strConjuncion.trim(), subFont)), 425, PYi + 2, 0);
            }
