 ...
 * @author zperez
 */
public class ReportADMASRPDF {

    private String FILE = "RptADMASRPDF.pdf";
    ...
    public File createReport(SQP00911Filter Data, List<SQP00911Filter> lst_razones, List<FACSIMILFilter> searchAgent, List<SQP00911Filter> lst_TKT, List<SQP00911Filter> List_TKTSUM) {
        ...
        try {
            ...
            ReportADMASRPDF.TableHeader event = new ReportADMASRPDF.TableHeader();
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.A2548PREME, subFont)), 380, PYi + 2, 0);

            PYi = PYi - Hlng;
            Phrase txtDisputado = new Phrase(new Paragraph("Office ", subFont));
            Phrase datDisputado = new Phrase(new Paragraph(Data.AGENCY, subFont));
            ...
            Phrase datPagado = new Phrase(new Paragraph(Data.A2548EMPLE, subFont));
            ...
            colorRectangle(under, GrayColor.GRAYWHITE, 375, PYi, 185, 13);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.A2548MDA, subFont)), 380, PYi + 2, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TARIF), subFont)), 183 - (((formato_numero(List_TKTSUM.get(0).A2548TARIF)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548TARIF)).length() * 3) - 8), PYi + 3, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TARIA), subFont)), 360 - (((formato_numero(List_TKTSUM.get(0).A2548TARIA)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548TARIA)).length() * 3) - 8), PYi + 3, 0);
            ...
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TARID), subFont)), 535 - (((formato_numero(List_TKTSUM.get(0).A2548TARID)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548TARID)).length() * 3) - 8), PYi + 3, 0);
            ...
            PosX1 = PosX1 + 75;
            colorRectangle(under, GrayColor.GRAYWHITE, 80, PYi - 1, 140, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TTAX), subFont)), 183 - (((formato_numero(List_TKTSUM.get(0).A2548TTAX)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548TTAX)).length() * 3) - 8), PYi + 3, 0);
                    //(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TTAX), subFont)), PosX1 + 2, PYi + 3, 0);
            PosX1 = PosX1 + 165;
            colorRectangle(under, GrayColor.GRAYWHITE, 220, PYi - 1, 170, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TTAXA), subFont)), 360 - (((formato_numero(List_TKTSUM.get(0).A2548TTAXA)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548TTAXA)).length() * 3) - 8), PYi + 3, 0);
                    //(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TTAXA), subFont)), PosX1 + 2, PYi + 3, 0);
            PosX1 = PosX1 + 165;
            colorRectangle(under, GrayColor.GRAYWHITE, 390, PYi - 1, 175, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548TTAXD), subFont)), 535 - (((formato_numero(List_TKTSUM.get(0).A2548TTAXD)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548TTAXD)).length() * 3) - 8), PYi + 3, 0);
            ...
            PosX1 = PosX1 + 75;
            colorRectangle(under, GrayColor.GRAYWHITE, 80, PYi - 1, 140, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548SERVI), subFont)), 183 - (((formato_numero(List_TKTSUM.get(0).A2548SERVI)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548SERVI)).length() * 3) - 8), PYi + 3, 0);
                    //(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548SERVI), subFont)), PosX1 + 2, PYi + 3, 0);
            PosX1 = PosX1 + 165;
            colorRectangle(under, GrayColor.GRAYWHITE, 220, PYi - 1, 170, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548SERVA), subFont)), 360 - (((formato_numero(List_TKTSUM.get(0).A2548SERVA)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548SERVA)).length() * 3) - 8), PYi + 3, 0);
                    //(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548SERVA), subFont)), PosX1 + 2, PYi + 3, 0);
            PosX1 = PosX1 + 165;
            colorRectangle(under, GrayColor.GRAYWHITE, 390, PYi - 1, 175, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548SERVD), subFont)), 535 - (((formato_numero(List_TKTSUM.get(0).A2548SERVD)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548SERVD)).length() * 3) - 8), PYi + 3, 0);
            ...
            PosX1 = PosX1 + 75;
            colorRectangle(under, GrayColor.GRAYWHITE, 80, PYi - 1, 140, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548COMIS), subFont)), 183 - (((formato_numero(List_TKTSUM.get(0).A2548COMIS)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548COMIS)).length() * 3) - 8), PYi + 3, 0);
                    //(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548COMIS), subFont)), PosX1 + 2, PYi + 3, 0);
            PosX1 = PosX1 + 165;
            colorRectangle(under, GrayColor.GRAYWHITE, 220, PYi - 1, 170, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548COMIA), subFont)), 360 - (((formato_numero(List_TKTSUM.get(0).A2548COMIA)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548COMIA)).length() * 3) - 8), PYi + 3, 0);
                    //(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548COMIA), subFont)), PosX1 + 2, PYi + 3, 0);
            PosX1 = PosX1 + 165;
            colorRectangle(under, GrayColor.GRAYWHITE, 390, PYi - 1, 175, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548COMID), subFont)), 535 - (((formato_numero(List_TKTSUM.get(0).A2548COMID)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548COMID)).length() * 3) - 8), PYi + 3, 0);
            ...
            colorRectangle(under, GrayColor.GRAYWHITE, 390, PYi - 1, 175, 15);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(formato_numero(List_TKTSUM.get(0).A2548NETO), subFont)), 535 - (((formato_numero(List_TKTSUM.get(0).A2548NETO)).length() <= 4 ? 4 : (formato_numero(List_TKTSUM.get(0).A2548NETO)).length() * 3) - 8), PYi + 3, 0);
            ...
            //PRIMER CASO
            if ((Data.A2548CANAL.equals("ATO") && Data.A2548CIUD.equals("MEX")) || (Data.A2548CANAL.equals("CTO") || Data.A2548CANAL.equals("GSA"))) {
            ...
            else if (Data.A2548CANAL.equals("ATO") && Data.A2548PAIS.equals("MX") && !(Data.A2548CIUD.equals("MEX"))) {
            ...
            PYi = PYi - (Hlng + 10);
            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(lst_TKT.get(0).A2548REGIS, subFont)), PosX1 + 55, PYi + 3, 0);
