Ext.define('Ext.Praxis.controller.panel.ReportAccessLog.ReportAccessLogController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ReportAccessLogController',
...
//        this.btnSearch_click();
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.panel.ReportAccessLog.GridData', {
            proxy: {
