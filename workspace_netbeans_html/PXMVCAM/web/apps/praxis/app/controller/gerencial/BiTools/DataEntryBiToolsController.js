Ext.define('Ext.Praxis.controller.gerencial.BiTools.DataEntryBiToolsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryBiToolsController',
...
//        this.bean_scan.SCARCOD = Ext.getCmp(prototype.id + '-cmbSCARCOD').getValue();
        ...
        Ext.Ajax.request({
            url: '/AVIANCA/ManualConciliation/searchBeanAMDP_SCAN',
            method: 'POST',
            timeout: 60000000,
            params: paramScan,
...
//        this.bean.CCUSTCC = Ext.getCmp(prototype.id + '-de-txtCCUSTCC').getValue();
        ...
        Ext.Ajax.request({
            url: '/AVIANCA/ManualConciliation/searchBeanAMDP_SCAN_PENDING',
            method: 'POST',
            timeout: 60000000,
            params: paramDetail,
            beforerequest: Ext.getCmp(prototype.id + '-dataEntry').mask('Loading...'),
...
// <editor-fold defaultstate="collapsed" desc="Botones">
    ...
    executeOption: async function (beanTemp, option) {
        ...
        if (miGrilla) {
            ...
            if (datos == false) {
                ...
                Ext.Ajax.request({
                    url: '/AVIANCA/ManualConciliation/executeOption',
                    method: 'POST',
                    timeout: 60000000,
    ...
    procesarRegistros: async function (grilla) {
        ...
        if (isExistRange && !(montoAjuste >= amountMin && montoAjuste <= amountMax)) {
            return false;
        }
