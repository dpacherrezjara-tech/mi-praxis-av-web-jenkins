 ...
 */
Ext.define('Ext.Praxis.controller.gerencial.BiTools.BiToolsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BiToolsController',
    fecha: new Date(),
    drillDown: [],
    gridActual: '',
    orderbyEtiquetas: '',
    ...
    init: function (view) {
        prototype.id = 'BiToolsForm';
        prototype.url = CONTEXTPATH + '/BiTools';
        me = this;
        this.control({
            // -------------------Eventos Genericos --------------------
            '#BiToolsForm-xpanel': {
            ...
            ,
            '#BiToolsForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#BiToolsForm-btnClear': {
                click: this.btnClear_click
            },
            '#BiToolsForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#BiToolsForm-btnTxt': {
                click: this.btnTXT_click
            },
            '#BiToolsForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#BiToolsForm-btnDisplay': {
                click: this.btnDisplay_click
            },
            '#BiToolsForm-btnBack': {
                click: this.btnBack_click
            },
            '#BiToolsForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#BiToolsForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#BiToolsForm-btn-pag-next': {
                click: this.pagNext
            },
            '#BiToolsForm-btn-pag-last': {
                click: this.pagLast
            },
            '#BiToolsForm-imgInfo': {
            ...
            '#BiToolsForm-imgView': {
                click: this.onClickImgView
            },
            '#BiToolsForm-cmbFav': {
                select: this.onSelectCmbFav
            },
            '#BiToolsForm-imgBuild': {
    ...
    xpanel_afterrender: function (obj, e) {
        ...
        new Ext.util.KeyMap({
            target: Ext.getBody(),
            binding: {
                key: 27, // Se activa al presionar la tecla Escape
                fn: function () {
...
//        Ext.getCmp(prototype.id + '-gridData').hide();
    ...
    onClickImgInfo: function () {
        ...
        Ext.create('Ext.Praxis.view.gerencial.BiToolsForm.DataEntryHelp', {
    ...
    onClickImgSave: function () {
        ...
        Ext.create('Ext.Praxis.view.gerencial.BiToolsForm.DataEntrySaveQuery', {
...
//            me.beanDetailTW.IN_FECHA_TO = Ext.getCmp(prototype.id + '-cmbDateYear').getValue() + Ext.getCmp(prototype.id + '-cmbDateMonth').getValue() + Ext.getCmp(prototype.id + '-cmbDateToDay').getValue();
            ...
            me.gridActual = '-panelGridDataMain'
    ...
    getRules: function () {
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.payments.GridData', {
            proxy: {
                url: '/AVIANCA/ManualConciliation/getRules'
            },
            listeners: {
        ...
        Ext.getCmp(prototype.id + '-gridDataColumns_JS').bindStore(storeGridDatas);
    ...
    viewMPF101_clickHandler: function (beanDet) {
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.payments.GridData', {
            proxy: {
                url: '/AVIANCA/ManualConciliation/searchMPF101Teleworking'
            },
            listeners: {
                beforeload: function (obj) {
...
//                                            STCON: value01.STCON_101,
    ...
    searchBean: function (rec) {
        ...
        Ext.Ajax.request({
            url: '/AVIANCA/ManualConciliation/searchBean',
            method: 'POST',
            timeout: 60000000,
    ...
    winDataEntry: function (action, beanCons) {
        ...
        Ext.create('Ext.Praxis.view.gerencial.BiToolsForm.DataEntry', {
    ...
    winDataEntryRules: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.gerencial.BiToolsForm.DataEntryRules', {
