...
Ext.define('Ext.Praxis.controller.discharges.NoShow.NoShowFormController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.NoShowFormController',
    requires: [
       'Ext.Praxis.view.discharges.NoShowForm.InfoGrid'
    ],           
    me: '',
    setContext: function() {
        me = this;
    ...
    search: function(){        
        ...
        var bean = {};
        bean.VP_A3933FPROC1 = Ext.util.Format.date(Ext.getCmp(prototype.id+'-fecha1').getValue(), 'Ymd');
        bean.VP_A3933FPROC2 = Ext.util.Format.date(Ext.getCmp(prototype.id+'-fecha2').getValue(), 'Ymd');
        bean.VP_A3933STAT = Ext.getCmp(prototype.id+'-STAT').getValue();
               
        var storeGridDatas = Ext.create('Ext.Praxis.store.discharges.NoShow.GridData', {
            proxy: {
                url: prototype.url + '/search_control_recep'
            },
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A3933");
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.discharges.NoShowForm.NoShowFormDet', {
            id: prototype.id01 + '-NoShowFormDet',
            params: {
                action: action,
                rec: rec
            }
