Ext.define('Ext.Praxis.controller.flown.Item.ItemController', {
    ...
    init: function(view) {
        ...
        var me = this;
        this.control({
            '#ItemForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#ItemForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ItemForm-btn-pag-next': {
                click: this.pagNext
            },
            '#ItemForm-btn-pag-last': {
                click: this.pagLast
            },
            '#ItemForm-btnSearch': {
...
//            },
    ...
    setFormatParameter: function() {
        var IN_A051KEY1 = "II"; // Ext.getCmp(prototype.id + '-txtIN_A051KEY1').getValue();
...
//    },
    ...
    setGridData: function(obj, val) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.flown.Item.GridData', {
            proxy: {
...
//    },
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.flown.ItemForm.DataEntry', {
            id: 'DataEntryItemForm',
            params: {
                action: action,
                rec: rec
            }
