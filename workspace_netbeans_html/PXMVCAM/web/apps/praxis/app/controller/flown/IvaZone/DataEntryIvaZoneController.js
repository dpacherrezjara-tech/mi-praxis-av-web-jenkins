Ext.define('Ext.Praxis.controller.flown.IvaZone.DataEntryIvaZoneController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryIvaZoneController',
    url: CONTEXTPATH + '/IvaZone',
    p: {},
    dataentryParams: {},
    lblA051KEY2_OLD:'',
    ...
    validateForm: function () {
        ...
        if (txtA051KEY2 === '' || txtA051DESCR1 === '' || txtA051COMENT === '') {
    ...
    getDataEntryValues: function(strOption) {
        ...
        var A051KEY1 = "IZ"; // Ext.getCmp(prototype.id + '-txtA051KEY1').getValue();
