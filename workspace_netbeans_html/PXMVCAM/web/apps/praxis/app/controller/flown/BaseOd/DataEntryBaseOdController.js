Ext.define('Ext.Praxis.controller.flown.BaseOd.DataEntryBaseOdController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryBaseOdController',
    url: CONTEXTPATH + '/BaseOd',
    p: {},
    dataentryParams: {},
    lblA051KEY2_OLD:'',
    ...
    getDataEntryValues: function(strOption) {
        ...
        var A051KEY1 = "OD"; // Ext.getCmp(prototype.id + '-txtA051KEY1').getValue();
