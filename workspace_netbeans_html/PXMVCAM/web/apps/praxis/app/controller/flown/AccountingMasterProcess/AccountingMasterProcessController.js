...
Ext.define('Ext.Praxis.controller.flown.AccountingMasterProcess.AccountingMasterProcessController', {
    ...
    init: function(view) {
        ...
        this.control({
            // -------------------Eventos Genericos --------------------
            '#AccountingMasterProcessForm-xpanel': {
                afterrender: this.xpanel_afterrender
            }
            ,
            '#AccountingMasterProcessForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#AccountingMasterProcessForm-btnClear': {
                click: this.btnClear_click
            },
            '#AccountingMasterProcessForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#AccountingMasterProcessForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#AccountingMasterProcessForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#AccountingMasterProcessForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#AccountingMasterProcessForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#AccountingMasterProcessForm-btn-pag-next': {
                click: this.pagNext
            },
            '#AccountingMasterProcessForm-btn-pag-last': {
                click: this.pagLast
            },
            '#AccountingMasterProcessForm-cboModulo': {
    ...
    setGridData: function(obj, val) {
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.flown.AccountingMasterProcess.GridData', {
            proxy: {
