...
Ext.define('Ext.Praxis.controller.flown.IvaReport.DataEntryIvaReportController', {
    ...
    setReverse: function(objDT){
        ...
        /*Ext.create('Ext.Praxis.view.flown.IvaReportForm.DataEntryReverse', {
        ...
        Ext.Ajax.request({
            ...
            //beforerequest: Ext.getCmp('DataEntryIvaReport2Form').mask('Loading...'),
            success: function(response, options) {
                var res = Ext.JSON.decode(response.responseText);
                //console.log(res);
                if (res.success) {                    
                ...
                //Ext.getCmp('DataEntryIvaReport2Form').unmask();
            },
