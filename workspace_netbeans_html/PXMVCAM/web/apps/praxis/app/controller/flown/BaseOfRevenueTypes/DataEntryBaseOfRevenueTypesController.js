Ext.define('Ext.Praxis.controller.flown.BaseOfRevenueTypes.DataEntryBaseOfRevenueTypesController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryBaseOfRevenueTypesController',
    url: CONTEXTPATH + '/BaseOfRevenueTypes',
    p: {},
    dataentryParams: {},
    lblA051KEY2_OLD:'',
    ...
    getDataEntryValues: function(strOption) {
        ...
        var A051KEY1 = "IB"; // Ext.getCmp(prototype.id + '-txtA051KEY1').getValue();
