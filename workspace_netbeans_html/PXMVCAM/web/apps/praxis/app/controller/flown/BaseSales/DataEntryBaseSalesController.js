Ext.define('Ext.Praxis.controller.flown.BaseSales.DataEntryBaseSalesController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryBaseSalesController',
    url: CONTEXTPATH + '/BaseSales',
    p: {},
    dataentryParams: {},
    lblA051KEY2_OLD:'',
    ...
    getDataEntryValues: function(strOption) {
        ...
        var A051KEY1 = "BS"; // Ext.getCmp(prototype.id + '-txtA051KEY1').getValue();
        ...
        var A051CANTI1 = Ext.getCmp(prototype.id + '-txtA051CANTI1').getValue();
