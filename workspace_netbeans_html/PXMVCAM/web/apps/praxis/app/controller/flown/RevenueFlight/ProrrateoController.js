...
Ext.define('Ext.Praxis.controller.flown.RevenueFlight.ProrrateoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id + '-ProrrateoController',
    url: CONTEXTPATH + '/RevenueFlight',
    ...
    getDataBeanA720: function(listBeanA720) {
        ...
        if (listBeanA720 !== '') {
            ...
            if (listBeanA720.length > 0) {
                ...
                Ext.getCmp(prototype.id + '-txtRATE').setValue(Ext.util.Format.number(beanA720.A1526RATE, '0,000.00000'));
    ...
    onBtnDelivery: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(response, options) {
                ...
                var delivery = Ext.create('Ext.Praxis.view.flown.ElectronicMiscellaneousForm.DeliveryInformation', {
                ...
                success: function(response, options) {
                    ...
                    Ext.Ajax.request({
                        ...
                        success: function(response, options) {
                            ...
                            Ext.getCmp(prototype.id + '-prorrateo').unmask();
                            meRevFlig.getDataInputsProrrateo(paramsProrrateo);
                            Ext.getCmp(prototype.id + '-prorrateo').unmask();
                        }
                    });
