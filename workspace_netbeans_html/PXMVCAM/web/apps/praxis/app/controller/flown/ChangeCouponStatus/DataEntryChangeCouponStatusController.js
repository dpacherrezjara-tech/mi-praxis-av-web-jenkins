...
Ext.define('Ext.Praxis.controller.flown.ChangeCouponStatus.DataEntryChangeCouponStatusController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id + '-dataEntryController',
    url: CONTEXTPATH + '/ChangeCouponStatus',
    ...
    setStoreData: function() {
        ...
        var cmbTVTA = Ext.getCmp(prototype.id + '-cmbTVTA');
    ...
    getDataInputs: function() {
        ...
        Ext.getCmp(prototype.id + '-txtCDOC').setValue(rec.CDOC);
        Ext.getCmp(prototype.id + '-txtPSVVTA').setValue(rec.PSVVTA);
        Ext.getCmp(prototype.id + '-txtAGTIA').setValue(rec.AGTIA);
        Ext.getCmp(prototype.id + '-txtFVTA').setValue(rec.FVTA);
        ...
        if (rec.STCON.trim() === '1') {
            Ext.getCmp(prototype.id + '-cmbSTVAL').setValue('4');
        } else {
        ...
        if (rec.TVTA.trim() !== '') {
            Ext.getCmp(prototype.id + '-cmbTVTA').setValue(rec.TVTA);
        }
        if (rec.TDOC.trim() !== '') {
            Ext.getCmp(prototype.id + '-cmbTDOC').setValue(rec.TDOC);
        }
        if (rec.TPAX.trim() !== '') {
            Ext.getCmp(prototype.id + '-cmbTPAX').setValue(rec.TPAX);
        }
        ...
        if (rec.CCIA === '139') {
            ...
            Ext.Ajax.request({
                ...
                success: function(response, options) {
                    ...
                    var facsimil = Ext.create('Ext.Praxis.view.flown.ChangeCouponStatusForm.Facsimil', {
