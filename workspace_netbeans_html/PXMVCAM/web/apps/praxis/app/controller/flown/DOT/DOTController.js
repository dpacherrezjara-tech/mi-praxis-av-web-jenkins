Ext.define('Ext.Praxis.controller.flown.DOT.DOTController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DOTController',
    fecha: new Date(),
    searchParams: {},
    _path: '',
    lstPaginacion: '',
    ...
    onOpenExportClick: function(grid, rowIndex, colIndex) {
        ...
        this.winDataEntry(rec, store, rowIndex);
    },
    winDataEntry: function(rec, store, rowIndex) {
        rec = rec === null || rec === undefined ? {} : rec;
        Ext.create('Ext.Praxis.view.flown.DOTForm.DataEntry', {
            id: 'DataEntryDOTForm',
            params: {
                rec: rec,
                store: store,
...
//                'IN_CARR='+searchParams.IN_CARR;
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.flown.DOT.GridData', {
            proxy: {
    ...
    setGridDataSearchDetailFTE: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.flown.DOT.GridDataDetailFTE', {
            proxy: {
    ...
    setGridDataSearchDetailTKT: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.flown.DOT.GridDataDetailTKT', {
            proxy: {
