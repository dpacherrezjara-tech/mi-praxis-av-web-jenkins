Ext.define('Ext.Praxis.controller.flown.FlightClassification.DataEntryFlightClassificationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryFlightClassificationController',
    url: CONTEXTPATH + '/FlightClassification',
    p: {},
    dataentryParams: {},
    lblA051KEY2_OLD:'',
    ...
    validateForm: function () {
        ...
        var txtA051COMENT = Ext.getCmp(prototype.id + '-txtA051COMENT').getValue();

        if (txtA051KEY2 === '' || txtA051DESCR1 === '' || txtA051DESCR2 === '' || txtA051FECHA1 === '' || txtA051FECHA2 === '' || txtA051COMENT === '') {
    ...
    getDataEntryValues: function(strOption) {
        ...
        var A051KEY1 = "IF"; // Ext.getCmp(prototype.id + '-txtA051KEY1').getValue();
        ...
        var A051COMENT = Ext.getCmp(prototype.id + '-txtA051COMENT').getValue();
