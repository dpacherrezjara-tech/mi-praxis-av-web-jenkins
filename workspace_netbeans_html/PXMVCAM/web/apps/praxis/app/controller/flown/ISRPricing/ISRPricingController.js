Ext.define('Ext.Praxis.controller.flown.ISRPricing.ISRPricingController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ISRPricingController',
    ...
    init: function(view) {
        ...
        prototype.id = 'ISRPricingForm';
        prototype.url = CONTEXTPATH + '/ISRPricing';
        prototype.widthContenedor = 1250;
        prototype.widthGrid = 1191;
        // </editor-fold>
    ...
    showChk_A720: function() {
        Ext.Ajax.request({
            ...
            success: function(response, options) {
                ...
                if (res.success) {
                    var USER = res.USER;
                    if (USER === 'SAP01' || USER === 'SAP07') {
                        Ext.getCmp(prototype.id + '-chk_A720').show();
                    }
                } else {
                    global.Msg({
                        msg: res.sesion
    ...
    onCbxA720Change: function(cmp, newValue, oldValue, eOpts) {
        this.btnSearch_click();
    },
    ...
    btnSearch_click: function(obj, e) {
        if (this.getValue("chk_A720")) {
            this.setFormatParameter("A720");
            this.setGridData("searchA720");
        } else {
...
//        this.focus("cmp");
        ...
        // </editor-fold>
//        Ext.getCmp(prototype.id+'-box1').hide();
...
//        var cmp = this.getValue("cmp");
    ...
    setGridData: function(search) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.flown.ISRPricing.GridData', {
            proxy: {
