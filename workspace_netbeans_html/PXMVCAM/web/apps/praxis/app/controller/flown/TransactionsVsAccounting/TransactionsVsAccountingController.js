...
Ext.define('Ext.Praxis.controller.flown.TransactionsVsAccounting.TransactionsVsAccountingController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.TransactionsVsAccountingController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function (view) {
        me = this;
        prototype.id = 'TransactionsVsAccountingForm';
        prototype.url = CONTEXTPATH + '/TransactionsVsAccounting';
        ...
        this.control({
//            //   -------------------Eventos Genericos --------------------
            '#TransactionsVsAccountingForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#TransactionsVsAccountingForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#TransactionsVsAccountingForm-btnClear': {
                click: this.btnClear_click
            },
            '#TransactionsVsAccountingForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#TransactionsVsAccountingForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#TransactionsVsAccountingForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#TransactionsVsAccountingForm-btnBack': {
                click: this.btnBack_click
            },
            '#TransactionsVsAccountingForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#TransactionsVsAccountingForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#TransactionsVsAccountingForm-btn-pag-next': {
                click: this.pagNext
            },
            '#TransactionsVsAccountingForm-btn-pag-last': {
                click: this.pagLast
            }
