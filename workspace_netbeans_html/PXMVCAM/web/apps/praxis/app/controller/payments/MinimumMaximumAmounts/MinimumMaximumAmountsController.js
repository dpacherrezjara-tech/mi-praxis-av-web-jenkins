...
Ext.define('Ext.Praxis.controller.payments.MinimumMaximumAmounts.MinimumMaximumAmountsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.MinimumMaximumAmountsController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function(view) {
        me = this;
        prototype.id = 'MinimumMaximumAmountsForm';
        prototype.url = CONTEXTPATH + '/MinimumMaximumAmounts';
...
//        this.obtainData();
        ...
        this.control({
            //   -------------------Eventos Genericos --------------------
            '#MinimumMaximumAmountsForm-xpanel': {
                afterrender: this.xpanel_afterrender            
            },
            '#MinimumMaximumAmountsForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#MinimumMaximumAmountsForm-btnClear': {
                click: this.btnClear_click
            },
            '#MinimumMaximumAmountsForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#MinimumMaximumAmountsForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#MinimumMaximumAmountsForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#MinimumMaximumAmountsForm-btnBack': {
                click: this.btnBack_click
            },
            '#MinimumMaximumAmountsForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#MinimumMaximumAmountsForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#MinimumMaximumAmountsForm-btn-pag-next': {
                click: this.pagNext
            },
            '#MinimumMaximumAmountsForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
//
...
//        console.log(searchParams);
    ...
    setGridData: function() {
        win.lblUser_toolTip("Estructura: MPF112");
        me.panelActual = '-panelGridData';
        global.selectedChild(me.childs, prototype.id + me.panelActual);
        me.setWidthPie();
        this.setFormatParameter();
...
//
//                    if( res.result.SCOUNTRY == '' && res.result.SCURRENCY == '' ){
//                        global.Msg({msg: "Data not fund "});
//                        return false
//                    }
////                        let formateadoNeto = me.formatNumberWithCommas_double(res.result.NETO)
////                        console.log(formateadoNeto, 'formateadoNeto')
//                        Ext.getCmp(prototype.id + '-de-txtMAXF1').setValue(res.result.MAXF1)
//                        Ext.getCmp(prototype.id + '-de-txtMAXF2').setValue(res.result.MAXF2)
//                        Ext.getCmp(prototype.id + '-de-txtSCURRENCY').setValue(res.result.SCURRENCY)
//                        Ext.getCmp(prototype.id + '-de-txtMINF1').setValue(res.result.MINF1)
//                        Ext.getCmp(prototype.id + '-de-txtMINF2').setValue(res.result.MINF2)
//                        Ext.getCmp(prototype.id + '-de-txtSCOUNTRY').setValue(res.result.SCOUNTRY)
//                        Ext.getCmp(prototype.id + '-txtUSCR').setValue(res.result.USCR)
//                        Ext.getCmp(prototype.id + '-txtFECR').setValue(res.result.FECR)
//                        Ext.getCmp(prototype.id + '-txtHOCR').setValue(res.result.HOCR)
//                        Ext.getCmp(prototype.id + '-txtUSUP').setValue(res.result.USUP)
//                        Ext.getCmp(prototype.id + '-txtFEUP').setValue(res.result.FEUP)
//                        Ext.getCmp(prototype.id + '-txtHOUP').setValue(res.result.HOUP)
//
//
////                    }
//
...
//            });
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.MinimumMaximumAmountsForm.DataEntry', {
