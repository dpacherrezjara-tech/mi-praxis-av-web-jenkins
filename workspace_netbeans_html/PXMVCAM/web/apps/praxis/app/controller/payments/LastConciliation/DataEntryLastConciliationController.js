Ext.define('Ext.Praxis.controller.payments.LastConciliation.DataEntryLastConciliationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryLastConciliationController',
...
//        console.log(this.beanResult);
        ...
        this.setValue('de-txtCard', this.beanResult.SCARDN);
        ...
        this.setValue('de-txtDATAVIS', this.beanResult.DATAVIS);
        this.setValue('de-txtNUMAVIS', this.beanResult.NUMAVIS);
        this.setValue('de-cmbSTAAVIS', this.beanResult.STAAVIS);
    ...
    obtainData: function() {   
        ...
        var cmbSTAAVIS = Ext.getCmp(prototype.id + '-de-cmbSTAAVIS');
...
//        });
    ...
    llenarData: function(beanTemp) {
        ...
        beanTemp.IN_STAAVIS = this.getValue("de-cmbSTAAVIS");
                
        //Guardando valores originales =========================
        //console.log(this.beanResult);
        beanTemp.IN_SDATE = this.beanResult.SDATE;
        beanTemp.IN_CARDN = this.beanResult.SCARDN;
        beanTemp.IN_SAUTHOC = this.beanResult.SAUTHOC;       
    },
    getData: function() {
