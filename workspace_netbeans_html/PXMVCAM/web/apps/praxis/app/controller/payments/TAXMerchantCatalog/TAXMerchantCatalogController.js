Ext.define('Ext.Praxis.controller.payments.TAXMerchantCatalog.TAXMerchantCatalogController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.TAXMerchantCatalogController',
    ...
    loadGrid: function(){
        ...
        mainPanel.removeAll();
        const grid = Ext.create('Ext.Praxis.view.payments.TAXMerchantCatalogForm.Grids.TAXMerchantCatalogGrid',{
