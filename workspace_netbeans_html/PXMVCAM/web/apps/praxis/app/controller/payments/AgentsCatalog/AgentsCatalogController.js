...
Ext.define('Ext.Praxis.controller.payments.AgentsCatalog.AgentsCatalogController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AgentsCatalogController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function (view) {
        ...
        this.control({
//            //   -------------------Eventos Genericos --------------------
//            '#AgentsCatalogForm-xpanel': {
//                afterrender: this.xpanel_afterrender            
//            },
            '#AgentsCatalogForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#AgentsCatalogForm-btnClear': {
                click: this.btnClear_click
            },
            '#AgentsCatalogForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#AgentsCatalogForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#AgentsCatalogForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#AgentsCatalogForm-btnBack': {
                click: this.btnBack_click
            },
            '#AgentsCatalogForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#AgentsCatalogForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#AgentsCatalogForm-btn-pag-next': {
                click: this.pagNext
            },
            '#AgentsCatalogForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
//
