...
Ext.define('Ext.Praxis.controller.payments.ExchangeRate.ExchangeRateController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ExchangeRateController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function (view) {
        ...
        this.control({
//            //   -------------------Eventos Genericos --------------------
            '#ExchangeRateForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#ExchangeRateForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#ExchangeRateForm-btnClear': {
                click: this.btnClear_click
            },
            '#ExchangeRateForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#ExchangeRateForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#ExchangeRateForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#ExchangeRateForm-btnBack': {
                click: this.btnBack_click
            },
            '#ExchangeRateForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#ExchangeRateForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ExchangeRateForm-btn-pag-next': {
                click: this.pagNext
            },
            '#ExchangeRateForm-btn-pag-last': {
                click: this.pagLast
            },
            '#ExchangeRateForm-cmbDateFromYear': {
                afterrender: this.afterRenderYear,
                select: this.selectComboFromYear
            },
            '#ExchangeRateForm-cmbDateToYear': {
                afterrender: this.afterRenderYear
            },
            '#ExchangeRateForm-cmbDateFromMonth': {
                afterrender: this.afterRenderMonth,
                select: this.selectComboFromMonth
            },
            '#ExchangeRateForm-cmbDateToMonth': {
                afterrender: this.afterRenderMonth,
                select: this.selectComboToMonth
            },
            '#ExchangeRateForm-cmbDateFromDay': {
...
//        });
    ...
    setFormatParameter: function () {
        ...
        me.bean.IN_CURRENCY1 = Ext.getCmp(prototype.id + '-cmbCURRENCY1').getValue();
        me.bean.IN_CURRENCY2 = Ext.getCmp(prototype.id + '-cmbCURRENCY2').getValue();
...
//        me.bean.IN_SCARDN2 = Ext.getCmp(prototype.id + '-txtCard2').getValue().trim();
    ...
    setGridData: function () {
        win.lblUser_toolTip("Estructura: MPF033");
    ...
    winDataEntry: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.ExchangeRateForm.DataEntry', {
