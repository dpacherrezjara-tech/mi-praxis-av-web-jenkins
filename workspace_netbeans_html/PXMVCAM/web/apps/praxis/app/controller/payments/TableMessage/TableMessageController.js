...
Ext.define('Ext.Praxis.controller.payments.TableMessage.TableMessageController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.TableMessageController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
...
//        this.obtainData();
        ...
        this.control({
            //   -------------------Eventos Genericos --------------------
            '#TableMessageForm-xpanel': {
                afterrender: this.xpanel_afterrender            
            },
            '#TableMessageForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#TableMessageForm-btnClear': {
                click: this.btnClear_click
            },
            '#TableMessageForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#TableMessageForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#TableMessageForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#TableMessageForm-btnBack': {
                click: this.btnBack_click
            },
            '#TableMessageForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#TableMessageForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#TableMessageForm-btn-pag-next': {
                click: this.pagNext
            },
            '#TableMessageForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
//
...
//        console.log(searchParams);
    ...
    setGridData: function() {
        win.lblUser_toolTip("Estructura: A2353");
        me.panelActual = '-panelGridData';
        global.selectedChild(me.childs, prototype.id + me.panelActual);
        me.setWidthPie();
        this.setFormatParameter();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.TableMessageForm.DataEntry', {
