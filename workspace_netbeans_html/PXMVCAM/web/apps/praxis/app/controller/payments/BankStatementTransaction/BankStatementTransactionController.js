...
Ext.define('Ext.Praxis.controller.payments.BankStatementTransaction.BankStatementTransactionController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BankStatementTransactionController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function(view) {
        me = this;
        prototype.id = 'BankStatementTransactionForm';
        prototype.url = CONTEXTPATH + '/BankStatementTransaction';
        ...
        this.control({
//            //   -------------------Eventos Genericos --------------------
//            '#BankStatementTransactionForm-xpanel': {
//                afterrender: this.xpanel_afterrender            
//            },
            '#BankStatementTransactionForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#BankStatementTransactionForm-btnClear': {
                click: this.btnClear_click
            },
            '#BankStatementTransactionForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#BankStatementTransactionForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#BankStatementTransactionForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#BankStatementTransactionForm-btnBack': {
                click: this.btnBack_click
            },
            '#BankStatementTransactionForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#BankStatementTransactionForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#BankStatementTransactionForm-btn-pag-next': {
                click: this.pagNext
            },
            '#BankStatementTransactionForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
//
...
//    },
    ...
    obtainData: function() {
        ...
        var cmbCTRAN = Ext.getCmp(prototype.id + '-cmbCTRAN');
        cmbCTRAN.bindStore(Ext.create('Ext.data.ArrayStore', {
            autoLoad: false,
            fields: ['code', 'name'],
            data: [
                ["", "All"],
                ["01", "01 - COMISIONES REGURALES"],
    ...
    setFormatParameter: function() {
        ...
        me.bean.IN_CTRAN = Ext.getCmp(prototype.id + '-cmbCTRAN').getValue();
        me.bean.IN_FECHA_TO = Ext.getCmp(prototype.id + '-txtDESCEECC').getValue();
...
//        console.log(searchParams);
    ...
    setGridData: function() {
        ...
        win.lblUser_toolTip("Estructura: A2357");
        me.panelActual = '-panelGridData';
        global.selectedChild(me.childs, prototype.id + me.panelActual);
        me.setWidthPie();
...
//            console.log(storeGridDatas);
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.BankStatementTransactionForm.DataEntry', {
    ...
    btnClear_click: function(obj, e) {
        Ext.getCmp(prototype.id + '-txtDESCEECC').setValue('');
        Ext.getCmp(prototype.id + '-cmbBank').setValue('');
        Ext.getCmp(prototype.id + '-cmbPais').setValue('');
        Ext.getCmp(prototype.id + '-cmbCTRAN').setValue('');
