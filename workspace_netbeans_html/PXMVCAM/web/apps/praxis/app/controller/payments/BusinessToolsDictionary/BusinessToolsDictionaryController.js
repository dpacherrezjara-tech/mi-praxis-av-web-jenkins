...
Ext.define('Ext.Praxis.controller.payments.BusinessToolsDictionary.BusinessToolsDictionaryController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BusinessToolsDictionaryController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
...
//        this.obtainData();
        ...
        this.control({
            //   -------------------Eventos Genericos --------------------
            '#BusinessToolsDictionaryForm-xpanel': {
                afterrender: this.xpanel_afterrender            
            },
            '#BusinessToolsDictionaryForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#BusinessToolsDictionaryForm-btnClear': {
                click: this.btnClear_click
            },
            '#BusinessToolsDictionaryForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#BusinessToolsDictionaryForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#BusinessToolsDictionaryForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#BusinessToolsDictionaryForm-btnBack': {
                click: this.btnBack_click
            },
            '#BusinessToolsDictionaryForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#BusinessToolsDictionaryForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#BusinessToolsDictionaryForm-btn-pag-next': {
                click: this.pagNext
            },
            '#BusinessToolsDictionaryForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
//
...
//    },
    ...
    setFormatParameter: function() {
        ...
        me.bean = {};
        me.bean.IN_SOURCEF = Ext.getCmp(prototype.id + '-txtSOURCEF').getValue();
        me.bean.IN_TABNAME = Ext.getCmp(prototype.id + '-txtTABNAME').getValue();
//        me.bean.IN_OUTNAME = Ext.getCmp(prototype.id + '-txtOUTNAME').getValue();
//        me.bean.IN_TABLA = Ext.getCmp(prototype.id + '-txtTABLA').getValue();
...
//        console.log(searchParams);
    ...
    setGridData: function() {
        win.lblUser_toolTip("Estructura: A2536");
        me.panelActual = '-panelGridData';
        global.selectedChild(me.childs, prototype.id + me.panelActual);
        me.setWidthPie();
        this.setFormatParameter();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.BusinessToolsDictionaryForm.DataEntry', {
...
//                lstCountry: me.lstCountry
    ...
    btnClear_click: function(obj, e) {
        Ext.getCmp(prototype.id + '-txtSOURCEF').setValue('');
        Ext.getCmp(prototype.id + '-txtTABNAME').setValue('');
