Ext.define('Ext.Praxis.controller.payments.TourismConciliation.DataEntryTourismConciliationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryTourismConciliationController',
    ...
    //        this.p = this.view.params;
        ...
        console.log('tipoAccion recibido:', this.actionCode);
        console.log('bean recibido:', this.bean);
