    Ext.define('Ext.Praxis.controller.payments.SalesReconciliation.DataEntrySalesReconciliationController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntrySalesReconciliationController',
    bean: {},
    lstA2290: {},
    lstCards: {},
    actionCode: '',
    ...
    viewDataEntry: function (e, b, c) {
        ...
        if (this.lstA2290 !== undefined) {
            ...
            if(beanCons !== undefined && beanCons.strTicket !== ''){
                me.searchBean(beanCons, 'DataEntrySalesReconciliationForm');
            } else {
