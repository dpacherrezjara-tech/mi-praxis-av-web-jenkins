Ext.define('Ext.Praxis.controller.payments.AccountingReport.SummaryDetailGridController', {
    ...
    init: function (view) {
        if(view.backButton){
            Ext.getCmp(prototype.id + '-dtsumm-btnBack').show();
            Ext.getCmp(prototype.id + '-dtsumm-btnBack').on('click',view.backButton);
        }
    },
        ...
        Ext.Msg.show(
                {
                    ...
                    fn: function (btn) {
                        if (btn === 'yes') {
                            global.downloadFile(me.request,'downloadSummaryDetail',params,'zip');
                        }
                    }
                });
    }
