...
Ext.define('Ext.Praxis.controller.payments.TerminalsCatalog.TerminalsCatalogController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.TerminalsCatalogController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function (view) {
        me = this;
        prototype.id = 'TerminalsCatalogForm';
        prototype.url = CONTEXTPATH + '/TerminalsCatalog';
        ...
        this.control({
//            //   -------------------Eventos Genericos --------------------
//            '#TerminalsCatalogForm-xpanel': {
//                afterrender: this.xpanel_afterrender            
//            },
            '#TerminalsCatalogForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#TerminalsCatalogForm-btnClear': {
                click: this.btnClear_click
            },
            '#TerminalsCatalogForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#TerminalsCatalogForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#TerminalsCatalogForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#TerminalsCatalogForm-btnBack': {
                click: this.btnBack_click
            },
            '#TerminalsCatalogForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#TerminalsCatalogForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#TerminalsCatalogForm-btn-pag-next': {
                click: this.pagNext
            },
            '#TerminalsCatalogForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
//
...
//        console.log(searchParams);
    ...
    setGridData: function () {
        win.lblUser_toolTip("Estructura: MPF016");
        me.panelActual = '-panelGridData';
        global.selectedChild(me.childs, prototype.id + me.panelActual);
        me.setWidthPie();
...
//            console.log(storeGridDatas);
    ...
    winDataEntry: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.TerminalsCatalogForm.DataEntry', {
