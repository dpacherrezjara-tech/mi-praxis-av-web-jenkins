                ...
                proxy: {
                    ...
                    load: function (obj) {
                        ...
                        if (obj.data.length === 0) {
                            ...
                            Ext.getCmp(prototype.id + '-QTY_TOTAL_CHGBACK')
                            .setText(
                              '<span style="color:#4A90E2; font-weight:bold; text-decoration:underline; cursor:pointer;">' +
                              Ext.util.Format.number(QTY_TOTAL_CHGBACK, '0,000') +
                              '</span>', 
                              false
                            );
