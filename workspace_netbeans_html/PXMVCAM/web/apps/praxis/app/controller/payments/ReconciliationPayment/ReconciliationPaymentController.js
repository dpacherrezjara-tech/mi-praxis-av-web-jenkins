...
Ext.define('Ext.Praxis.controller.payments.ReconciliationPayment.ReconciliationPaymentController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ReconciliationPaymentController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    beanSubmission: {},
    ...
    init: function (view) {
        ...
        this.control({
//            //   -------------------Eventos Genericos --------------------
            '#ReconciliationPaymentForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#ReconciliationPaymentForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#ReconciliationPaymentForm-btnClear': {
                click: this.btnClear_click
            },
            '#ReconciliationPaymentForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#ReconciliationPaymentForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#ReconciliationPaymentForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#ReconciliationPaymentForm-btnEmail': {
                click: this.btnEmail_click
            },
            '#ReconciliationPaymentForm-btnBack': {
                click: this.btnBack_click
            },
            '#ReconciliationPaymentForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#ReconciliationPaymentForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ReconciliationPaymentForm-btn-pag-next': {
                click: this.pagNext
            },
            '#ReconciliationPaymentForm-btn-pag-last': {
                click: this.pagLast
            },
            '#ReconciliationPaymentForm-cmbDateFromYear': {
//                afterrender: this.afterRenderYear,
                select: this.selectComboFromYear
            },
            '#ReconciliationPaymentForm-cmbDateFromMonth': {
//                afterrender: this.afterRenderMonth,
                select: this.selectComboFromMonth
            },
            '#ReconciliationPaymentForm-cmbDateToMonth': {
//                afterrender: this.afterRenderMonth,
                select: this.selectComboToMonth
            },
            '#ReconciliationPaymentForm-cmbDateFromDay': {
//                afterrender: this.afterRenderYear,
...
//        var rec = grid.getStore().getAt(rowIndex);
    ...
    winDataEntry: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataEntry', {
...
//                lstCountry: me.lstCountry
    ...
    onMsiTracking: function (a, b, c, d, e, rowData) {
        Ext.create('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataGridMsiTracking', {
...
//                lstCountry: me.lstCountry
    ...
    winDataEntrySettlement: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataEntrySettlement', {
    ...
    winDataEntryChargeback: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataEntryChargeback', {
    ...
    winDataEntryAdjustment: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataEntryAdjustment', {
