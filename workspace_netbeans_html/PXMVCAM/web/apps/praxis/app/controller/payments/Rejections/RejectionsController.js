...
Ext.define('Ext.Praxis.controller.payments.Rejections.RejectionsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.RejectionsController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function(view) {
        ...
        this.control({
            //   -------------------Eventos Genericos --------------------
            '#RejectionsForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#RejectionsForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#RejectionsForm-btnClear': {
                click: this.btnClear_click
            },
            '#RejectionsForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#RejectionsForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#RejectionsForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#RejectionsForm-btnBack': {
                click: this.btnBack_click
            },
            '#RejectionsForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#RejectionsForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#RejectionsForm-btn-pag-next': {
                click: this.pagNext
            },
            '#RejectionsForm-btn-pag-last': {
                click: this.pagLast
            }
            //-----------------Eventos Especificos -------------------    
...
//        console.log(me.bean);
    ...
    setGridData: function() {
        win.lblUser_toolTip("Estructura: A2287");
...
//            console.log(storeGridDatas)
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.RejectionsForm.DataEntry', {
    ...
    exportExcel: function() {
        ...
        switch (me.panelActual) {
            case  '-panelGridData':
                global.getFile(encodeURI(prototype.url + '/getXLSX?beanString=' + searchParams.beanString));
                break;
            default:
                global.Msg(
