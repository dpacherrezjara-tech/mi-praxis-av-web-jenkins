Ext.define('Ext.Praxis.controller.payments.ExteriorBankReconciliation.TaxDetailGridController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.TaxDetailGridController',
        ...
        Ext.Msg.show(
                {
                    ...
                    fn: function (btn) {
                        if (btn === 'yes') {
                            global.downloadFile(me.request,'/downloadTaxes',params);
                        }
                    }
                });
