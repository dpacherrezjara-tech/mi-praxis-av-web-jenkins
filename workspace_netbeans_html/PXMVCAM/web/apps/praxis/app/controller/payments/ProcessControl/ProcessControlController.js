Ext.define('Ext.Praxis.controller.payments.ProcessControl.ProcessControlController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ProcessControlController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function (view) {
        me = this;
        prototype.id = 'ProcessControlForm';
        prototype.url = CONTEXTPATH + '/ProcessControl';
        ...
        this.control({
            ...
            '#ProcessControlForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#ProcessControlForm-btnClear': {
                click: this.btnClear_click
            },
            '#ProcessControlForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#ProcessControlForm-btnTxtLIQUI': {
                click: this.btnTxt_clickLIQUI
            },
            '#ProcessControlForm-btnTxtSALE': {
                click: this.btnTxt_clickSALE
            },
            '#ProcessControlForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#ProcessControlForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#ProcessControlForm-btnBack': {
                click: this.btnBack_click
            },
            '#ProcessControlForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#ProcessControlForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ProcessControlForm-btn-pag-next': {
                click: this.pagNext
            },
            '#ProcessControlForm-btn-pag-last': {
                click: this.pagLast
            },
//            //-----------------Eventos Especificos -------------------          
...
//        $('#ProcessControlForm-panelGridData-body span')[3].style.fontSize = '16px'
    ...
    winDataEntry: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.ProcessControlForm.DataEntry', {
