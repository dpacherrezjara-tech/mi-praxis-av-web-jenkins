Ext.define('Ext.Praxis.controller.payments.ZonesMp.ZonesMpController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ZonesMpController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
...
//            },
            '#ZonesMpForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#ZonesMpForm-btnClear': {
                click: this.btnClear_click
            },
            '#ZonesMpForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#ZonesMpForm-btnFilter': {
            ...
            '#ZonesMpForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#ZonesMpForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ZonesMpForm-btn-pag-next': {
                click: this.pagNext
            },
            '#ZonesMpForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
        });
...
//            console.log(storeGridDatas);
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.ZonesMpForm.DataEntry', {
