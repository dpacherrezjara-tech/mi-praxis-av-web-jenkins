Ext.define('Ext.Praxis.controller.payments.InputsSecondPhase.LoadedGridController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.LoadedGridController',
    url: CONTEXTPATH + '/InputsPhase2',
    init: function (view) {
        if(view.backButton){
            Ext.getCmp(prototype.id + '-loaded-btnBack').show();
            Ext.getCmp(prototype.id + '-loaded-btnBack').on('click',view.backButton);
        }
    },
