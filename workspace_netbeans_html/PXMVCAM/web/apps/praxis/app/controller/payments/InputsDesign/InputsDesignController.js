...
Ext.define('Ext.Praxis.controller.payments.InputsDesign.InputsDesignController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.InputsDesignController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
...
//        this.obtainData();
        ...
        this.control({
            //   -------------------Eventos Genericos --------------------
            '#InputsDesignForm-xpanel': {
                afterrender: this.xpanel_afterrender            
            },
            '#InputsDesignForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#InputsDesignForm-btnClear': {
                click: this.btnClear_click
            },
            '#InputsDesignForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#InputsDesignForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#InputsDesignForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#InputsDesignForm-btnBack': {
                click: this.btnBack_click
            },
            '#InputsDesignForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#InputsDesignForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#InputsDesignForm-btn-pag-next': {
                click: this.pagNext
            },
            '#InputsDesignForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
//
...
//        me.bean.CODE = Ext.getCmp(prototype.id + '-cmbCode').getValue();
        me.bean.IN_CODEM = Ext.getCmp(prototype.id + '-txtCODEM').getValue();
...
//        console.log(searchParams);
    ...
    setGridData: function() {
        win.lblUser_toolTip("Estructura: MPFUNI");
        me.panelActual = '-panelGridData';
        global.selectedChild(me.childs, prototype.id + me.panelActual);
        me.setWidthPie();
        this.setFormatParameter();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.InputsDesignForm.DataEntry', {
