Ext.define('Ext.Praxis.controller.payments.TemplateReconciliation.DataEntryTemplateReconciliationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryTemplateReconciliationController',
    ...
    // </editor-fold>
    init: function (view) {
        prototype.id = 'TemplateReconciliationForm';
        prototype.url = CONTEXTPATH + '/TemplateReconciliation';
        meDE = this;
...
//                Ext.getCmp(prototype.id + '-btn-delete').show();
    ...
    mostrarData: function () {
        ...
        this.setValue('de-txtCCUST2', this.bean.data.CCUST); // segundo CCUST (form de detalle)
        this.setValue('de-txtPRDA', this.bean.data.PRDA);
        this.setValue('de-txtCODPRO', this.bean.data.CODPRO);
        this.setValue('de-txtCCUSTPRO', this.bean.data.CCUSTPRO);
        this.setValue('de-txtFLIQUIDACI', this.bean.data.FLIQUIDACI);
        this.setValue('de-txtLIQUIDACIO', this.bean.data.LIQUIDACIO);
        this.setValue('de-txtMERCHAND', this.bean.data.MERCHAND);
        this.setValue('de-txtCODIGO', this.bean.data.CODIGO);
        this.setValue('de-txtCORRL', this.bean.data.CORRL);

        // AMOUNT
        this.setValue('de-txtMONEDA', this.bean.data.MONEDA);

        let importe = this.bean.data.IMPORTE;
        if (importe !== null && importe !== undefined) {
            this.setValue('de-txtIMPORTE', importe); // sin formato para evitar que se corte
        }
    ...
    llenarData: function (beanTemp) {
        ...
        beanTemp.IN_PRDA = this.bean.data.PRDA;
        beanTemp.IN_CODPRO = this.bean.data.CODPRO;
        beanTemp.IN_CCUSTPRO = this.bean.data.CCUSTPRO;
        beanTemp.IN_FLIQUIDACI = this.bean.data.FLIQUIDACI;
        beanTemp.IN_LIQUIDACIO = this.bean.data.LIQUIDACIO;
        beanTemp.IN_MERCHAND = this.bean.data.MERCHAND;
        beanTemp.IN_MONEDA = this.bean.data.MONEDA;
        beanTemp.IN_CORRL = this.bean.data.CORRL;
        beanTemp.IN_CODIGO = this.bean.data.CODIGO;
...
//        console.log(opts);
    ...
    DeshabilitarCampoClave: function () {
        ...
        let camposDeshabilitar = [
            ...
            'de-txtCODIGO',
            'de-txtCORRL',
            'de-txtMONEDA', // moneda también se bloquea
            'de-txtUSCR',
            'de-txtFECR',
            'de-txtHOCR',
            'de-txtUSUP',
