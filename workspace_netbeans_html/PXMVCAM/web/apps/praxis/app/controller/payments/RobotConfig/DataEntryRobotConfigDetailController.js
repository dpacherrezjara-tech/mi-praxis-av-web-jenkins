Ext.define('Ext.Praxis.controller.payments.RobotConfig.DataEntryRobotConfigDetailController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryRobotConfigDetailController',
...
//        console.log('afterRender');
    ...
    mostrarData: function () {
        ...
        console.log('BeanResult',meDE.beanResult )        
      
        this.setValue('de-txtCODES', meDE.beanResult.CODES)
        this.setValue('de-txtARCHIVO', meDE.beanResult.ARCHIVO)
        this.new_archivo = meDE.beanResult.ARCHIVO;
        this.setValue('de-txtDEST', meDE.beanResult.DEST)
    ...
    getData: function () {
        ...
        Ext.Ajax.request({
            url: prototype.url + '/searchDetailDetail',
            method: 'POST',
            timeout: 60000000,
...
//        console.log(opts);
        ...
        Ext.Msg.show({
            ...
            fn: function (btn) {
                if (btn === 'yes') {
                    ...
                    if (msjResult === '') {
                        beanTemp.option = 'I';
                        this.MaintenanceDetail(beanTemp);
                    } else {
                    ...
                    fn: function (btn) {
                        if (btn === 'yes') {
                            ...
                            if (msjResult === '') {
                                ...
                                beanTemp.option = 'U';
                                meDE.MaintenanceDetail(beanTemp);
                            } else {
                                global.Msg({msg: msjResult});
                            }
                        }
    ...
    //<editor-fold defaultstate="collapsed" desc="MaintenanceDetail">
    MaintenanceDetail: function (beanTemp) {
//        console.log(beanTemp);
        var beanString = JSON.stringify(beanTemp);
        Ext.Ajax.request({
            url: prototype.url + '/MaintenanceDetail',
            method: 'POST',
            timeout: 60000000,
//            params: beanTemp,
...
//        console.log('llenarData');
        ...
        beanTemp.ARCHIVO = this.getValue("de-txtARCHIVO");
        beanTemp.DEST = this.getValue("de-txtDEST");
        beanTemp.STVAL = this.getValue("cmbSTVAL");
        beanTemp.NEW_ARCHIVO = this.new_archivo;
//        console.log(beanTemp);
    },
