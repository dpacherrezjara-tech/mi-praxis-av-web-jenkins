Ext.define('Ext.Praxis.controller.payments.ManualConciliation.DataEntryRulesManualConciliationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryRulesManualConciliationController',
...
//        this.obtainData();
    ...
    getData: function() {
        ...
        Ext.Ajax.request({
            url: prototype.url + '/searchRulesDetail',
            method: 'POST',
            timeout: 60000000,
    ...
    MaintenanceA2353: function(beanTemp) {
        Ext.Ajax.request({
            url: prototype.url + '/MaintenanceRules',
            method: 'POST',
            timeout: 60000000,
            params: beanTemp,
//            params: {beanString: beanString},
