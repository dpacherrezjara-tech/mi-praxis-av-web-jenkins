...
Ext.define('Ext.Praxis.controller.payments.StatementRules.StatementRulesController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.StatementRulesController',
    fecha: new Date(),
    childs: '5',
    bean: '',
    paginActual: '',
    ...
    init: function (view) {
        ...
        this.control({
            //   -------------------Eventos Genericos --------------------
            '#StatementRulesForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#StatementRulesForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#StatementRulesForm-btnClear': {
                click: this.btnClear_click
            },
            '#StatementRulesForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#StatementRulesForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#StatementRulesForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#StatementRulesForm-btnBack': {
                click: this.btnBack_click
            },
            '#StatementRulesForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#StatementRulesForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#StatementRulesForm-btn-pag-next': {
                click: this.pagNext
            },
            '#StatementRulesForm-btn-pag-last': {
                click: this.pagLast
            }
//            //-----------------Eventos Especificos -------------------    
...
//                me.btnSearch_click();
    ...
    setGridData: function () {
        win.lblUser_toolTip("Estructura: MPF071");
        me.panelActual = '-panelGridData';
        global.selectedChild(me.childs, prototype.id + me.panelActual);
        me.setWidthPie();
        this.setFormatParameter();
    ...
    winDataEntry: function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.StatementRulesForm.DataEntry', {
