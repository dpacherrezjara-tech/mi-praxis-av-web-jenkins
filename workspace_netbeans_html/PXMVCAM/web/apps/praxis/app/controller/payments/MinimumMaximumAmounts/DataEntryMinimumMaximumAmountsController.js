Ext.define('Ext.Praxis.controller.payments.MinimumMaximumAmounts.DataEntryMinimumMaximumAmountsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryMinimumMaximumAmountsController',
...
//        this.obtainData();
    ...
    mostrarData: function() {
        ...
        this.setValue('de-txtMAXF1', this.beanResult.MAXF1);
        this.setValue('de-txtMINF1', this.beanResult.MINF1);
        this.setValue('de-txtMAXF2', this.beanResult.MAXF2);
        this.setValue('de-txtMINF2', this.beanResult.MINF2);
    ...
    llenarData: function(beanTemp) {
        ...
        beanTemp.MAXF1 = this.getValue("de-txtMAXF1");
        beanTemp.MINF1 = this.getValue("de-txtMINF1");
        beanTemp.MAXF2 = this.getValue("de-txtMAXF2");
        beanTemp.MINF2 = this.getValue("de-txtMINF2");
...
//        var beanString = JSON.stringify(beanTemp);
        Ext.Ajax.request({                      //LLAMADO A LA RUTA Y CONECTA AL JAVA
...
//            params: {beanString: beanString},
    ...
    validacionInsert: function(beanTemp) {
        var msjResult = '';
        if (this.getValue("de-txtSCURRENCY") === ''|| this.getValue("de-txtSCOUNTRY") === '') {
