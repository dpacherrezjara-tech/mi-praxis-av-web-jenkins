Ext.define('Ext.Praxis.controller.payments.HeadersReport.SequencesGridController', {
    ...
    getData: function () {
        ...
        if (params.IN_DATEF && params.IN_DATEF.length === 6) params.IN_DATEF = params.IN_DATEF.slice(2); // → "2401"
        if (params.IN_DATET && params.IN_DATET.length === 6) params.IN_DATET = params.IN_DATET.slice(2); // → "2510"
