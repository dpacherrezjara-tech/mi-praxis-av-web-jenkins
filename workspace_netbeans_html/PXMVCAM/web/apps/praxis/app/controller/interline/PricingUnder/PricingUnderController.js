Ext.define('Ext.Praxis.controller.interline.PricingUnder.PricingUnderController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.PricingUnderController',
    dataObtain: {},
    childs: '',
    lstConditions: {},
    lstCampos: {},
...
//    _path: '',
    ...
    init: function (view) {
        me = this;
        prototype.id = 'PricingUnderForm';
        prototype.url = CONTEXTPATH + '/PricingUnder';
    ...
    imgInfoHelp_clickHandler: function (cmp, e, eOpts) {
        Ext.create('Ext.Praxis.view.interline.PricingUnderForm.DataEntry', {
            id: 'DataEntryPricingUnderForm',
            params: {
