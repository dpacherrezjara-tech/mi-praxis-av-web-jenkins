Ext.define('Ext.Praxis.controller.interline.AccountingMasterProces3.AccountingMasterProces3Controller', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountingMasterProces3Controller',
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.interline.AccountingMasterProces3Form.DataEntry', {
            id: 'DataEntryAccountingMasterProces3Form',
            params: {
                action: action,
                rec: rec,
    ...
    setFormatParameter: function() {
        ...
        switch (cboModulo) {
            case 'PSALES': case 'PFLOWN': case 'PADJMA': case 'PCADUCOS':
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.interline.AccountingMasterProces3.GridData', {
            proxy: {
