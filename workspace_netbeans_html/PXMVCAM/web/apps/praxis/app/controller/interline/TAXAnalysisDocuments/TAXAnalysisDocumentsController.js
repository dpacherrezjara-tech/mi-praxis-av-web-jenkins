Ext.define('Ext.Praxis.controller.interline.TAXAnalysisDocuments.TAXAnalysisDocumentsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.TAXAnalysisDocumentsController',
    dataObtain: {},
    childs: '',
    lstConditions: {},
    lstCampos: {},
...
//    _path: '',
    ...
    init: function (view) {
        me = this;
        prototype.id = 'TAXAnalysisDocumentsForm';
        prototype.url = CONTEXTPATH + '/TAXAnalysisDocuments';
...
//        this.imgSearch_clickHandler();
    ...
    imgMasivo_clickHandler: function (cmp) {
        switch (cmp.id) {
            case prototype.id+'-imgOver':
                this.post_to_url(CONTEXTPATH + '/Home#interline-pricing-over-form', {}, 'post', 'PricingOverForm');
                break;
    ...
    imgQualityC_clickHandler: function () {
    ...
    imgComments_clickHandler: function () {
        var params = {};
        if (this.gridSelectAC.length > 0) {
            params.listaSQL = this.gridSelectAC;
        } else {
            params.listaSQL = this.gridDataAC;
        }
        Ext.create('Ext.Praxis.view.interline.TAXAnalysisDocumentsForm.DataEntryComments', {
            id: 'DataEntryCommentsTAXAnalysisDocumentsForm',
            params: params
        }).show();
    },
    ...
    imgInfoHelp_clickHandler: function (cmp, e, eOpts) {
        Ext.create('Ext.Praxis.view.interline.TAXAnalysisDocumentsForm.DataEntry', {
            id: 'DataEntryTAXAnalysisDocumentsForm',
            params: {
...
//                        else me.selectedChild('boxMainData', 'paggin', false);
        ...
        Ext.getCmp(prototype.id + '-gridSwap').bindStore(storeGridDatas);
