...
Ext.define('Ext.Praxis.controller.sales.ConciliationARC.DataEntryConciliationARCController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id + '-dataEntryController',
    url: CONTEXTPATH + '/ConciliationARC',
    /**
     * Constructor
     */
    init: function(view) {
    ...
    getDataInputs: function() {
        ...
        Ext.getCmp(prototype.id + '-de-txtCASH').setValue(Ext.util.Format.number(sum, '0,000.00'));
        ...
        Ext.getCmp(prototype.id + '-de-txtCREDIT').setValue(Ext.util.Format.number(num1, '0,000.00'));
        Ext.getCmp(prototype.id + '-de-txtCREDITP').setValue(Ext.util.Format.number(num2, '0,000.00'));
    ...
    crud: function() {
        ...
        Ext.Ajax.request({
            url: this.url + '/setConciliacionARC',
            method: 'POST',
            timeout: 60000000,
