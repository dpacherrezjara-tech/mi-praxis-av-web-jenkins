Ext.define('Ext.Praxis.controller.sales.AccountingMasterProcessADJ.AccountingMasterProcessADJController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountingMasterProcessADJController',
    ...
    init: function(view) {
        ...
        prototype.id = 'AccountingMasterProcessADJForm';
        prototype.url = CONTEXTPATH+'/AccountingMasterProcessADJ';
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.sales.AccountingMasterProcessADJForm.DataEntry', {
            id: 'DataEntryAccountingMasterProcessADJForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.AccountingMasterProcessADJ.GridData', {
            proxy: {
