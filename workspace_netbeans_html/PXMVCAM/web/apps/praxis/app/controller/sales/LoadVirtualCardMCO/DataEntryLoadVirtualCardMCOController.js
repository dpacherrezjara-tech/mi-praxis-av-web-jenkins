Ext.define('Ext.Praxis.controller.sales.LoadVirtualCardMCO.DataEntryLoadVirtualCardMCOController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryLoadVirtualCardMCOController',
    msjAlert: '',
    init: function(view){
    },
                ...
                this.reader.onload = (function(theFile) {
                    return function(e) {
                        ...
                        Ext.Ajax.request({
                            ...
                            beforerequest: Ext.getCmp('DataEntryLoadVirtualCardMCOForm').mask('Loading...'),
                            success: function(response, options){
                                ...
                                Ext.getCmp('DataEntryLoadVirtualCardMCOForm').unmask();
                            },
...
//                        console.log("LISTO PARA UPDATE");
    ...
    crud: function() {
        Ext.Ajax.request({
            url: prototype.url + '/setMantenimientoCARDMCO',
            method: 'POST',
            timeout: 60000000,
            ...
            success: function(response, options) {
                ...
                global.Msg({
                    ...
                    fn: function() {
                        //exito
                        Ext.getCmp('DataEntryLoadVirtualCardMCOForm').close(),
                        Ext.getCmp(prototype.id + '-btnSearch').fireEvent('click', {});
                    }
                });
            }
