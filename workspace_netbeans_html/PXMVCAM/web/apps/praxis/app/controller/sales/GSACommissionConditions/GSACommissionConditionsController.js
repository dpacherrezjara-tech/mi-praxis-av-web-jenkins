Ext.define('Ext.Praxis.controller.sales.GSACommissionConditions.GSACommissionConditionsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.GSACommissionConditionsController',
    ...
    init: function(view) {
        ...
        prototype.id = 'GSACommissionConditionsForm';
        prototype.url = CONTEXTPATH+'/GSACommissionConditions';
        prototype.widthContenedor = 1100;
        prototype.widthGrid = 870;
        // </editor-fold>
        this.control({
        });
    },
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.sales.GSACommissionConditionsForm.DataEntry', {
            id: 'DataEntryGSACommissionConditionsForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function(data) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.GSACommissionConditions.GridData', {
            proxy: {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A1773");
