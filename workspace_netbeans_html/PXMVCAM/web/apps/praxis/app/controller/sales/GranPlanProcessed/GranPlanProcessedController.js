Ext.define('Ext.Praxis.controller.sales.GranPlanProcessed.GranPlanProcessedController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.GranPlanProcessedController',
    ...
    init: function(view) {
        ...
        prototype.id = 'GranPlanProcessedForm';
        prototype.url = CONTEXTPATH+'/GranPlanProcessed';
        prototype.widthContenedor = 1500;
        prototype.widthGrid = 1439;
        // </editor-fold>
        this.control({
        });
    },
    ...
    winDataEntry: function(action, data) {
        ...
        Ext.create('Ext.Praxis.view.sales.GranPlanPendingForm.DataEntry', {
    ...
    winDataEntryAdd: function(action) {
        action = action === null || action === undefined ? 'U' : action;
        Ext.create('Ext.Praxis.view.sales.GranPlanPendingForm.DataEntryAdd', {
            id: 'DataEntryAddGranPlanPendingController',
            params: {
                action: action
            }
        }).show();
    ...
    btnClear_click: function(obj, e) {
        ...
        this.setValue('Cmb_TypeFilter', '0');
        this.setValue('txtBrwTKTNumber', '');
        this.setValue('txtCodIATA', '');
        // </editor-fold>

        // <editor-fold defaultstate="collapsed" desc="Clear Grilla">
        Ext.getCmp(prototype.id + '-grid-iata').getStore().removeAll();
    ...
    setFormatParameter: function() {
        ...
        var txtBrwLote = this.getValue("txtBrwLote");
        // </editor-fold>
        ...
        _path = prototype.url+'/getXLSX?' +
            ...
            'VP_A1802CCUST='+searchParams.VP_A1802CCUST+'&' +
            'VP_TICKET='+searchParams.VP_TICKET+'&' +
            'VP_A1802IATA='+searchParams.VP_A1802IATA+'&' +
            'VP_A1802LOTEI='+searchParams.VP_A1802LOTEI;
        // </editor-fold>
    },
    // </editor-fold>
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.GranPlanProcessed.GridData', {
            proxy: {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A1802");
        ...
        Ext.getCmp(prototype.id + '-grid-iata').bindStore(storeGridDatas);
