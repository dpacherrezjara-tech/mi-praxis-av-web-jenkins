...
Ext.define('Ext.Praxis.controller.sales.BaseAmountPMP.BaseAmountPMPController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BaseAmountPMPController',
    fecha: new Date(),
    searchParams: {},
    init: function(view) {
        console.log('1)  APPLICATION BASE AMOUNT PMP - CONTROLLER BASE AMOUNT PMP- INIT');
        prototype.id = 'BaseAmountPMPForm';
        prototype.url = CONTEXTPATH + '/ProrationFactorsPMP';
        var me = this;
        this.control({
            // -------------------Eventos Genericos --------------------
            '#BaseAmountPMPForm-xpanel': {
                afterrender: this.xpanel_afterrender
            }
            ,
            '#BaseAmountPMPForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#BaseAmountPMPForm-btnClear': {
                click: this.btnClear_click
            },
            '#BaseAmountPMPForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#BaseAmountPMPForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#BaseAmountPMPForm-btnBack': {
                click: this.btnBack_click
            },
            '#BaseAmountPMPForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#BaseAmountPMPForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#BaseAmountPMPForm-btn-pag-next': {
                click: this.pagNext
            },
            '#BaseAmountPMPForm-btn-pag-last': {
                click: this.pagLast
            }

            //-----------------Eventos Especificos -------------------
            ,
            '#BaseAmountPMPForm-cmbSearchType': {
                select: this.selectcmbSearchType
            },
            '#BaseAmountPMPForm-txtCodOri': {
                keyup: this.eventKey,
                change: this.onUpperValue

            },
            '#BaseAmountPMPForm-txtCodDes': {
                keyup: this.eventKey,
                change: this.onUpperValue
            },
            '#BaseAmountPMPForm-txtOrigen': {
                keyup: this.eventKey,
                change: this.onUpperValue

            },
            '#BaseAmountPMPForm-txtDestination': {
                keyup: this.eventKey,
                change: this.onUpperValue
            },
            '#BaseAmountPMPForm-cmbDateFromYear': {
                afterrender: this.afterRenderYear,
                select: this.selectComboFromYear
            },
            /*'#BaseAmountPMPForm-cmbDateToYear': {
                afterrender: this.afterRenderYear
            }
            ,*/
            '#BaseAmountPMPForm-cmbDateFromMonth': {
                afterrender: this.afterRenderMonthFrom,
                select: this.selectComboFromMonth
            },
            /*'#BaseAmountPMPForm-cmbDateToMonth': {
                afterrender: this.afterRenderMonthTo,
                select: this.selectComboToMonth
            },*/
            '#BaseAmountPMPForm-rbgFactorDataDisplay': {
    ...
    setParams: function() {
        ...
        var IN_MODE = 'BASE'; // IN_MODE = 'BASE' / IN_MODE = 'FACTOR'
