Ext.define('Ext.Praxis.controller.sales.GSAIncentiveSummary.GSAIncentiveSummaryController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.GSAIncentiveSummaryController',
    ...
    init: function(view) {
        ...
        prototype.id = 'GSAIncentiveSummaryForm';
        prototype.url = CONTEXTPATH+'/GSAIncentiveSummary';
        prototype.widthContenedor = 1200;
        prototype.widthGrid = 1180;
        // </editor-fold>
        this.control({
        });
    },
    ...
    setFormatParameter: function(selectedValue) {
        ...
        switch (selectedValue) {
            case 'GSA':
                ...
                var txtFilterDateFrom = this.getValue("txtFilterDateFrom");
                var txtFilterDateTo = this.getValue("txtFilterDateTo");
                // </editor-fold>
                ...
                searchParams = {
                    IN_TFILTER: '1',
                    IN_GSA: txtFilterGSA,
                    IN_AAMM_F: txtFilterDateFrom,
                    IN_AAMM_T: txtFilterDateTo
                };

                _path = prototype.url+'/getXLSX?' +
                        'IN_TFILTER='+searchParams.IN_TFILTER+'&' +
                        'IN_GSA='+searchParams.IN_GSA+'&' +
                        'IN_AAMM_F='+searchParams.IN_AAMM_F+'&' +
                        'IN_AAMM_T='+searchParams.IN_AAMM_T;
                // </editor-fold>
                break;
            default:
                // <editor-fold defaultstate="collapsed" desc="llenarData">
    ...
    setGridData: function(data) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.GSAIncentiveSummary.GridData', {
            proxy: {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A1777");
