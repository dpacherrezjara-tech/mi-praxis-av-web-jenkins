Ext.define('Ext.Praxis.controller.sales.GranPlanPending.GranPlanPendingController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.GranPlanPendingController',
    ...
    init: function(view) {
        ...
        prototype.id = 'GranPlanPendingForm';
        prototype.url = CONTEXTPATH+'/GranPlanPending';
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.GranPlanPending.GridData', {
            proxy: {
                url: prototype.url+'/load_Comm_Pending'
            },
            listeners: {
