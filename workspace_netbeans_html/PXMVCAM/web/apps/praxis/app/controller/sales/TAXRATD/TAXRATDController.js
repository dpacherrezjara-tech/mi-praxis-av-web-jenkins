...
Ext.define('Ext.Praxis.controller.sales.TAXRATD.TAXRATDController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.TAXRATDController',
    fecha: new Date(),
    searchParams: {},
    init: function(view) {
        console.log('1)  APPLICATION TAX RATD  - CONTROLLER TAX RATD - INIT');
        prototype.id = 'TAXRATDForm';
        prototype.url = CONTEXTPATH + '/TAXRATD';
        var me = this;
        this.control({
            // -------------------Eventos Genericos --------------------
            '#TAXRATDForm-xpanel': {
            ...
            ,
            '#TAXRATDForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#TAXRATDForm-btnClear': {
                click: this.btnClear_click
            },
            '#TAXRATDForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#TAXRATDForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#TAXRATDForm-btnBack': {
                click: this.btnBack_click
            },
            '#TAXRATDForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#TAXRATDForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#TAXRATDForm-btn-pag-next': {
                click: this.pagNext
            },
            '#TAXRATDForm-btn-pag-last': {
                click: this.pagLast
            }

            //-----------------Eventos Especificos -------------------
            ,
            '#TAXRATDForm-cmbSearchType': {
                select: this.selectcmbSearchType
            },
            '#TAXRATDForm-txtSearch': {
                keyup: this.eventKey,
