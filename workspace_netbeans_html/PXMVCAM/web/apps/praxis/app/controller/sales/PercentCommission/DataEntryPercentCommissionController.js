...
Ext.define('Ext.Praxis.controller.sales.PercentCommission.DataEntryPercentCommissionController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id + '-dataEntryController',
    url: CONTEXTPATH + '/PercentCommission',
    lblPreffixOld: '',
    /**
     * Constructor
     */
    ...
    getDataInputs: function() {
        ...
        Ext.getCmp(prototype.id + '-TXT_A1874IATA').setValue(data.A2448IATA.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874IATA_DES').setValue(data.A003KEY3.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874DESCR').setValue(data.A2448DESCR.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874FORMA').setValue(data.A2448FORMA.trim());
        Ext.getCmp(prototype.id + '-TXT_A2448TRNCU').setValue(data.A2448TRNCU.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874CLASX').setValue(data.A2448CLASX.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874CODEX').setValue(data.A2448CODEX.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874SCODX').setValue(data.A2448SCODX.trim());
        Ext.getCmp(prototype.id + '-TXT_A2448IATAX').setValue(data.A2448IATAX.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874MCARR').setValue(data.A2448MCARR.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874TPASS').setValue(data.A2448TPASS.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874ACODE').setValue(data.A2448ACODE.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874TOUR').setValue(data.A2448TOUR.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874FBASI').setValue(data.A2448FBASI.trim());
        Ext.getCmp(prototype.id + '-TXT_A2448TDESI').setValue(data.A2448TDESI.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874CLASS').setValue(data.A2448CLASS.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874CODE').setValue(data.A2448CODE.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874SCODE').setValue(data.A2448SCODE.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874MOPAY').setValue(data.A2448MOPAY.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874ANCIL').setValue(data.A2448ANCIL.trim());
        Ext.getCmp(prototype.id + '-TXT_A1874COMM').setValue(Ext.util.Format.number(data.A2448COMM, '0,000.00'));
        Ext.getCmp(prototype.id + '-TXT_A1874FINIV').setValue(data.A2448FINIV.substr(0, 4) + '/' + data.A2448FINIV.substr(4, 2) + '/' + data.A2448FINIV.substr(6, 2));
