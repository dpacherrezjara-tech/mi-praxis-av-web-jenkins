Ext.define('Ext.Praxis.controller.sales.ControlFigures.ControlFiguresController', {
    ...
    imgExcel_clickHandler: function(obj, e) {
          //console.log(obj);
          this.imgTexto_clickHandler(obj, e, 'excel');  
//        var file = {};
//        var vA1530GRUPO = '';
//        var beanDet = {};
...
//        }
    ...
    imgTexto_clickHandler: function(obj, e, opt) {
        //console.log(obj);
        //return;        
        var str_formato = 'downloadText';
        var str_msg = 'Download Plain Text File ?';
        if( opt === 'texto'){ 
            str_formato = 'downloadText';
            str_msg = 'Download Plain Text File ?';
        };
        if( opt === 'excel'){ 
            str_formato = 'getXLSXv1';
            str_msg = 'Download Excel ?';
        };
        ...
        Ext.Msg.show({
            ...
            fn: function(btn) {
                if (btn === 'ok') {                                            
                    global.getFile(prototype.url + '/' + str_formato +'?beanString='+encodeURI(JSON.stringify(this.beancf)));
//                    global.getFile(prototype.url + '/downloadText?beanString='+encodeURI(JSON.stringify(this.beancf)));                                        
                }
            }
        });
