Ext.define('Ext.Praxis.controller.sales.GSAIncentiveConditions.GSAIncentiveConditionsController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.GSAIncentiveConditionsController',
    ...
    init: function(view) {
        ...
        prototype.id = 'GSAIncentiveConditionsForm';
        prototype.url = CONTEXTPATH+'/GSAIncentiveConditions';
        prototype.widthContenedor = 1220;
        prototype.widthGrid = 1209;
        // </editor-fold>
        this.control({
        });
    },
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.sales.GSAIncentiveConditionsForm.DataEntry', {
            id: 'DataEntryGSAIncentiveConditionsForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setFormatParameter: function(selectedValue) {
        ...
        switch (selectedValue) {
            case 'GSA':
                ...
                var txtFilterCity = this.getValue("txtFilterCity");
                // </editor-fold>
    ...
    setGridData: function(data) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.GSAIncentiveConditions.GridData', {
            proxy: {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A1774");
