...
Ext.define('Ext.Praxis.controller.sales.DeliveryFileASR.DeliveryFileASRController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DeliveryFileASRController',
    fecha: new Date(),
    paginActual: '',
    drillDown: [],
    gridActual: '',
    ...
    init: function(view) {
        ...
        this.control({
            // -------------------Eventos Genericos --------------------
            '#DeliveryFileASRForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#DeliveryFileASRForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#DeliveryFileASRForm-btnClear': {
                click: this.btnClear_click
            },
            '#DeliveryFileASRForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#DeliveryFileASRForm-btnBack': {
                click: this.btnBack_click
            },
            '#DeliveryFileASRForm-btnTxt': {
                click: this.btnTxt_click
            },
            //-----------------Eventos Especificos -------------------            

            '#DeliveryFileASRForm-btnDowload': {
                click: this.pagNext
            }
        });
    },
