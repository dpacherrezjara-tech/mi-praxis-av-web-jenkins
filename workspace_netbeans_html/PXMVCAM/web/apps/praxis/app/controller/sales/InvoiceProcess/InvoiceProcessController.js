...
Ext.define('Ext.Praxis.controller.sales.InvoiceProcess.InvoiceProcessController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.InvoiceProcessController',
    flightNumber: '',
    carrier: '',
    searchParams: {},
    me: '',
    ...
    init: function(view) {
        prototype.id = 'InvoiceProcessForm';
        prototype.url = CONTEXTPATH + '/InvoiceProcess';
        var me = this;
        this.control({
            // -------------------Eventos Genericos --------------------
            '#InvoiceProcessForm-xpanel': {
                afterrender: this.xpanel_afterrender
            }
            ,
            '#InvoiceProcessForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#InvoiceProcessForm-btnClear': {
                click: this.btnClear_click
            },
            '#InvoiceProcessForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#InvoiceProcessForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#InvoiceProcessForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#InvoiceProcessForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#InvoiceProcessForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#InvoiceProcessForm-btn-pag-next': {
                click: this.pagNext
            },
            '#InvoiceProcessForm-btn-pag-last': {
                click: this.pagLast
            },
            '#InvoiceProcessForm-cboModulo': {
    ...
    setGridData: function(obj, val) {
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.InvoiceProcess.GridData', {
            proxy: {
    ...
    winDataEntry: function(action, rec, all, rowIndex) {
        ...
        Ext.create('Ext.Praxis.view.sales.InvoiceProcessForm.DataEntry', {
            //id: prototype.id + '-dataEntry',
            id: 'DataEntryInvoiceProcessForm',
            params: {
                action: action,
                rec: rec,
                all: all,
