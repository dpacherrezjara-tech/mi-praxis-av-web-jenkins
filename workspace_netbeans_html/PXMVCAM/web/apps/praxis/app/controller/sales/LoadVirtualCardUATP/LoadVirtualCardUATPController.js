Ext.define('Ext.Praxis.controller.sales.LoadVirtualCardUATP.LoadVirtualCardUATPController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.LoadVirtualCardUATPController',
    searchParams: {},
    init: function(view) {
    ...
    setGridData: function(obj, val) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.LoadVirtualCardUATP.GridData', {
            proxy: {
    ...
    winDataEntry: function(action, rec, txtXLSError, cmbtINDAC) {
        ...
        Ext.create('Ext.Praxis.view.sales.LoadVirtualCardUATPForm.DataEntry', {
            id: 'DataEntryLoadVirtualCardUATPForm',
            params: {
                action: action,
                rec: rec,
