Ext.define('Ext.Praxis.controller.salesaudit.DisputeManagement.DisputeManagementController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DisputeManagementController',
    me: '',
//    childs: '',
//    stack: [],
//    bean: {},
...
//        Ext.create('Ext.Praxis.view.salesaudit.DisputeManagementForm.DataEntry', {
//            id: 'DataEntryDisputeManagementForm',
//            params: params
//        }).show();
//    },
    // <editor-fold defaultstate="collapsed" desc="Options">
    imgSearch_clickHandler: function(obj, e) {
        window.alert("imgSearch_clickHandler !");
//        var selectedValue = this.getValue("cbxFiltro");
//        
//        this.bean = {};
//        this.bean.VP_CODRAZ='';
