 ...
 */
Ext.define('Ext.Praxis.controller.salesaudit.BsplinkRefundQueryRFND.BsplinkRefundQueryRFNDController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BsplinkRefundQueryRFNDController',
    ...
    onUpdateClick: function (grid, rowIndex, colIndex) {
        ...
        if (rec.get('A3389FLAG') === 'F' || rec.get('A3389FLAG') === 'R' || rec.get('A3389FLAG') === 'Z') {
            ...
            me.beanUpdate.IN_STATUS = rec.get('A3389FLAG');
            me.beanUpdate.IN_PREME = rec.get('A3389PREME');
            //////
