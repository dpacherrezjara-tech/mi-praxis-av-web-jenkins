...
Ext.define('Ext.Praxis.controller.salesaudit.BsplinkUserMaintenanceRFND.BsplinkUserMaintenanceRFNDController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BsplinkUserMaintenanceRFNDController',
...
//        }
    ...
    winDataEntry: function (action, rec) {
        ...
        var win = new Ext.Praxis.view.salesaudit.BsplinkUserMaintenanceRFND.DataEntryUserMaintenance({
            params: {
                action: action,
                rec: rec,
                url01: prototype.url,
    ...
    OnColumnStatusRenderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
        ...
        if (String(record.get('A3406FLAG')) == 'Enabled') {
            value = 'green';
        } else {
            value = 'red';
        }
    ...
    OnEditActionDisabled: function (view, rowIndex, colIndex, item, record) {
        return String(record.get('A3406FLAG')) != 'Enabled' ? true : false;
    },
