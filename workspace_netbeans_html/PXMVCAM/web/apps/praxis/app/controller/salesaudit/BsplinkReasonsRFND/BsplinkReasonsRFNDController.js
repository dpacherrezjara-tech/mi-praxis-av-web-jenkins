...
Ext.define('Ext.Praxis.controller.salesaudit.BsplinkReasonsRFND.BsplinkReasonsRFNDController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BsplinkReasonsRFNDController',
    ...
    OnColumnStatusRenderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
        if (String(record.get('A3404FLAG')) == 'Enabled') {
            value = 'green';
        } else {
            value = 'red';
        }
    ...
    onExcelClick: function () {
        ...
        me.beanEXCEL.A3404FAMIL = Ext.getCmp(prototype.id + '-txtFamilia').getValue();
