 ...
 */
Ext.define('Ext.Praxis.controller.salesaudit.SalesAuditAccepted.DataEntryDetailsHistorialTKTController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryDetailsHistorialTKTController',
    BeanReason: {},
    ...
    cargaDatos: function () {
        ...
        Ext.getCmp(prototype.id7 + '-griddata').getStore().removeAll();
        var mask = new Ext.LoadMask(Ext.getCmp(prototype.id7 + '-form'), {
            msg: 'Please Wait....'
        });
        mask.show();
        Ext.Ajax.request({
            ...
            success: function (records, operation, success) {
                ...
                if (res.data.length > 0) {
                    Ext.getCmp(prototype.id7 + '-griddata').getStore().loadData(res.data);
                } else {
    ...
    setStoresGrids: function () {
        var grid01 = Ext.getCmp(prototype.id7 + '-griddata');

        var store01 = Ext.create('Ext.data.Store', {
            storeId: prototype.id7 + '-store-grid01'
        });
