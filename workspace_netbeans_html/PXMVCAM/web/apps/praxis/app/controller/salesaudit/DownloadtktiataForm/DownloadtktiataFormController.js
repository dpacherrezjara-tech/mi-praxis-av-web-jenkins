...
Ext.define('Ext.Praxis.controller.salesaudit.DownloadtktiataForm.DownloadtktiataFormController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DownloadtktiataFormController',
    ...
    afterRender: function () {
        ...
        me.setStoresFilters();
        me.setStoresGrids();
        Ext.getCmp(prototype.idDownloadtktiataForm + '-pagginator-01').getCmpPaginator().on('beforechange', me.onPagingBeforeChange01, this);
    },
    onCmbSearchAfterRender: function (obj) {
        obj.setValue('');
    },
    onCmbSearchChange: function (obj, records, eOpts) {
        var cmbcountry = Ext.getCmp(prototype.idDownloadtktiataForm + '-cmbcountry');
        var grid00 = Ext.getCmp(prototype.idDownloadtktiataForm + '-gridsale');
        var grid01 = Ext.getCmp(prototype.idDownloadtktiataForm + '-gridexch1');
        var grid02 = Ext.getCmp(prototype.idDownloadtktiataForm + '-gridexch2');
    ...
    setStoresFilters: function () {
        var cmbSearch = Ext.getCmp(prototype.idDownloadtktiataForm + '-search-type');
        var cmbcountry = Ext.getCmp(prototype.idDownloadtktiataForm + '-cmbcountry');
    ...
    setStoresGrids: function () {
        ...
        Ext.getCmp(prototype.idDownloadtktiataForm + '-pagginator-01').setStore(store00);
        Ext.getCmp(prototype.idDownloadtktiataForm + '-pagginator-01').setStore(store01);
        Ext.getCmp(prototype.idDownloadtktiataForm + '-pagginator-01').setStore(store02);
    ...
    onSearchClick: function (obj, e) {
        var me = this;
        me.bean.VP_OPCION = Ext.getCmp(prototype.idDownloadtktiataForm + '-search-type').getValue();
        me.bean.VP_PAIS = Ext.getCmp(prototype.idDownloadtktiataForm + '-cmbcountry').getValue();
        me.bean.VP_DATEFROM = Ext.getCmp(prototype.idDownloadtktiataForm + '-txtFilterDateFrom').getRawValue();
        me.bean.VP_DATETO = Ext.getCmp(prototype.idDownloadtktiataForm + '-txtFilterDateTo').getRawValue();
        ...
        me.bean.pexcel = Ext.getCmp(prototype.idDownloadtktiataForm + '-pagination').getValue() ? 0 : 1;
    ...
    SearchReport: function (bean, bExcel) {
        ...
        if (bExcel) {
            ...
            Ext.getCmp(prototype.idDownloadtktiataForm + '-gridsale').getStore().removeAll();
            Ext.getCmp(prototype.idDownloadtktiataForm + '-gridexch1').getStore().removeAll();
            Ext.getCmp(prototype.idDownloadtktiataForm + '-gridexch2').getStore().removeAll();
            if (bean.VP_OPCION === '1') {
                Ext.getCmp(prototype.idDownloadtktiataForm + '-gridsale').getStore().loadPage(1, {
                    params: bean,
                ...
                Ext.getCmp(prototype.idDownloadtktiataForm + '-gridexch1').getStore().loadPage(1, {
                    params: bean,
                    callback: function (records, operation, success) {
                        if (records.length === 0) {
                            global.Msg({msg: "Data not found.", icon: 2, fn: function () {
                ...
                Ext.getCmp(prototype.idDownloadtktiataForm + '-gridexch2').getStore().loadPage(1, {
                    params: bean,
                    callback: function (records, operation, success) {
                        if (records.length === 0) {
                            global.Msg({msg: "Data not found.", icon: 2, fn: function () {
    ...
    Processing_clickHandler: function (bean, bExcel) {
        var me = this;
        me.beanProc.VP_OPCION = Ext.getCmp(prototype.idDownloadtktiataForm + '-search-type').getValue();
        me.beanProc.VP_PAIS = Ext.getCmp(prototype.idDownloadtktiataForm + '-cmbcountry').getValue();
        me.beanProc.VP_DATEFROM = Ext.getCmp(prototype.idDownloadtktiataForm + '-txtFilterDateFrom').getRawValue();
        me.beanProc.VP_DATETO = Ext.getCmp(prototype.idDownloadtktiataForm + '-txtFilterDateTo').getRawValue();
        var vl_url = '';
        ...
        if (me.beanProc.VP_DATEFROM !== '' && me.beanProc.VP_DATETO !== '') {
            if (Date.parse(Ext.getCmp(prototype.idDownloadtktiataForm + '-txtFilterDateFrom').getRawValue()) > Date.parse(Ext.getCmp(prototype.idDownloadtktiataForm + '-txtFilterDateTo').getRawValue())) {
