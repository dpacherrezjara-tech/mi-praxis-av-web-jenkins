...
Ext.define('Ext.Praxis.controller.salesaudit.LoadATPCOLog.LoadATPCOLogController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.LoadATPCOLogController',
    fecha: new Date(),
    childs: '',
    bean: '',
    paginActual: '',
    ...
    init: function(view) {
        me = this;
        prototype.id = 'LoadATPCOLogForm';
        prototype.url = CONTEXTPATH + '/LoadATPCOLog';
        ...
        this.control({
            // -------------------Eventos Genericos --------------------
            '#LoadATPCOLogForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#LoadATPCOLogForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#LoadATPCOLogForm-btnClear': {
                click: this.btnClear_click
            },
            '#LoadATPCOLogForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#LoadATPCOLogForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#LoadATPCOLogForm-btnBack': {
                click: this.btnBack_click
            },
            '#LoadATPCOLogForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#LoadATPCOLogForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#LoadATPCOLogForm-btn-pag-next': {
                click: this.pagNext
            },
            '#LoadATPCOLogForm-btn-pag-last': {
                click: this.pagLast
            }
            //-----------------Eventos Especificos -------------------            
    ...
    btnClear_click: function(obj, e) {
        ...
        Ext.getCmp(prototype.id + '-ComboBy').setValue('1');
