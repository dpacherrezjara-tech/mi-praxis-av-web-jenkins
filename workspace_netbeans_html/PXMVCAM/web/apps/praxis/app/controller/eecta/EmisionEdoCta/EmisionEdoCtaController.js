Ext.define('Ext.Praxis.controller.eecta.EmisionEdoCta.EmisionEdoCtaController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.EmisionEdoCtaController',
    requires: [
...
//        this.Onsearch();
    ...
    search: function()
    {
        ...
        bean.VP_NREDO = Ext.getCmp(prototype.id + '-NREDO').getValue();
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.eecta.SalesList.GridData', {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A3981");
