Ext.define('Ext.Praxis.controller.eecta.DetalleSaldo.DetalleSaldoController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DetalleSaldoController',
    requires: [
        'Ext.Praxis.view.eecta.DetalleSaldoForm.InfoGrid'
    ],
    beanXLS: {},
    recGrid01: {},
    recGrid02: {},
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.eecta.SalesList.GridData', {
            ...
            listeners: {
                ...
                load: function (obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A3958");
