Ext.define('Ext.Praxis.view.payments.SalesReconciliationForm.DataEntryDebits', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryDebitsSalesReconciliationForm',
    requires: [
        'Ext.Praxis.controller.payments.SalesReconciliation.DataEntryDebitsSalesReconciliationController'
    ],
    controller: 'DataEntryDebitsSalesReconciliationController',
                                                                                    ...
                                                                                    items: [
                                                                                        {
                                                                                            ...
                                                                                            columns: {
                                                                                                ...
                                                                                                items: [
                                                                                                    ...
                                                                                                    {text: 'Doc.<br>Type', dataIndex: 'descTDOC', width: 71,
                                                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                                                            metaData.style = "text-align:center;";
                                                                                                            if (record.data.TDOC === 'A') {
                                                                                                                metaData.tdAttr = 'data-qtip="' + record.data.desCERROR + '"';
