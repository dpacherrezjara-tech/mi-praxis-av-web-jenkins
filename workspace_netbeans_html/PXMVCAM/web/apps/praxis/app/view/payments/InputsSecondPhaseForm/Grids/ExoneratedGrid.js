Ext.define('Ext.Praxis.view.payments.InputsSecondPhaseForm.Grids.ExoneratedGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.' + prototype.id + '-ExoneratedGrid',
    requires: [
        'Ext.Praxis.controller.payments.InputsSecondPhase.ExoneratedGridController'
    ],
    controller: 'ExoneratedGridController',
