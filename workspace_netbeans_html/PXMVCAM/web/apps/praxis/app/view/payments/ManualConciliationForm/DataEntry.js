Ext.define('Ext.Praxis.view.payments.ManualConciliationForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryManualConciliationForm',
    requires: [
        'Ext.Praxis.controller.payments.ManualConciliation.DataEntryManualConciliationController'
    ],
    controller: 'DataEntryManualConciliationController',
                                                    ...
                                                    items: [
                                                        {
                                                            ...
                                                            columns: {
                                                                ...
                                                                items: [
                                                                    ...
                                                                    {text: 'Doc SType', dataIndex: 'descTDOC', width: 59,
                                                                        editor: {xtype: 'textfield', editable: false},
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            if (record.data.TDOC === 'A') {
