Ext.define('Ext.Praxis.view.payments.CargoSendForm.Info', {
                            ...
                            items: [
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            ...
                                            {text: '<span style="color:white;font-weight:bold;">ID Send</span>', dataIndex: 'SREPID', width: 110, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    var data = record.data;
                                                    metaData.style = "text-align:center;";
                                                    return  value;
                                                }},
                                            {text: '<span style="color:white;font-weight:bold;">Status</span>', dataIndex: 'STVAL', width: 150, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    var data = record.data;
                                                    metaData.style = "text-align:center;";
                                                    ...
                                                    var v = (value || '').trim();
                                                    if (v === '0') {
                                                        metaData.style = 'background-color:#FF8C00; color:white; font-weight:bold; text-align:center;';
                                                        return 'Generated';
                                                    } else if (v === '1') {
                                                        metaData.style = 'background-color:#2E7D32; color:white; font-weight:bold; text-align:center;';
                                                        return 'Sent';
                                                    } else if (v === '2') {
                                                        metaData.style = 'background-color:#B71C1C; color:white; font-weight:bold; text-align:center;';
                                                        return 'Reversed';
                                                    }
                                                    return value;
                                                }
                                            },
                                               {text: '<span style="color:white;font-weight:bold;">Type</span>', dataIndex: 'TYPEDOC', width: 100, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    var data = record.data;
                                                    metaData.style = "text-align:center;";
                                                    ...
                                                    return  value;
                                                                                           ...
                                                                                           {text: '<span style="color:white;font-weight:bold;">Country</span>', dataIndex: 'SCOUNTRY', width: 100, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    var data = record.data;
                                                    metaData.style = "text-align:center;";
                                            ...
                                            {text: '<span style="color:white;font-weight:bold;">Quantity</span>', dataIndex: 'QTYREGIS', width: 90, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    var data = record.data;
                                                    metaData.style = "text-align:center;";
                                            ...
                                            },
                                            {
                                                ...
                                                renderer: function (value, metaData, record) {
                                                    return '<img src="resources/img/botones/1326498593_018.png" style="cursor:pointer; width:18px; height:15px;">';
                                                },
                                                listeners: { click: 'onEditCargoSend' }
                                            },
                                            {
                                                ...
                                                style: 'padding:2px; background: #6C87A8; border-color:white',
                                                renderer: function (value, metaData, record) {
                                                    return '<img src="resources/img/botones/excel-png-office-xlsx-icon-3.png" style="cursor:pointer; width:20px; height:15px;">';
                                                },
                                                listeners: { click: 'onDownloadReportBySREPID' }
                                            },
                                        ]
                                    }
                                }
