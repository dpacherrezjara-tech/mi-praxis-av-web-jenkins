Ext.define('Ext.Praxis.view.payments.SalesReconciliationForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntrySalesReconciliationForm',
    requires: [
        'Ext.Praxis.controller.payments.SalesReconciliation.DataEntrySalesReconciliationController'
    ],
    controller: 'DataEntrySalesReconciliationController',
