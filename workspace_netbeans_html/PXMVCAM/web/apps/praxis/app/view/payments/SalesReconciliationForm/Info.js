    ...
    items: [
        {
            ...
            items: [
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        {
                                            xtype: 'panel',
                                            id: prototype.id + '-panelGridDataDetalle20',
                                            bodyStyle: 'background-color: #E3EAEF;',
                                            border: false,
                                            height: 'auto',
                                            width: 1730,
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'grid',
                                                    id: prototype.id + '-gridDataDetalle20',
                                                    width: 1813,
                                                    columnLines: true,
                                                    features: [{
                                                            ftype: 'summary'
                                                        ...
                                                        items: [
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = "text-align:center;";
                                                                    var data = record.data;
                                                                    metaData.tdAttr = 'data-qtip="' + data.desCOREP + '"';
                                                                    return value;
                                                                }
                                                            },
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                    var data = Ext.getCmp(prototype.id + '-gridDataDetalle20').getStore().getData().items[0].data;
                ...
                //                                                        }
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                columns: [
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        listeners: {
                                                                            click: 'gridDetCore_clickHandler'
                                                                        },
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:right;color:#057ECB;background-color:#d5f4d5;";
                                                                            value = '<b>' + Ext.util.Format.number(value, '0,000') + '<b>';
                                        ...
                                        {
                                            xtype: 'panel',
                                            id: prototype.id + '-boxMainDataCore',
                                            hidden: true,
                                            width: '100%',
                                            bodyStyle: 'background: transparent;',
                                            border: false,
                                                                        ...
                                                                        columns: [
                                                                            {
                                                                                ...
                                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                                    metaData.style = "text-align:right;";
                                                                                    var data = Ext.getCmp(prototype.id + '-gridDataCore').getStore().getData().items[0].data;
                                                                                    return Ext.util.Format.number(data.lngTotQMATCH, '0,000');
                                                                                }
                                                                            },
                                                                            {
...
//                                                                    metaData.style = "background-color:#d5f4d5;";
                                                            ...
                                                            {
                                                                text: 'Status', dataIndex: 'STVAL', width: 133,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                            ...
                                                            {
                                                                text: 'Adm<br>Numb', dataIndex: 'ADMNUM', width: 75,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                                    metaData.style = "text-align:center;color:" + color + ";background-color:#b2e1ff;";
                                                        ...
                                                        items: [
                                                            {
                                                                ...
                                                                columns: [
                                                                    {
                                                                        text: 'Status', dataIndex: 'STVAL', width: 113,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            var data = record.data;
                                                                            var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                                            metaData.style = "text-align:center;color:" + color + ";";
...
//                                                                        },
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                columns: [
                                                                    ...
                                                                    {
                                                                        text: 'Card Number', width: 150, dataIndex: 'SCARDN',
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            var data = record.data;
                                                                            var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                                            metaData.style = 'text-align:center;color:' + color + ';background-color:#CCFFFF;';
                                                            ...
                                                            {
                                                                text: 'Amount', dataIndex: 'SVFOP', width: 125,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                                    metaData.style = "text-align:right;color:" + color + ";background-color:#b2e1ff;";
...
//                                                                    metaData.tdAttr = 'data-qtip="' + data.SAGENT + '"';
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                columns: [
                                                                    {
                                                                        text: 'Settl.', dataIndex: 'QTYDOC', width: 45,
                                                                        listeners: {
                                                                            click: 'onGridSett'
                                                                        },
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
...
//                                                                        },
                                                            ...
                                                            {
                                                                text: 'Status', dataIndex: 'STVAL', width: 123,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                                    metaData.style = "text-align:center;color:" + color + ";";
...
//                                            hidden: true,
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    columns: {
                                                        ...
                                                        items: [
                                                            ...
                                                            {
                                                                text: 'Sales Date', dataIndex: 'SDATE', width: 100,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    return value;
                                                                }
                                                            ...
                                                            {
                                                                text: 'Country', dataIndex: 'SCOUNTRY', width: 140,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    metaData.tdAttr = 'data-qtip="' + data.DESC_SCOUNTRY + '"';
                                                                    return data.DESC_SCOUNTRY;
                                                                }
                                                            },
                                                            {
                                                                text: 'Doc SAP Bank', dataIndex: 'BANDOC', width: 130,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                    metaData.unselectableAttr = "unselectable='off'";
                                                            ...
                                                            {
                                                                text: 'Invoice', dataIndex: 'INVOICE', width: 170,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                    metaData.unselectableAttr = "unselectable='off'";
                                                            ...
                                                            {
                                                                text: 'Agent Cons.', dataIndex: 'SCONSOL', width: 130,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    return value;
                                                                }
                                                            },
                                                            {
                                                                ...
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    let strTDOC = data.TDOC == 'A' ? 'Adjustment' : 'Sales';
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    ...
                                                                    var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                                    metaData.style = "text-align:center;color:" + color + ";background-color:#b2e1ff;";
                                                                    metaData.tdAttr = 'data-qtip="' + data.strSCURRENCY + '"';
                                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                    return value;
                                                                }
                                                            },
                                                            {
                                                                text: 'Amount', dataIndex: 'SVFOP', width: 135,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    var data = record.data;
                                                                    var color = data.strPEM === 'SALES' ? '#64418c' : '#244066';
                                                                    metaData.style = "text-align:right;color:" + color + ";background-color:#b2e1ff;";
                                                                ...
                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                    metaData.style = "text-align:right;";
                                                                    var data = Ext.getCmp(prototype.id + '-gridIBT').getStore().getData().items[0].data;
                                                                    return win.formatDblNumber(data.dblTotSVFOP);
                                                                }
                                                            },

                                                            {
                                                                ...
                                                                columns: [
                                                                    ...
                                                                    {
                                                                        text: 'Flag', dataIndex: 'STCON', width: 60,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            var data = record.data;
                                                                            return value;
                                                                        }
                                        ...
                                        {
                                            xtype: 'panel',
                                            id: prototype.id + '-paginacion_IBT',
                                            layout: {
                                                type: 'hbox',
                                                pack: 'center'
                                            },
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            id: prototype.id + '-lbl-currentPage_IBT',
                                                            text: '1',
                                                            width: 50
                                                        },
                                                        {
                                                        ...
                                                        {
                                                            id: prototype.id + '-lbl-pageCount_IBT',
                                                            text: '0',
                                                            width: 50
                                                        },
