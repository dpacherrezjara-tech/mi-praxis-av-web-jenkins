Ext.define('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataEntrySettlement', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntrySettlementReconciliationPaymentForm',
    requires: [
        'Ext.Praxis.controller.payments.ReconciliationPayment.DataEntrySettlementReconciliationPaymentController'
    ],
    controller: 'DataEntrySettlementReconciliationPaymentController',
