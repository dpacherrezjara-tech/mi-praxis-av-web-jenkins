Ext.define('Ext.Praxis.view.payments.LastConciliationForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryLastConciliationForm',
    requires: [
        'Ext.Praxis.controller.payments.LastConciliation.DataEntryLastConciliationController'
    ],
    controller: 'DataEntryLastConciliationController',
    title: 'Last Conciliation - Data Entry Form',
    header: true,
//    height: 575,
    width: 1000,
    resizable: false,
...
//                                { xtype: 'tbspacer', width: 3 },
                ...
                {
                    xtype: 'label',
                    html: '<strong style="color:#121E31; text-decoration: underline; ">Emission Information</strong>',
                    textDecoration: 'underline',
                    height: 70,
                    fontSize: '11',
                    style: 'font-weight:bold;color:#0B333C;',
