            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            border: false,
                            width: 1150,
                            id: prototype.id + '-panelDetailSaleCielo',
                            bodyStyle: 'background-color: #F4F7FD;',
                            padding: '1',
                            layout: {
                                type: 'vbox',
                            ...
                            items: [
                                {
                                    xtype: 'grid',
                                    id: prototype.id + '-gridDataDetailSaleCielo',
                                    height: 520,
                                    width: 1000,
                                    hidden: false,
                                    columnLines: true,
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Nbr</span>', dataIndex: 'RN', width: 45, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            ...
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Status</span>', dataIndex: 'strDescStatus', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Country</span>', dataIndex: 'SCOUNTRY', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Doctype</span>', dataIndex: 'descTDOC', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Agent</span>', dataIndex: 'SAGENT', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Source</span>', dataIndex: 'CFUENTE', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Sconsol</span>', dataIndex: 'SCONSOL', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Invoice</span>', dataIndex: 'INVOICE', width: 140, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Ticket</span>', dataIndex: 'TICKET', width: 110, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {align: 'center', text: '<span style="color:white;font-weight:bold;">Currency</span>', dataIndex: 'SCURRENCY', width: 90, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                            {text: '<span style="color:white;font-weight:bold;">Amount</span>', dataIndex: 'SVFOP', width: 110, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    var data = record.data;
                                                    metaData.style = "text-align:right;";
...

                        {
                            ...
                            border: false,
                            width: 1270,
                            id: prototype.id + '-panelDetailCielo',
                            bodyStyle: 'background-color: #F4F7FD;',
                            padding: '1',
                            layout: {
                                type: 'vbox',
                            ...
                            items: [
                                {
                                    xtype: 'grid',
                                    id: prototype.id + '-gridDataDetailCielo',
                                    height: 520,
                                    width: 1270,
                                    hidden: false,
                                    columnLines: true,
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {
                                                text: 'Detail',
                                                style: 'background-color: #6C87A8; color: white; font-weight: bold;',
                                                columns: [
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Nbr</span>', dataIndex: 'RN', width: 45, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                    {text: '<span style="color:white;font-weight:bold;">Customer</span>', dataIndex: 'CCUST', width: 80, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    ...
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Status</span>', dataIndex: 'strDescStatus', width: 100, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Country</span>', dataIndex: 'SCOUNTRY', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Merch</span>', dataIndex: 'MERCHNC', width: 90, style: 'padding:4px; background: #6C87A8;border-color:white;'},

                                                    {text: '<span style="color:white;font-weight:bold;">Process</span>', dataIndex: 'COREP', width: 70, style: 'padding:2px; background: #6C87A8;border-color:white',
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = "text-align:center;";
                                                            var data = record.data;
                                                    ...
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Doctype</span>', dataIndex: 'descTDOC', width: 70, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Business</span>', dataIndex: 'NEGOC', width: 80, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Bandoc</span>', dataIndex: 'BANDOC', width: 90, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Payment Date</span>', dataIndex: 'PAYDATE', width: 100, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Currency</span>', dataIndex: 'SCURRENCY', width: 80, style: 'padding:4px; background: #6C87A8;border-color:white;'},
                                                ]
                                            },
                                            {
                                                text: 'Total Agreement',
                                                style: 'background-color: #546E7A; color: white; font-weight: bold;',
                                                columns: [
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Quotas</span>', dataIndex: 'TOTCUOTA', width: 60, style: 'padding:2px; background: #546E7A;border-color:white',
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:center;";
                                                    ...
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Amount</span>', dataIndex: 'TOTAMOU', width: 80, style: 'padding:2px; background: #546E7A;border-color:white',
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:right;";
                                            ...
                                            {
                                                text: 'Amount Paid',
                                                style: 'background-color: #388E3C; color: white; font-weight: bold;',
                                                columns: [
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Quotas</span>', dataIndex: 'NCUOTA', width: 60, style: 'padding:2px; background: #388E3C;border-color:white',
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:center;";
                                                    ...
                                                    {align: 'center', text: '<span style="color:white;font-weight:bold;">Amount</span>', dataIndex: 'SVFOP_LAST', width: 80, style: 'padding:2px; background: #388E3C;border-color:white',
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:right;";
                                            ...
                                            {
                                                align: 'center', text: 'Pending Amount',
                                                style: 'background-color: #C62828; color: white; font-weight: bold;',
                                                columns: [
                                                    {
                                                        align: 'center', // Te recomiendo poner el align aquí también
                                                        text: '<span style="color:white;font-weight:bold;">Amount</span>',
                                                        dataIndex: 'ABALANCE',
                                                        width: 110,
                                                        style: ';padding:2px; background: #C62828;border-color:white',
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {

                                                            let colorCelda = (value <= 0) ? '#28a745' : '#dc3545'; // #28a745 = verde, #dc3545 = rojo

                                                            metaData.style = "text-align:right; color:" + colorCelda + ";";
