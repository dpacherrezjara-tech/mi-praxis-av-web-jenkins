                                        ...
                                        items: [
                                            ...
                                            },
                                            {
                                                ...
                                                columns: [
                                                    ...
                                                    {
                                                        text: 'Match', dataIndex: 'lngQSETTMATCH', width: 100, //PROCESS lngQTKT
                                                        listeners: {
                                                            click: 'onGridDay'
                                                        },
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                        ...
                                                        summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                            ...
                                                            var data = Ext.getCmp(prototype.id + '-gridDataMain').getStore().getData().items[0].data;
                                                            return Ext.util.Format.number(data.lngTotQSETTMATCH, '0,000');
                                                        }
                                                            
                                                       
                                                    },
                                                    {
                                                        text: 'Not Processed', dataIndex: 'lngQSETTPEND', width: 100, align: 'center', menuDisabled: true, // NO PROCESS lngQNPROC
                                                        listeners: {
                                                            click: 'onGridDay'
                                                        },
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                        ...
                                                        summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                            ...
                                                            return '<b>' + Ext.util.Format.number(data.lngTotQSETTPEND, '0,000') + '<b>';
                                                        }
                                                    },
                                                    {
                                                        text: 'Total', dataIndex: 'lngQSETT', width: 100,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = "text-align:right;background-color:#B6D8EE;";
                                            ...
                                            },
                                            {
                                                ...
                                                columns: [
                                                    {
                                                        text: 'Match', dataIndex: 'lngQTKTMATCH', width: 100, align: 'center', menuDisabled: true, // PROCESS lngQSETT
                                                        listeners: {
                                                            click: 'onGridDay'
                                                        },
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                        ...
                                                        summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                            var data = Ext.getCmp(prototype.id + '-gridDataMain').getStore().getData().items[0].data;
                                                            metaData.style = 'text-align:right; margin-right:3px ';
                                                            return '<b>' + Ext.util.Format.number(data.lngTotQTKTMATCH, '0,000') + '<b>';
                                                        }
                                                    },
                                                    {
                                                        text: 'Not Processed', dataIndex: 'lngQTKTPEND', width: 100, align: 'center', menuDisabled: true, //NO PROCESS
                                                        listeners: {
                                                            click: 'onGridDay'
                                                        },
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                        ...
                                                        summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                            var data = Ext.getCmp(prototype.id + '-gridDataMain').getStore().getData().items[0].data;
                                                            metaData.style = 'text-align:right; margin-right:3px ';
                                                            return '<b>' + Ext.util.Format.number(data.lngTotQTKTPEND, '0,000') + '<b>';
                                                        }
                                                    },
                                                    {
                                                        text: 'Total', dataIndex: 'lngQTKT', width: 100,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = "text-align:right;background-color:#d5f4d5;";
                                                            return Ext.util.Format.number(value, '0,000');
                                                        },
...
//GRILLA: AÑO,MES,DIA - 2DA BAJADA                       
                        {
                            xtype: 'panel',
                            id: prototype.id + '-panelGridDataMainDay',
                            bodyStyle: 'background-color: #E3EAEF;',
                            border: false,
                            height: 'auto',
                            width: 1580,
                            ...
                            items: [
                                {
                                    xtype: 'grid',
                                    id: prototype.id + '-gridDataMainDay',
                                    width: 682,
                                    columnLines: true,
                                    features: [{
                                            ftype: 'summary'
                                        ...
                                        items: [
                                            {
                                                ...
                                                columns: [
                                                    {
                                                        text: 'Date', dataIndex: 'PRDA', width: 80, align: 'center', sortable: false, menuDisabled: true, //flex: 1
                                                        listeners: {
                                                            click: 'onGridDetalleByDay'
                                                        },
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = "text-align:center;background-color:#B6D8EE;";
                                                            value = '<b>' + value + '</b>';
                                                        ...
                                                        summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                            var data = Ext.getCmp(prototype.id + '-gridDataMainDay').getStore().getData().items[0].data;
                                                            metaData.style = 'text-align:center; margin-right:3px ';
                                                            return '<b>' + 'Total' + '<b>';
                                                        }
                                                    }
                            ...
                            items: [
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {text: 'Date', dataIndex: 'PRDA', width: 80,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
...
//                                                    let strStatus = value == '5' ? "Match Manual" : "Pendiente"
                                            ...
                                            {text: 'Concep', dataIndex: 'FCONCEP', width: 80,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    let strConcep = ''
                                                    metaData.style = "text-align:center;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
...
//                                                    let descConcept = value == 'I' ? "Settlement" : "Ticket"
                                            ...
                                            {text: 'Ticket', dataIndex: 'TKT', width: 115,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    metaData.style = "text-align:center;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                    metaData.unselectableAttr = "unselectable='off'";
                                            ...
                                            {text: 'Cod Author.', dataIndex: 'SAUTHOC', width: 70,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    metaData.style = "text-align:center;color:#244066;background-color:#b2e1ff;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                    metaData.unselectableAttr = "unselectable='off'";
                                            ...
                                            {text: 'Total<br> Amount', dataIndex: 'SVFOPACUM2', width: 90,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                    metaData.unselectableAttr = "unselectable='off'";
                                                    metaData.style = "text-align:right;";
                                                    
                                                    if(record.data.FCONCEP === 'L'){
                                                        metaData.style = "text-align:right;background-color:#fdfd8e;";
                                                    }else if(record.data.FCONCEP === 'T'){
                                                        metaData.style = "text-align:right;background-color:#cbfffc;";
                                                    }
                                                    
                                                    
                                                    if(record.data.FCONCEP === 'V'){
                                                        metaData.style = "text-align:right;background-color:#fdfd8e;";
                                                    }else if(record.data.FCONCEP === 'A'){
                                                        metaData.style = "text-align:right;background-color:#cbfffc;";
                                                    }else{
...
//                                                    return '<b>' + Ext.util.Format.number(value, '0,000.00') + '<b>';
                                            ...
                                            {text: 'Trans.<br>Conci', dataIndex: 'TRANC', width: 70,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    //metaData.style = "text-align:center;";
                                                    metaData.style = "text-align:center;background-color:#d5f4d5;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                            ...
                                            {text: 'Rep.<br>Numb', dataIndex: 'TRANL', width: 60,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    metaData.style = "text-align:center;color:#244066;background-color:#b2e1ff;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                    metaData.unselectableAttr = "unselectable='off'";
                                            ...
                                            {text: 'Invoice', dataIndex: 'INVOICE', width: 90,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    metaData.style = "text-align:center;color:#244066;background-color:#b2e1ff;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                    metaData.unselectableAttr = "unselectable='off'";
                                            ...
                                            {text: 'Comment', dataIndex: 'CERROR', width: 200,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    metaData.style = "text-align:center;color:#244066;background-color:#b2e1ff;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                    metaData.unselectableAttr = "unselectable='off'";
...
//DETALLES
                        {
                            xtype: 'panel',
                            id: prototype.id + '-panelGridDataDetByF',
                            bodyStyle: 'background-color: #E3EAEF;',
                            border: false,
                            height: 'auto',
                            hidden:true,
                                        ...
                                        items: [
                                            ...
                                            {text: 'Status', dataIndex: 'STVAL', width: 110,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    ...
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                    metaData.unselectableAttr = "unselectable='off'";
                                                    let strStatus = value == '5' ? "Match Manual" : "Pendiente" //TERNARIO
                                                    return strStatus;
                                                }
                                            },
                                            
                                            {text: 'Concep', dataIndex: 'FCONCEP', width: 90,
                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                    let strConcep = ''
                                                    metaData.style = "text-align:center;";
                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                        ...
                        {
                            xtype: 'panel',
                            id: prototype.id + '-panelGridDataDetByD',
                            bodyStyle: 'background-color: #E3EAEF;',
                            border: false,
                            height: 'auto',
                            hidden:true,
                        ...
                        {
                            xtype: 'panel',
                            id: prototype.id + '-panelGridDataDetByS',
                            bodyStyle: 'background-color: #E3EAEF;',
                            border: false,
                            height: 'auto',
                            hidden:true,
