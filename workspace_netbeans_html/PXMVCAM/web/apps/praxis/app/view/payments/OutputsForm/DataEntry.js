Ext.define('Ext.Praxis.view.payments.OutputsForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryOutputsForm',
    requires:[
        'Ext.Praxis.controller.payments.Outputs.DataEntryOutputsController'
    ],
    controller: 'DataEntryOutputsController',
