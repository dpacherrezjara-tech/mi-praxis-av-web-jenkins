                            ...
                            items: [
                                        ...
                                        items: [
                                            ...
                                            },
                                            {
                                                        ...
                                                        columns: [
                                                            ...
                                                            {
                                                               text: '<span style="color:black;font-weight:bold;">Qty</span>', dataIndex: 'QTY', width: 60, style:'background:#FBD2D1;color:black !important',align: 'center', menuDisabled: true, //flex: 1
                                                                listeners: {
                                                                    click: 'onGridDataDetail'
                                                                },
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                style:'background:#FBD2D1;color:black !important',width: 140, align: 'center', menuDisabled: true,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = "color:#2B2B2B;text-align:right;";
                                                                    value = '<b>' + Ext.util.Format.number(value, '0,000') + '</b>';
                                                                    return  value;
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                columns: [
                                                                         {
                                                                text:  '<span style="color:black;font-weight:bold;">Amount</span>' , dataIndex: 'SUM_MPF100',
                                                                style:'background:#D1FBD2;color:black !important',width: 140, align: 'center', menuDisabled: true,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = "color:#2B2B2B;text-align:right;";
                                                                    value = '<b>' + Ext.util.Format.number(value, '0,000') + '</b>';
                                                                    return  value;
                                                                ...
                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                    ...
                                                                    return '<b>' + Ext.util.Format.number(data.totARMATCH, '0,000') + '<b>';
                                                                         ...
                                                                         {
                                                                  text:  '<span style="color:black;font-weight:bold;">Difference</span>' ,
                                                                 dataIndex: 'DIFFERENCE_100', width: 140, style:'background:#D1FBD2;color:black !important',align: 'center ', menuDisabled: true, //flex: 1
                                                            ...
                                                            },
                                                             {
                                                                    ...
                                                                    columns: [
                                                                        {
                                                            text:  '<span style="color:black;font-weight:bold;">Amount</span>' , dataIndex: 'SUM_ACTIVE',
                                                            style:'background:#CFE9F6;color:black !important',width: 140, align: 'center', menuDisabled: true,
                                                            renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                metaData.style = "color:#2B2B2B;text-align:right;";
                                                                value = '<b>' + Ext.util.Format.number(value, '0,000') + '</b>';
                                                                return  value;
                                                            ...
                                                            summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                ...
                                                                return '<b>' + Ext.util.Format.number(data.totARMATCH, '0,000') + '<b>';
                                                                        ...
                                                                        {
                                                              text:  '<span style="color:black;font-weight:bold;">Difference</span>' ,
                                                             dataIndex: 'DIFFERENCE', width: 140, style:'background:#CFE9F6;color:black !important',align: 'center ', menuDisabled: true, //flex: 1
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                columns: [
                                                                         {
                                                                text:  '<span style="color:black;font-weight:bold;">Pending</span>' , dataIndex: 'PENDING_MPF100',
                                                                style:'background:#D1FBD2;color:black !important',width: 140, align: 'center', menuDisabled: true,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = "color:#2B2B2B;text-align:right;";
                                                                    value = '<b>' + Ext.util.Format.number(value, '0,000') + '</b>';
                                ...
                                },
                                {
                                        ...
                                        items: [
                                            ...
                                            {width: 60, id: prototype.id + '-QTY_TOTAL',style:'background: #FBD2D1;text-align:right'},
                                            {width: 140, id: prototype.id + '-AMOUNT_TOTAL_USD',style:'background: #FBD2D1;text-align:right'},
                                            {width: 140, id: prototype.id + '-AMOUNT_TOTAL_MPF100',style:'background: #D1FBD2;text-align:right'},
                                            {width: 140, id: prototype.id + '-AMOUNT_TOTAL_DIFFERENCE_100',style:'background: #D1FBD2;text-align:right'},
                                            {width: 140, id: prototype.id + '-AMOUNT_TOTAL_ACTIVE',style:'background: #CFE9F6;text-align:right'},
                                            {width: 140, id: prototype.id + '-AMOUNT_TOTAL_DIFFERENCE',style:'background: #CFE9F6;text-align:right'},
                                            {width: 140, id: prototype.id + '-AMOUNT_TOTAL_PENDING_MPF100',style:'background: #D1FBD2;text-align:right'}
                                        ]
                                    },
                            ]
                        }
