Ext.define('Ext.Praxis.view.payments.TemplateReconciliaCreditForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryTemplateReconciliaCreditForm',
    requires: [
        'Ext.Praxis.controller.payments.TemplateReconciliaCredit.DataEntryTemplateReconciliaCreditController'
    ],
