Ext.define('Ext.Praxis.view.payments.SalesCompensationForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntrySalesCompensationForm',
    requires:[
        'Ext.Praxis.controller.payments.SalesCompensation.DataEntrySalesCompensationController'
    ],
    controller: 'DataEntrySalesCompensationController',
