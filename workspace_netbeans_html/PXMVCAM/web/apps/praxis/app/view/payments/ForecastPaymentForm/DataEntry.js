Ext.define('Ext.Praxis.view.payments.ForecastPaymentForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryForecastPaymentForm',
    requires: [
        'Ext.Praxis.controller.payments.ForecastPayment.DataEntryForecastPaymentController'
    ],
    controller: 'DataEntryForecastPaymentController',
    title: 'ForecastPayment - Data Entry Form',
    header: true,
//    height:920,
    width: 850,
    resizable: false,
            ...
            items: [
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            text: 'ForecastPayment Information',
