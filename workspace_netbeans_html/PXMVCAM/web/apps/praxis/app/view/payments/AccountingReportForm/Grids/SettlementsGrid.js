Ext.define('Ext.Praxis.view.payments.AccountingReportForm.Grids.SettlementsGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.' + prototype.id + '-SettlementsGrid',
    requires: [
        'Ext.Praxis.controller.payments.AccountingReport.SettlementsGridController'
    ],
    controller: 'SettlementsGridController',
