Ext.define('Ext.Praxis.view.payments.SalesConciliationManualForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntrySalesConciliationManualForm',
    requires: [
        'Ext.Praxis.controller.payments.SalesConciliationManual.DataEntrySalesConciliationManualController'
    ],
    controller: 'DataEntrySalesConciliationManualController',
    title: 'SalesConciliationManual - Data Entry Form',
    header: true,
//    height:920,
    width: 850,
    resizable: false,
            ...
            items: [
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            text: 'SalesConciliationManual Information',
