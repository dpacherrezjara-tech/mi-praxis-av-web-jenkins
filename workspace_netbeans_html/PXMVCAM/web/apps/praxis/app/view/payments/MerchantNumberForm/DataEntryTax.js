Ext.define('Ext.Praxis.view.payments.MerchantNumberForm.DataEntryTax', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryMerchantNumberDetailForm',
    requires: [
        'Ext.Praxis.controller.payments.MerchantNumber.DataEntryMerchantNumberTaxController'
    ],
    controller: 'DataEntryMerchantNumberTaxController',
