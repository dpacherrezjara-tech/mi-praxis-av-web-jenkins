prototype.idAdju2 = prototype.id + '-ReveDetailDataEntry';

Ext.define('Ext.Praxis.view.payments.AccountingReportForm.DataEntrys.ReveDetailDataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.ReveDetailDataEntry',
    requires: [
        'Ext.Praxis.controller.payments.AccountingReport.ReveDetailDataEntryController'
    ],
    controller: 'ReveDetailDataEntryController',
    title: 'Reverse Information - Form',
    header: true,
    width: 1100,
    resizable: false,
    layout: 'vbox',
    ...
    items: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'panel',
                    id: prototype.idAdju2 + '-panelDetails',
                    width: '100%',
                    layout: {
                        type: 'vbox',
                        pack: 'center'
                    ...
                    items: [
                        {
                            ...
                            width: '100%',
                            maxHeight: 300,
                            id: prototype.idAdju2 + '-gridSettl',
                            columns: {
                                defaults: {
                                    align: 'center',
                                    menuDisabled: true,
                        ...
                        },
                        {
                            ...
                            width: '100%',
                            id: prototype.idAdju2 + '-totalsSettl',
                            defaults: {
                                xtype: 'textfield',
                                width: 210,
                                labelWidth: 100,
                        ...
                        },
                        {
                            ...
                            width: '100%',
                            id: prototype.idAdju2 + '-totalsInvoi',
                            defaults: {
                                xtype: 'textfield',
                                width: 210,
                                labelWidth: 100,
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                {
                    text: 'Cancel',
                    id: prototype.idAdju2 + '-btn-cancel',
