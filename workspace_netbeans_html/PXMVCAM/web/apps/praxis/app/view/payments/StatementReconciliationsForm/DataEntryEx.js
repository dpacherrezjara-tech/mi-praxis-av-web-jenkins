Ext.define('Ext.Praxis.view.payments.StatementReconciliationsForm.DataEntryEx', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryExStatementReconciliationsForm',
    requires: [
        'Ext.Praxis.controller.payments.StatementReconciliations.DataEntryStatementReconciliationsExController'
    ],
    controller: 'DataEntryStatementReconciliationsExController',
...
//                                                    fieldStyle: 'text-align:center',
                                        ...
                                        //<editor-fold defaultstate="collapsed" desc="Header Setlement">
                                        {
                                            xtype: 'label',
                                        ...
                                        },
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'datefield',
                                                    id: prototype.id + '-txtFromADATEHE',
                                                    fieldStyle: 'text-align:center',
                                                    format: 'Y/m/d',
                                                    formatText: '',
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-txtLIQUIDACIOHE',
                                                    fieldStyle: 'text-align:center',
                                                    enforceMaxLength: true,
                                                    maskRe: /[0-9]/,
                                                    maxLength: 16,
                                                ...
                                                {xtype: 'tbspacer', width: 5},
                                                {
                                                    ...
                                                    tooltip: 'Clean',
                                                    listeners: {
                                                        click: 'clear_keyDownHandlerHead'
                                                    }
                                                ...
                                                {xtype: 'tbspacer', width: 5},
                                                {
                                                    xtype: 'button',
                                                    width: 25,
                                                    id: prototype.id + '-btnClearCustomHe',
...
//                                                {xtype: 'tbspacer', width: 5},
                                        ...
                                        },
                                        {
                                            ...
                                            items: [
                                                {
                                                    xtype: 'panel',
                                                    id: prototype.id + '-panelDataInfoScanHead',
                                                    layout: 'vbox',
                                                    border: false,
                                                    width: 1550,
                                                    height: 132,
...
//                                                            width: 1464,
                                                                ...
                                                                items: [
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        renderer: function (value, metaData, record) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = 'detalle-societyHead';
                                                                            return value;
                                                                        }
                                                                    },
                                                                    {text: 'Core', dataIndex: 'CODPRO', width: 55,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                    ...
                                                                    {text: 'Nro. Liquida', dataIndex: 'LIQUIDACIO', width: 110,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                            metaData.unselectableAttr = "unselectable='off'";
                                                                    ...
                                                                    {text: 'Id.Bank', dataIndex: 'BANDOC', width: 85,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                            metaData.unselectableAttr = "unselectable='off'";
                                                                    ...
                                                                    {text: 'Conci<br>Date', dataIndex: 'DATECI', width: 80,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                            metaData.unselectableAttr = "unselectable='off'";
                                                                    ...
                                                                    {text: 'Tranc<br>Numb', dataIndex: 'TRANCI', width: 80,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                            metaData.unselectableAttr = "unselectable='off'";
                                                                    ...
                                                                    {text: 'Importe', dataIndex: 'IMPORTEPAG', width: 100,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:right;";
                                                                            metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                            metaData.unselectableAttr = "unselectable='off'";
                                        ...
                                        },
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmountHead_Tot',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmountHead_Com',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmountHead_Net',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmountHead_Imp',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                        ...
                                        //<editor-fold defaultstate="collapsed" desc="Detail Setlement">
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'label',
                                                    text: 'Fees/Tax Settlement',
                                                    id: prototype.id + '-titleFees',
                                                    style: 'font-weight:bold;color:#0B333C;text-decoration-line: underline;',
                                                    bodyStyle: 'background:#E5ECEF;',
                                                    fontSize: '11',
                                                    width: 280,
                                                            ...
                                                            columns: {
                                                                ...
                                                                items: [
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        renderer: function (value, metaData, record) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = 'detalle-society';
                                                                            return value;
                                                                        }
                                                                    },
                                                                    {text: 'Doc <br>Type', dataIndex: 'descTDOC', width: 55,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            return value;
                                                                        }
                                                                    },
                                                                    {text: 'Value<br>Date', dataIndex: 'ADATE', width: 70,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            return value;
                                                                        }
                                                                    ...
                                                                    {text: 'Nro. Liquida', dataIndex: 'FUNDSTRGK', width: 110,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                            metaData.unselectableAttr = "unselectable='off'";
                                                                    ...
                                                                    {text: 'Terminal', dataIndex: 'TERMI', width: 65,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                            metaData.unselectableAttr = "unselectable='off'";
                                                                    ...
                                                                    },
                                                                    {
                                                                        ...
                                                                        columns: [
                                                                            ...
                                                                            {text: 'Auth.', dataIndex: 'SAUTHOC', width: 50,
                                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                                    metaData.style = "text-align:center;";
                                                                                    metaData.tdCls = "x-grid-cell x-grid-td x-grid-cell-actioncolumn-1609 x-grid-cell-last x-selectable";
                                                                                    metaData.unselectableAttr = "unselectable='off'";
                                                                    ...
                                                                    {text: 'Red', dataIndex: 'RED', width: 45,
...
//                                                                            value = 'COP';
                                                        ...
                                                        {
                                                            xtype: 'grid',
                                                            id: prototype.id + '-gridDataInfoScanFees',
                                                            margin: '0 0 0 10',
                                                            width: 384,
                                                            height: 250,
                                                            columnLines: true,
                                                                        ...
                                                                        columns: [
                                                                            {text: 'Code', dataIndex: 'CODIGO', width: 80,
                                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                                    metaData.style = "text-align:center;";
                                                                                    var data = record.data;
                                                                                    metaData.tdAttr = 'data-qtip="' + data.DESCRIP + '"';
                                                                                    return value;
                                                                                }
                                                                            },
                                                                        ]
...
//                                                                            value = 'COP';
                                        ...
                                        },
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmount_Tot',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmount_Com',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmount_Net',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmount_Imp',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {xtype: 'tbspacer', width: 60},
                                                {
                                                    xtype: 'label',
                                                    text: 'Fees Amount:',
                                                    id: prototype.id + '-Fees',
                                                    style: 'font-weight:bold;color:#0B333C;',
                                                    width: 90
                                                },
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmount_Fee',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-de-txtSumAmount_FeeEx',
                                                    fieldStyle: 'text-align:right',
                                                    enforceMaxLength: true,
                                                    readOnly: true,
                                                    width: 100
