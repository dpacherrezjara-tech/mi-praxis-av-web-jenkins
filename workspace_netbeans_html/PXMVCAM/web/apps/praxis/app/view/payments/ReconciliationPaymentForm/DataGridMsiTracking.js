...
Ext.define('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataGridMsiTracking', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataGridMsiTrackingForm',
    requires: [
        'Ext.Praxis.controller.payments.ReconciliationPayment.DataGridMsiTrackingController'
    ],
