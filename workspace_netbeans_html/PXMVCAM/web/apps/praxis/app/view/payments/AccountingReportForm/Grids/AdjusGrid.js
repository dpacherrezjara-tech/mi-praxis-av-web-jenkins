Ext.define('Ext.Praxis.view.payments.AccountingReportForm.Grids.AdjusGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.' + prototype.id + '-AdjusGrid',
    requires: [
        'Ext.Praxis.controller.payments.AccountingReport.AdjusGridController'
    ],
    controller: 'AdjusGridController',
    ...
    columns: {
        ...
        items: [
            ...
            {text: 'Status', dataIndex: 'STVAL', width: 80,
                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                    metaData.style = "text-align:center;background-color:#9FD1CB;font-weight:bold;";
                    const opts = {
                        '1': 'Auto',
                        '5': 'Manual'
                    };
            ...
            {text: 'Terminal', dataIndex: 'TERMI', width: 130},
