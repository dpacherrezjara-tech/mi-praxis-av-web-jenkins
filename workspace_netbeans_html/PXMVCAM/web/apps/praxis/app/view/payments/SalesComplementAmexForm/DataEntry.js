Ext.define('Ext.Praxis.view.payments.SalesComplementAmexForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntrySalesComplementAmexForm',
    requires: [
        'Ext.Praxis.controller.payments.SalesComplementAmex.DataEntrySalesComplementAmexController'
    ],
    controller: 'DataEntrySalesComplementAmexController',
    title: 'Sales Complement - Data Entry Form',
    header: true,
    height: 640,
    width: 1320,
    resizable: false,
