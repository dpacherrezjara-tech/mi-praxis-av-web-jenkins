Ext.define('Ext.Praxis.view.payments.AccountingReportForm.FiltersRever', {
    extend: 'Ext.form.Panel',
    alias: 'widget.' + prototype.id + '-filtersReverse',
    border: false,
    ...
    items: [
        {
            ...
            items: [
                //<editor-fold defaultstate="collapsed" desc="Browser">
                {
                    xtype: 'form',
                    border: false,
                    id: prototype.id + '-formFiltersReve',
                    bodyStyle: 'background: transparent',
                    margin: '0 0 0 10',
                    layout: 'vbox',
                    defaults: {
