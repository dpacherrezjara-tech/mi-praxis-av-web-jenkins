Ext.define('Ext.Praxis.view.payments.ProcessControlForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryProcessControlForm',
    requires:[
        'Ext.Praxis.controller.payments.ProcessControl.DataEntryProcessControlController'
    ],
    controller: 'DataEntryProcessControlController',
