Ext.define('Ext.Praxis.view.payments.SalesReconciliAmexForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntrySalesReconciliAmexForm',
    requires:[
        'Ext.Praxis.controller.payments.SalesReconciliAmex.DataEntrySalesReconciliAmexController'
    ],
    controller: 'DataEntrySalesReconciliAmexController',
