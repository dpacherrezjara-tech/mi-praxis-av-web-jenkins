        ...
        items: [
            // Tab 1: Settlements
            {
                ...
                columns: [
                    ...
                    { text: 'Status', dataIndex: 'STVAL', flex: 0.5 },
                    { text: 'Doc Type', dataIndex: 'TDOC', flex: 0.7 },
                    { text: 'Settlement', dataIndex: 'LIQUIDACIO', flex: 1 },
                    { text: 'Client', dataIndex: 'CCUST', flex: 0.5 },
                    { text: 'Sale Date', dataIndex: 'SDATE', flex: 1 },
                    { text: 'Settlement Date', dataIndex: 'ADATE', flex: 1 },
                    ...
                    { text: 'Settlement Amount', dataIndex: 'SVFOP', flex: 1 },
                    { text: 'Currency', dataIndex: 'SCURRENCY', flex: 0.7 },
                    {
                        text: 'Total',
                        dataIndex: 'TOTAL',
                        flex: 0.7,
