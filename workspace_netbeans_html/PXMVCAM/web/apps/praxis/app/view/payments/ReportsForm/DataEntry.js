Ext.define('Ext.Praxis.view.payments.ReportsForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReportsForm',
    requires: [
        'Ext.Praxis.controller.payments.Reports.DataEntryReportsController'
    ],
    controller: 'DataEntryReportsController',
    title: 'Reports - Data Entry Form',
    header: true,
//    height:920,
    width: 805,
    resizable: false,
