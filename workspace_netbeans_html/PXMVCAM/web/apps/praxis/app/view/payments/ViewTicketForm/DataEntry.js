Ext.define('Ext.Praxis.view.payments.ViewTicketForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryViewTicketForm',
    requires: [
    'Ext.Praxis.controller.payments.ViewTicket.DataEntryViewTicketController'
    ],
    controller: 'DataEntryViewTicketController',
                                        ...
                                        // <editor-fold defaultstate="collapsed" desc="gridData">
                                        {
                                            ...
                                            columns: {
                                                ...
                                                items: [                                                                                                        
                                                    ...
                                                    {
                                                        text: 'CC Number', dataIndex: 'SCARDN', width: 150,editor:{ xtype:'textfield', editable: false }
                                                    },
                                                    {
                                                        text: 'Approved Cod.', dataIndex: 'SAUTHOC', width: 100,editor:{ xtype:'textfield', editable: false }
                                                    },                                                    
                                                    {
                                                        text: 'Issue Date', dataIndex: 'SDATE', width: 80
                                                    },
                                                    {
                                                        text: 'IATA', dataIndex: 'SAGENT', width: 200, editor:{ xtype:'textfield', editable: false }
                                                    },                                                    
                                                    {
                                                    ...
                                                    {
                                                        text: 'PNR', dataIndex: 'SPNR', width: 80,editor:{ xtype:'textfield', editable: false }
                                                    },
                                                    {
                                                        xtype: 'actioncolumn',
                                                        text: 'Edit',
