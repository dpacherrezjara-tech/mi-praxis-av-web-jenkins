                                                    ...
                                                    items: [
                                                        {
                                                            ...
                                                            columns: {
                                                                ...
                                                                items: [
                                                                    ...
                                                                    {text: 'ADATE', dataIndex: 'ADATE', width: 65,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            return value;
                                                                        }
                                                                    },
                                                                    {text: 'VALDATE', dataIndex: 'VALDATE', width: 75,
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            return value;
                                                                        }
                                                                    ...
                                                                    {text: 'STRDATE', dataIndex: 'STRDATE', width: 85,
                                                                    ...
                                                                    {text: 'ENDDATE', dataIndex: 'ENDDATE', width: 85,
                                                                        //                                                                editor: {xtype: 'textfield', editable: true},
                                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                            metaData.style = "text-align:center;";
                                                                            return value;
