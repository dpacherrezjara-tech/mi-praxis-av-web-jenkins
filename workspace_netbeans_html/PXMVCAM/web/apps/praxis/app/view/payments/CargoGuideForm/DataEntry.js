                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                {xtype: 'tbspacer', width: 15},
                                {xtype: 'textfield', fieldLabel: 'ADATE', id: prototype.id + '-de-txtADATE', width: 220, labelWidth: 90, fieldStyle: 'text-align:center;'}
                            ]
                        },
                        {
                            xtype: 'container',
                            ...
                            defaults: {labelStyle: 'font-weight:bold;color:#0B333C;'},
                            items: [
                                {xtype: 'textfield', fieldLabel: 'PAYDAY', id: prototype.id + '-de-txtPAYDATE', width: 230, labelWidth: 90, fieldStyle: 'text-align:center;'},
                                {xtype: 'tbspacer', width: 15},
                                {xtype: 'textfield', fieldLabel: 'COUNTRY', id: prototype.id + '-de-txtCOUNTRY', width: 220, labelWidth: 90, fieldStyle: 'text-align:center;'},
                                {xtype: 'tbspacer', width: 15},
                                {xtype: 'textfield', fieldLabel: 'NCICLO', id: prototype.id + '-de-txtNCICLO', width: 230, labelWidth: 90, fieldStyle: 'text-align:center;'}
                            ]
                        },
                        {
                            xtype: 'container',
                            ...
                            defaults: {labelStyle: 'font-weight:bold;color:#0B333C;'},
                            items: [
                                {xtype: 'textfield', fieldLabel: 'METPAGO', id: prototype.id + '-de-txtMETPAGO', width: 230, labelWidth: 90, fieldStyle: 'text-align:center;'},
                                {xtype: 'tbspacer', width: 15},
                                {xtype: 'textfield', fieldLabel: 'NPAGE', id: prototype.id + '-de-txtNPAGE', width: 220, labelWidth: 90, fieldStyle: 'text-align:center;'},
                                {xtype: 'tbspacer', width: 15},
                                {xtype: 'textfield', fieldLabel: 'CUSCA', id: prototype.id + '-de-txtCUSCA', width: 220, labelWidth: 90, fieldStyle: 'text-align:center;'}
                            ]
                        },
                        {
                            xtype: 'container',
                            ...
                            defaults: {labelStyle: 'font-weight:bold;color:#0B333C;'},
                            items: [
                                {xtype: 'textfield', fieldLabel: 'CODPSE', id: prototype.id + '-de-txtCODPSE', width: 230, labelWidth: 90, fieldStyle: 'text-align:center;'},
                                {xtype: 'tbspacer', width: 15},
                                {xtype: 'textfield', fieldLabel: 'BANDOC', id: prototype.id + '-de-txtBANDOC', width: 220, labelWidth: 90, fieldStyle: 'text-align:center;'},
                            ]
                        },
// </editor-fold>
