Ext.define('Ext.Praxis.view.payments.TableMessageForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryTableMessageForm',
    requires:[
        'Ext.Praxis.controller.payments.TableMessage.DataEntryTableMessageController'
    ],
    controller: 'DataEntryTableMessageController',
