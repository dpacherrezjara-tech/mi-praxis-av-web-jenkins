...
Ext.define('Ext.Praxis.view.payments.ReconciliationPaymentForm.DataEntryErrorTransaction', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryErrorTransactionReconciliationPaymentForm',
    requires: [
        'Ext.Praxis.controller.payments.ReconciliationPayment.DataEntryErrorTransactionReconciliationPaymentController'
    ],
    controller: 'DataEntryErrorTransactionReconciliationPaymentController',
