valor = '0';
Ext.define('Ext.Praxis.view.payments.AccountingPlanForm.Info', {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {text: 'Nbr.', dataIndex: 'RN', width: 40},
                                            {
                                                ...
                                                columns: [
                                                    {text: 'Code', dataIndex: 'CODTRAN', width: 50,
                                                    ...
                                                    {text: 'Description', dataIndex: 'DESCRI', width: 200,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:left;";
                                                            metaData.tdAttr = 'data-qtip="' + data.DESCRI + '"';
                                                            return value;
                                                        }
                                                    }
                                                ]
                                            },
                                            {
                                                ...
                                                columns: [
                                                    {text: 'Code', dataIndex: 'CODAGRU', width: 70,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "font-weight:bold;";
                                                            return value;
                                            ...
                                            },
                                            {
                                                ...
                                                columns: [
                                                    {text: 'Register', dataIndex: 'desTIPREG', width: 80,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:left;";
                                                            return value;
                                            ...
                                            },
                                            {
                                                ...
                                                columns: [
                                                    {text: 'Code', dataIndex: 'CODCLIT', width: 70}
                                                ]
                                            },
                                            {
                                                text: 'Client',
                                                ...
                                                columns: [
                                                    {text: 'Address', dataIndex: 'DIRCLIT', width: 80}
                                                ]
                                            },
                                            {
                                                text: 'Class',
                                                ...
                                                columns: [
                                                    {text: 'Account', dataIndex: 'CLASE', width: 70,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:left;";
                                                            metaData.tdAttr = 'data-qtip="' + data.strDescripcion1 + '"';
                                                            return value;
                                                        }
                                                    }
                                                ]
                                            },
                                            {
                                                ...
                                                columns: [
                                                    {text: 'Number', dataIndex: 'NROPOLIZ', width: 70}
                                                ]
                                            },
                                            {
                                                text: 'Accounting',
