Ext.define('Ext.Praxis.view.payments.ExtBankReconciliationForm.FiltersBySettlement', {
    extend: 'Ext.form.Panel',
    alias: 'widget.' + prototype.id + '-settlFilters',
    requires: [
    ...
    items: [
        {
            ...
            id: prototype.id + '-cmbSettlFilters',
        ...
        },
        {
            ...
            items: [
                //<editor-fold defaultstate="collapsed" desc="Summary">
                {
                    ...
                    border: false,
                    hidden: true,
                    id: prototype.id + '-formFiltersBS-1',
                    bodyStyle: 'background: transparent',
                    layout: 'vbox',
                    defaults: {
                ...
                //<editor-fold defaultstate="collapsed" desc="Settl Browser">
                {
                    xtype: 'form',
                    border: false,
                    id: prototype.id + '-formFiltersBS-2',
                    bodyStyle: 'background: transparent',
                    layout: 'vbox',
                    defaults: {
                        fieldStyle: 'text-align: center;',
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'combo',
                                    id: prototype.id + '-cmbSettlCodebank2',
                                    name: 'IN_CODEBANK',
                                    queryMode: 'local',
                                    allowBlank: true,
                                    forceSelection: true,
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'combo',
                                    id: prototype.id + '-cmbSettlCODPRO2',
                                    name: 'IN_CODPRO',
                                    labelWidth: 80,
                                    width: 250,
                ...
                //</editor-fold>
                //<editor-fold defaultstate="collapsed" desc="Headers Browser">
                {
                    xtype: 'form',
                    border: false,
                    id: prototype.id + '-formFiltersBS-4',
                    bodyStyle: 'background: transparent',
                    hidden:true,
                    layout: 'vbox',
                    defaults: {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'combo',
                                    id: prototype.id + '-cmbSettlCODPRO4',
                                    name: 'IN_CODPRO',
                                    labelWidth: 80,
                                    width: 250,
                                    valueField: 'A4451KEY2',
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'combo',
                                    id: prototype.id + '-cmbSettlPCurr4',
                                    name: 'IN_MONEDAPAGO',
                                    queryMode: 'local',
                                    allowBlank: true,
                                    forceSelection: true,
