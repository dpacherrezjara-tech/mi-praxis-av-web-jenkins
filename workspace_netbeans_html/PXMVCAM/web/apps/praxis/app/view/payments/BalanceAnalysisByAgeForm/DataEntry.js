Ext.define('Ext.Praxis.view.payments.BalanceAnalysisByAgeForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryBalanceAnalysisByAgeForm',
    requires: [
        'Ext.Praxis.controller.payments.BalanceAnalysisByAge.DataEntryBalanceAnalysisByAgeController'
    ],
    controller: 'DataEntryBalanceAnalysisByAgeController',
    title: 'BalanceAnalysisByAge - Data Entry Form',
    header: true,
//    height:920,
    width: 805,
    resizable: false,
                    ...
                    items: [
                        {
                            ...
                            style: 'font-weight:bold;color:#0B333C;background:#transparent',
