Ext.define('Ext.Praxis.view.payments.BankReconciliationForm.DataEntryTktTw', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryTktTwBankReconciliationForm',
    requires: [
        'Ext.Praxis.controller.payments.BankReconciliation.DataEntryTktTwBankReconciliationController'
    ],
    controller: 'DataEntryTktTwBankReconciliationController',
