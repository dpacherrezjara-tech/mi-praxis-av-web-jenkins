Ext.define('Ext.Praxis.view.program.ProMasterTicketForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryProMasterTicketForm',
    requires: [
        'Ext.Praxis.controller.program.ProMasterTicket.DataEntryProMasterTicketController'
    ],
