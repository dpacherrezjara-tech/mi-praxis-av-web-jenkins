...
Ext.define('Ext.Praxis.view.sales.ConsortiaForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.Consortia.DataEntryConsortiaController'
    ],
    title: 'Consortia Information',
    header: true,
    width: 1150,
    height: 780,
    border: false,
                                    ...
                                    items: [
                                        {
                                            ...
                                            width: 150,
                                            padding: '2px 5px 2px 10px',
                                            html: '<strong style="color:#0B333C;  ">Sent to FOB </strong>'
                            ...
                            items: [
                                ...
                                // <editor-fold defaultstate="collapsed" desc="OPCIONES">
                                {
                                    ...
                                    items: [
                                        {
                                            xtype: 'label',
                                            id: prototype.id + '-de' + '-labelSearch',
                                        ...
                                        {xtype: 'tbspacer', width: 5},
                                        {
                                            ...
                                            text: '<strong style="color:white;">Sent<strong>',
                                            //tooltip: 'Save Ticket',
                                            cls: 'x-btn-sent',
                                ...
                                //-----------------------------------------------------------------
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            ...
                                            {text: 'Trans.<br> Type', width: 60, dataIndex: 'A2445TRNCU'},
                                            {text: 'CPN', width: 50, dataIndex: 'A2445CUPON'},
                                            {text: 'CNJ', width: 50, dataIndex: 'A2445FLAG'},
                                            {text: 'Issue <br> Date', width: 50, dataIndex: 'A2445FECVT'},
                                            {text: 'Carr', width: 50, dataIndex: 'A2445CARR'},
                                            {text: 'Fare <br> Fasis', width: 50, dataIndex: 'A2445FBAS'},
                                            {text: 'Class', width: 50, dataIndex: 'A2445CLAS'},
                                            {text: 'IT Tour<br> Code', width: 70, dataIndex: 'A2445CODIT'},
                                            {text: 'FOP', width: 50, dataIndex: 'A2445CFOP'},
                                            {text: 'Station <br>IATA', width: 60, dataIndex: 'A2445IATAE'},
                                            {
                                                text: 'Coupon',
                                                defaults: {
                                                    menuDisabled: true,
                                                ...
                                                columns: [
                                                    {text: 'CPN <br>Fare', dataIndex: 'A2445VCPN', width: 60,
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: 'Comm.', width: 60, dataIndex: 'A2445ACSC',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: 'Agr.<br> Code', width: 60, dataIndex: 'A2445CCST',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: '%', width: 60, dataIndex: 'A2445PCSC',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
                                            ...
                                            },
                                            {
                                                ...
                                                columns: [
                                                    {text: 'Amount', dataIndex: 'A2445OCANR', width: 60,
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: 'Comm.', width: 56, dataIndex: 'A2445COCAR',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: 'Agr.<br> Code', width: 55, dataIndex: 'A2445AGRAN',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: '%', width: 55, dataIndex: 'A2445POCANs',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:4px;';
                                                            return Ext.util.Format.number(value, '0,000.00');
                                                        }
