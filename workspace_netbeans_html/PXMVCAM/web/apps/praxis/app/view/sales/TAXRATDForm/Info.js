...
Ext.define('Ext.Praxis.view.sales.TAXRATDForm.Info', {
                        ...
                        items: [
                            ...
                            {text: 'Name', width: 400, dataIndex: 'A1202TNAME',
                                 renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    ...
                                    return '<a href="#sales-tax-ratd-form" style="color:#008FE3; text-decoration:none;">' + value + '</a>';
                                }
                                ,
                                listeners: {
                                    click: 'getDataEntryTAXRATD'
                                }
