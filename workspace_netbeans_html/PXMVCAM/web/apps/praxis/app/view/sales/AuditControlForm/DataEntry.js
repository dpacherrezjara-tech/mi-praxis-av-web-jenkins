...
Ext.define('Ext.Praxis.view.sales.AuditControlForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
           'Ext.Praxis.controller.sales.AuditControl.DataEntryAuditControlController'
    ],
    title: 'AUDIT CONTROL - Data Entry',
    header: true,
    width: 700,
    height: 300,
    border: false,
