Ext.define('Ext.Praxis.view.sales.GranPlanProcessedForm.DataEntryAdd',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryAddGranPlanProcessedForm',
    requires:[
        'Ext.Praxis.controller.sales.GranPlanProcessed.DataEntryAddGranPlanProcessedController'
    ],
    controller: 'DataEntryAddGranPlanProcessedController',
