Ext.define('Ext.Praxis.view.sales.GranPlanProcessedForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryGranPlanProcessedForm',
    requires:[
        'Ext.Praxis.controller.sales.GranPlanProcessed.DataEntryGranPlanProcessedController'
    ],
    controller: 'DataEntryGranPlanProcessedController',
