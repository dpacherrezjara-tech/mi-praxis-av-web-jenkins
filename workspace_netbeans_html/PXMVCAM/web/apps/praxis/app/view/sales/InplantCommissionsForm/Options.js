Ext.define('Ext.Praxis.view.sales.InplantCommissionsForm.Options', {
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype:'button',
                            id: prototype.id + '-imgDownload',
                            icon: 'resources/img/botones/1400209639_24.png',
                            tooltip: 'Download',
                            listeners: {
