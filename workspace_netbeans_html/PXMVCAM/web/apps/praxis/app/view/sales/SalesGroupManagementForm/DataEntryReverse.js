 ...
 */
Ext.define('Ext.Praxis.view.sales.SalesGroupManagementForm.DataEntryReverse', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntryReverse',
    controller: prototype.id + '-dataEntryReverseController',
    requires: [
           'Ext.Praxis.controller.sales.SalesGroupManagement.DataEntryReverseSalesGroupManagementController'
    ],
