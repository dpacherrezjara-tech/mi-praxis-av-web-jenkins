...
Ext.define('Ext.Praxis.view.sales.InvoiceCommissionConsortiaForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.InvoiceCommissionConsortia.DataEntryInvoiceCommissionConsortiaController'
    ],
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    //fieldLabel: '<strong style="color:#000;">User Creator</strong>',
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    //fieldLabel: '<strong style="color:#000;">User Modified</strong>',
