Ext.define('Ext.Praxis.view.sales.LoadControlARCForm.Info', {
            ...
            items: [
                {
                    ...
                    items: [
                        //<editor-fold defaultstate="collapsed" desc="ARC Load Control">
                        {
                            title: 'ARC Load Control',
                            items: [
                                {
                                    xtype: 'grid',
                        ...
                        //<editor-fold defaultstate="collapsed" desc="Load HOT">
                        {
                            ...
                            tbar: [
                                ...
                                '->',
                                {
                                    ...
                                    style: 'font-weight:bold;background:#024F79;',
                                    html: '<strong style="background:#024F79;color:white;">Load CAT</strong>',
                                    tooltip: 'Load ARC',
                                    listeners: {
                            ...
                            items: [
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            ...
                                            {text: 'Bank', dataIndex: 'A1697BANK', width: 130},
