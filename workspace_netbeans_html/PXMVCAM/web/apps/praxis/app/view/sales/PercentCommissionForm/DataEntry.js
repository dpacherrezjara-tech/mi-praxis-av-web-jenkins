...
Ext.define('Ext.Praxis.view.sales.PercentCommissionForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.PercentCommission.DataEntryPercentCommissionController'
    ],
    title: 'Percent Commission',
    header: true,
    width: 800,
    height: 600,
    border: false,
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874IATA_DES',
                                            required: true,
                                            disabled: false,
                                            readOnly: true,
                                            width: 520,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874CODEA',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 40,
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874FORMA',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 50,
                                        ...
                                        },
                                        {
                                            ...
                                            width: 120,
                                            padding: '2px 5px 2px 10px',
                                            html: '<strong style="color:#000;  ">Transaction Code</strong>'

                                        },
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A2448TRNCU',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 120,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874DESCR',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 620,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874CLASX',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 620,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874CODEX',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 50,
                                        ...
                                        },
                                        {
                                            ...
                                            width: 110,
                                            padding: '2px 5px 2px 10px',
                                            html: '<strong style="color:#000;  ">Exclude IATA</strong>'

                                        },
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A2448IATAX',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 90,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874SCODX',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 620,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874MCARR',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 50,
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874TPASS',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 50,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textareafield',
                                            id: prototype.id + '-TXT_A1874ACODE',
                                            width: 250,
                                            enforceMaxLength: true,
                                            maxLength: 100,
                                            listeners: {
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874FBASI',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 100,
                                        ...
                                        {xtype: 'tbspacer', width: 150},
                                        {
                                            ...
                                            width: 130,
                                            padding: '2px 5px 2px 10px',
                                            html: '<strong style="color:#000;  ">Ticket Designator</strong>'

                                        },
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A2448TDESI',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 230,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TXT_A1874CLASS',
                                            required: true,
                                            disabled: false,
                                            readOnly: false,
                                            width: 240,
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textareafield',
                                            id: prototype.id + '-TXT_A1874SCODE',
                                            width: 250,
                                            enforceMaxLength: true,
                                            maxLength: 100,
                                            listeners: {
                                        ...
                                        },
                                        {
                                            xtype: 'textareafield',
                                            // height: 35,
                                            id: prototype.id + '-TXT_A1874MOPAY',
                                            width: 230,
                                            enforceMaxLength: true,
                                            maxLength: 100,
                                            listeners: {
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'textareafield',
                                            id: prototype.id + '-TXT_A1874ANCIL',
                                            enforceMaxLength: true,
                                            maxLength: 100,
                                            width: 250,
                                            listeners: {
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            xtype: 'datefield',
                                            format: 'Y/m/d',
                                            id: prototype.id + '-TXT_A1874FINIV',
                                        ...
                                        },
                                        {
                                            xtype: 'datefield',
                                            format: 'Y/m/d',
                                            id: prototype.id + '-TXT_A1874FFINV',
                                            fieldStyle: 'text-align:center',
                                            maskRe: /[0-9/]/,
                                            enforceMaxLength: true,
                                            padding: '2px 5px 2px 3px',
