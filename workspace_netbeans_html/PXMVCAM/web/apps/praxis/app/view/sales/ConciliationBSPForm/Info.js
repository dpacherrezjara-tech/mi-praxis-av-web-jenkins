...
Ext.define('Ext.Praxis.view.sales.ConciliationBSPForm.Info', {
            ...
            items: [
                {
                    ...
                    columns: {
                        ...
                        items: [
                            ...
                            {text: 'City', width: 70, dataIndex: 'A1698BANK'},
                            {text: 'Country', width: 70, dataIndex: 'A1698PAIS'},
                            {text: 'Processing<br>Date', width: 80, dataIndex: 'A1698FPRDA'},
                            {text: 'File Id', width: 80, dataIndex: 'A1698IDFIL'},
                            {text: 'Curr', width: 60, dataIndex: 'CURRENCY'},
                            ...
                            {text: 'BSP',
                                ...
                                columns: [
                                    ...
                                    {text: 'TAX', dataIndex: 'BSP_TAX', width: 80,
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = 'text-align :right;';
                                            return Ext.util.Format.number(value, '0,000.00');
                                        }
                                    },
                                    {text: 'Comm', dataIndex: 'BSP_COMM', width: 80,
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = 'text-align :right;';
                                            return Ext.util.Format.number(value, '0,000.00');
                                        }
                            ...
                            {text: 'Praxis',
                                ...
                                columns: [
                                    ...
                                    {
                                        text: 'Status', dataIndex: 'A1530STPRO_00', width: 80
                                    }
                                ]
                            },
