Ext.define('Ext.Praxis.view.sales.LoadVirtualCardUATPForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryLoadVirtualCardUATPForm',

    controller: 'DataEntryLoadVirtualCardUATPController',

    requires:[
        'Ext.Praxis.controller.sales.LoadVirtualCardUATP.DataEntryLoadVirtualCardUATPController'
    ],

    title:'Load Virtual UATP:',
    header:true,
