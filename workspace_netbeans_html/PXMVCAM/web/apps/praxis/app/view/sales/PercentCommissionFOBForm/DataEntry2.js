...
Ext.define('Ext.Praxis.view.sales.PercentCommissionFOBForm.DataEntry2', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry2',
    controller: prototype.id + '-dataEntryController2',
    requires: [
        'Ext.Praxis.controller.sales.PercentCommissionFOB.DataEntryPercentCommissionFOBController2'
    ],
    title: 'Percent Commission (Exception)',
    header: true,
    width: 800,
    height: 600,
    border: false,
    ...
    items: [
        {
            region: 'center',
            xtype: 'form',
            id: prototype.id + '-DataEntry-center2',
            border: false,
            layout: {
                type: 'vbox'
            },
