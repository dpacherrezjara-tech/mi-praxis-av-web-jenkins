Ext.define('Ext.Praxis.view.sales.EstimationReverseProcessForm.Options', {
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype:'button',
                            id: prototype.id + '-imgEstimado',
                            icon: 'resources/img/botones/download.png',
                            tooltip: 'Generate Estimated Files',
                            listeners: {
                                click: 'imgEstimado_clickHandler'
                            }
                        },
                        {
                            xtype:'button',
                            id: prototype.id + '-imgReversa',
                            icon: 'resources/img/botones/update.png',
                            tooltip: 'Reverse',
                            listeners: {
                                click: 'imgReversa_clickHandler'
                            }
                        },
                        {
                            xtype: 'button',
            ...
            items: [
                {
                    ...
                    items: [
                        {
                            xtype: 'button',
                            id: prototype.id + '-imgType',
                            icon: 'resources/img/botones/addFav2.png',
                            tooltip: 'Add Favorite',
                            listeners: {
                                click: 'imFavo_clickHandler'
                            }
                        }
                    ]
                }
