Ext.define('Ext.Praxis.view.sales.LoadControlASRForm.Info', {
            ...
            items: [
                {
                    ...
                    items: [
                        //<editor-fold defaultstate="collapsed" desc="ASR Load Control">
                        {
                            title: 'ASR Load Control',
                            items: [
                                {
                                    xtype: 'grid',
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            ...
                                            {text: 'QUANTITY LINES',
                                                ...
                                                columns: [
                                                    {text: 'Receipt', dataIndex: 'A1698SQNR', width: 70},
                        ...
                        //<editor-fold defaultstate="collapsed" desc="Load HOT">
                        {
                            ...
                            tbar: [
                                ...
                                '->',
                                {
                                    ...
                                    style: 'font-weight:bold;background:#024F79;',
                                    html: '<strong style="background:#024F79;color:white;">Load ASR</strong>',
                                    tooltip: 'Load ASR',
                                    listeners: {
                                        click: 'btnLoadASR_clickHandler'
                                    }
                                }
                            ],
                            items: [
                            ...
                            items: [
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {text: 'ID File', dataIndex: 'A1724IDFIL', width: 70},
                                            {text: 'Group', dataIndex: 'A1724GRUPO', width: 70},
                                            {text: 'Transaction', dataIndex: 'A1724TRANS', width: 80},
                                            {text: 'Cia', dataIndex: 'A1724CIA', width: 35},
                                            {text: 'Form', dataIndex: 'A1724FORMA', width: 45},
                                            {text: 'Ser', dataIndex: 'A1724SERIE', width: 55},
                                            {text: 'Code', dataIndex: 'A1724CODER', width: 60},
                                            {text: 'Description', dataIndex: 'A1272DES', width: 235,
