...
//    ],
//    title: 'Conciliation ARC',

Ext.define('Ext.Praxis.view.sales.ConciliationDifferencesForm.DataEntryARC', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        //'Ext.Praxis.controller.sales.ConciliationARC.DataEntryConciliationARCController'
        'Ext.Praxis.controller.sales.ConciliationDifferences.DataEntryConciliationARCController',
    ],
    title: 'Conciliation ARC',
    header: true,
    width: 600,
