...
Ext.define('Ext.Praxis.view.sales.SalesAnalysisByAgentForm.Info5', {
    extend: 'Ext.form.Panel',
    alias: 'widget.' + prototype.id + '-info5',
    layout: 'border',
    align: 'center',
                        ...
                        // <editor-fold defaultstate="collapsed" desc="gridData">
                        {
                            ...
                            columns: {
                                items: [
                                    ...
                                    {text: 'Code', dataIndex: 'IATA', locked: true, width: 65,  renderer: 'onStringRenderer03'},
                                    {text: 'Agent', dataIndex: 'AGENTE', locked: true, width: 150,  align: 'left', renderer: 'onStringRenderer03'},
