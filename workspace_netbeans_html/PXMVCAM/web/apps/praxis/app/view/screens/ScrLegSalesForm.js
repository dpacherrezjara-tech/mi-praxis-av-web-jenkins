...
Ext.define('Ext.Praxis.view.screens.ScrLegSalesForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.ScrLegSalesForm',
    requires: [
        'Ext.Praxis.controller.screens.ScrLegSalesController'
    ],
    controller: 'ScrLegSalesController',
    title: 'Leg Sales',
    header: true,
    width: 1000,
    height: 300,
            ...
            items: [
                {
                    ...
                    items: [
                        //<editor-fold defaultstate="collapsed" desc="gridLegSales">
                        {
                            xtype: 'grid',
                            id: prototype.Leg.id+'-gridLegSales',
                            margin: '5 0',
                            ...
                            columns: {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        width: 75,
                                        dataIndex: 'CPNVLUN',
                                        text: '<b style="font-size:9px">Amount Rev</b>',
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    ...
                                    },
                                    {
                                        ...
                                        width: 75,
                                        dataIndex: 'LCPNVLU',
                                        text: '<b style="font-size:9px">Amount Loc</b>',
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = "font-size:9px !important;text-align:right;background:#bcdcf8";
                                            return value;
                                        }
                                    },
                                    {
                                        ...
                                        width: 70,
                                        dataIndex: 'IDNRCARR',
                                        text: '<b style="font-size:9px">ID Car</b>',
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = "font-size:9px !important";
                                            return value;
                                        }
