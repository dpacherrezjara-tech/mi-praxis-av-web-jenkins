Ext.define('Ext.Praxis.view.panel.PerProForm.DataEntryReverse',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReversePerProForm',

    controller: 'DataEntryReversePerProController',

    requires:[
        'Ext.Praxis.controller.panel.PerPro.DataEntryReversePerProController'
    ],
