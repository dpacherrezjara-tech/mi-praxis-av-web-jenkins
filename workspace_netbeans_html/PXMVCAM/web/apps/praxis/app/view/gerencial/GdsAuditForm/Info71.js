...
Ext.define('Ext.Praxis.view.gerencial.GdsAuditForm.Info71', {
    extend: 'Ext.form.Panel',
    alias: 'widget.' + prototype.id + '-info71',
    layout: 'border',
    align: 'center',
            ...
            items: [
                {
                    ...
                    items: [
                        // <editor-fold defaultstate="collapsed" desc="gridData">
                        {
                            ...
                            columns: {
                                items: [
                                    {text: 'CODE', dataIndex: 'COUNTRY', width: 50},
                                    ...
                                    },
                                    {
                                        ...
                                        summaryRenderer: function(value, summaryData, dataIndex) {
                                            var grid = Ext.getCmp(prototype.id + '-gridData71');
