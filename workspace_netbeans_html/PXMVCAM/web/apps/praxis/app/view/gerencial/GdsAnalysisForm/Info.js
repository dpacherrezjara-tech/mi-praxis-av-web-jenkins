...
Ext.define('Ext.Praxis.view.gerencial.GdsAnalysisForm.Info', {
                                ...
                                items: [
                                        ...
                                        items: [
                                            {
                                                ...
                                                tooltip: 'Edit',
                                                handler: 'onDetailFlownClick00'
                                            }
                                        ]
                                    },
                                    {text: 'Date', dataIndex: 'MES', width: 80, renderer: 'onMonthStringRenderer'},
                                    {
                                        text: 'BIDT',
                                        columns: [
                                            {
                                                text: 'Pax', dataIndex: 'PAX', width: 70, renderer: 'onAmountRenderer', align: 'right', summaryType: 'sum',
                                    ...
                                    },
                                    {
                                        ...
                                        columns: [
                                            ...
                                            {text: 'Paid $ ', dataIndex: 'NETNU', width: 85, align: 'right', renderer: 'onAmountRenderer01', summaryType: 'sum',
                                                summaryRenderer: function(value, summaryData, dataIndex) {
                                                    return '<b>' + Ext.util.Format.number(value, '0,00.00') + '</b>';
                                                }
                                            }
                                    ...
                                    },
                                    {
                                        ...
                                        columns: [
                                            {text: 'Pax', dataIndex: 'PAXNM', width: 70, align: 'right', summaryType: 'sum', renderer: 'onAmountRenderer',
                                                //renderer:function(value, metaData, record, rowIndex, colIndex,store){
                                                //    //console.log(record);
                                                //    //var tdAttr =  "'"+ record.data.value + "',";
                                                //    //var tdAttr =  tdAttr + "'"+ record.data.value + "'";
                                                //    return '<a href="#prototype.id" onclick="Ext.getCmp(\'App-Flown_bidt-Contenedor\').getController().App_DetailNoMatch(' + rowIndex + ');">' + Ext.util.Format.number(value, '0,000') + '</a>';
                                                //},
                                                summaryRenderer: function(value, summaryData, dataIndex) {
                                                    return '<b>' + Ext.util.Format.number(value, '0,000') + '</b>';
                                                }
                                            ...
                                            {
                                                text: 'Paid $', dataIndex: 'NETNM', width: 90, renderer: 'onAmountRenderer01', align: 'right', summaryType: 'sum',
                                                summaryRenderer: function(value, summaryData, dataIndex) {
                                                    return '<b>' + Ext.util.Format.number(value, '0,00.00') + '</b>';
                                                }
                                            },
