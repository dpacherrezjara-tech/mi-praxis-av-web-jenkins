...
Ext.define('Ext.Praxis.view.gerencial.GdsAnalysisForm.Info3', {
    extend: 'Ext.form.Panel',
    alias: 'widget.' + prototype.id + '-info3',
    layout: 'border',
    align: 'center',
                                        ...
                                        items: [
                                            {
                                                ...
                                                tooltip: 'Edit',
                                                handler: 'onDetailFlownClick02'
                                            }
                                        ]
                                    },
                                    {text: 'Number<br>Flight', dataIndex: 'FNUMBER', width: 60, align: 'center'},
                                    {
                                        text: 'BIDT',
                                        columns: [
                                            {
