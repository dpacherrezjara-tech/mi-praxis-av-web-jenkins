Ext.define('Ext.Praxis.view.gerencial.BiToolsForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryBiToolsForm',
    requires: [
        'Ext.Praxis.controller.gerencial.BiTools.DataEntryBiToolsController'
    ],
    controller: 'DataEntryBiToolsController',
