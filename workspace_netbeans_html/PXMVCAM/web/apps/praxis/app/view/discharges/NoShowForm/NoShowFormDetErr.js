...
Ext.define('Ext.Praxis.view.discharges.NoShowForm.NoShowFormDetErr', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id05 + '-dataEntry',
    controller: prototype.id05 + '-noShowFormDetErrController',
    requires: [
        'Ext.Praxis.controller.discharges.NoShow.NoShowFormDetErrController',
        'Ext.Praxis.view.discharges.NoShowForm.InfoGridDetErr'
    ],
    title: 'Log error de carga',
    width: 650,
    height: 630,
    border: false,
    resizable: false,
    ...
    items: [
        {
            region: 'center',
            xtype: 'form',
            id: prototype.id05 + '-DataEntry-center',
            border: false,
            layout: {
                type: 'vbox'
            },
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'textfield',
                                    id: prototype.id05 + '-TICKET_NUMBER',
...
//                                    },
                        ...
                        {
                            xtype: 'panel',
                            id: prototype.id05 + 'contenedor-grid',
                            layout: 'fit',
                            width: 650,
                            height: 520,                            
                            defaults: {
                            ...
                            items: [
                                {
                                    xtype: prototype.id05 + '-infoGridDetErr'
                                }
                            ]
                        }
                    ]
