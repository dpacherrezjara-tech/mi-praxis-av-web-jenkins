...
Ext.define('Ext.Praxis.view.interline.EstimationReverseARForm.EstimationReverseARForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.EstimationReverseARForm',
    requires: [
        'Ext.Praxis.controller.interline.EstimationReverseAR.EstimationReverseARController',
        'Ext.Praxis.view.interline.EstimationReverseARForm.Options',
        'Ext.Praxis.view.interline.EstimationReverseARForm.Filters',
        'Ext.Praxis.view.interline.EstimationReverseARForm.Info'
    ],
    controller: 'EstimationReverseARController',
    layout: {
        type: 'fit'
    },
    border: false,
