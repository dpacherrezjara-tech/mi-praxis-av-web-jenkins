Ext.define('Ext.Praxis.view.interline.AccountingMasterInterliForm.Info', {
            ...
            items: [
                {
                    ...
                    columns: {
                        ...
                        items: [
                            ...
                            {text: 'Account Type', width: 90, dataIndex: 'A1740TIPO', hidden: true},
                            ...
                            {text: 'Unit', width: 70, dataIndex: 'A1740UNIDA'},
                            ...
                            {text: 'Sub Account', width: 85, dataIndex: 'A1740SCTA'},
                            {text: 'Equipment', width: 80, dataIndex: 'A1740EQUI'},
                            {text: 'Inter Company', width: 95, dataIndex: 'A1740ICIA'},
