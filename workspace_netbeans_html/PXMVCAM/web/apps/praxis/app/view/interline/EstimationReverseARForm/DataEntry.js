Ext.define('Ext.Praxis.view.interline.EstimationReverseARForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryEstimationReverseARForm',
    requires: [
        'Ext.Praxis.controller.interline.EstimationReverseAR.DataEntryEstimationReverseARController'
    ],
    controller: 'DataEntryEstimationReverseARController',
                                            ...
                                            items: [
                                                // <editor-fold defaultstate="collapsed" desc="gvwConta">
                                                {
                                                    ...
                                                    columns: {
                                                        ...
                                                        items: [
                                                            {
                                                                text: 'Cta', dataIndex: 'A2112CUENTA', width: 300,
                                                            ...
                                                            {
                                                                text: 'Desc', dataIndex: 'A2112TITU', flex: 1,//width: 300,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = "text-align:center;color:#244066;";
                                                                    return value;
                                                                }
                                                            ...
                                                            {
                                                                text: 'Debit', dataIndex: 'A2112ACTIV', width: 85,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                ...
                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                    metaData.style = "text-align:right;";
                                                                      ...
                                                                      var total = 0;
                                                                      for (var i = 0; i < items.length; i++) total += Number(items[i].data.A2112ACTIV);
                                                                    return Ext.util.Format.number(total, '0,000.00');
                                                                }
                                                            },
                                                            {
                                                                text: 'Credit', dataIndex: 'A2112PASIV', width: 85,
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = "text-align:right;color:#244066;";
                                                                    return Ext.util.Format.number(value, '0,000.00');
                                                                },
                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                    metaData.style = "text-align:right;";
                                                                      var items = Ext.getCmp(prototype.id + '-gvwConta').getStore().getData().items;
                                                                      var total = 0;
                                                                      for (var i = 0; i < items.length; i++) total += Number(items[i].data.A2112PASIV);
                                                                    return Ext.util.Format.number(total, '0,000.00');
                                                                }
                                                            },
                                                            {
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                {
                    xtype: 'label',
                    id: prototype.id + '-lblA2111GRUPO_OLD',
                    hidden: true
                }
            ]
        }
