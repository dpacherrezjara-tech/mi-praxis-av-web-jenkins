Ext.define('Ext.Praxis.view.interline.TAXAnalysisDocumentsForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryTAXAnalysisDocumentsForm',

    controller: 'DataEntryTAXAnalysisDocumentsController',

    requires: [
        'Ext.Praxis.controller.interline.TAXAnalysisDocuments.DataEntryTAXAnalysisDocumentsController'
    ],
