Ext.define('Ext.Praxis.view.interline.PassengerInvoicesForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryPassengerInvoicesForm',
    requires: [
        'Ext.Praxis.controller.interline.PassengerInvoices.DataEntryPassengerInvoicesController'
    ],
    controller: 'DataEntryPassengerInvoicesController',
    title: 'Export Information Passenger Invoices',
    header: true,
    height: 208,
    width: 425,
    border: false,
