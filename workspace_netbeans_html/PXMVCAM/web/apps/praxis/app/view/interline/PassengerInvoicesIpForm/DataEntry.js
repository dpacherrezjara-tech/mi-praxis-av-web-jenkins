Ext.define('Ext.Praxis.view.interline.PassengerInvoicesIpForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryPassengerInvoicesIpForm',
    requires: [
        'Ext.Praxis.controller.interline.PassengerInvoicesIp.DataEntryPassengerInvoicesIpController'
    ],
    controller: 'DataEntryPassengerInvoicesIpController',
