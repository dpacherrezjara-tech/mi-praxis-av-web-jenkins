Ext.define('Ext.Praxis.view.interline.EstimationReverseAPForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryEstimationReverseAPForm',
    requires: [
        'Ext.Praxis.controller.interline.EstimationReverseAP.DataEntryEstimationReverseAPController'
    ],
    controller: 'DataEntryEstimationReverseAPController',
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                    metaData.style = "text-align:right;";
                                                                      ...
                                                                      var total = 0;
                                                                      for (var i = 0; i < items.length; i++) total += Number(items[i].data.A2135ACTIV);
                                                            ...
                                                            },
                                                            {
                                                                ...
                                                                summaryRenderer: function (value, summaryData, dataIndex, metaData, record) {
                                                                    metaData.style = "text-align:right;";
                                                                      var items = Ext.getCmp(prototype.id + '-gvwConta').getStore().getData().items;
                                                                      var total = 0;
                                                                      for (var i = 0; i < items.length; i++) total += Number(items[i].data.A2135PASIV);
                                                                    return Ext.util.Format.number(total, '0,000.00');
                                                                }
                                                            },
                                                            {
