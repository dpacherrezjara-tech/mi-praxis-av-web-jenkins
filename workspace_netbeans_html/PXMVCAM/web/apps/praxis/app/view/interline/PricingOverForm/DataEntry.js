Ext.define('Ext.Praxis.view.interline.PricingOverForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryPricingOverForm',

    controller: 'DataEntryPricingOverController',

    requires: [
        'Ext.Praxis.controller.interline.PricingOver.DataEntryPricingOverController'
    ],
