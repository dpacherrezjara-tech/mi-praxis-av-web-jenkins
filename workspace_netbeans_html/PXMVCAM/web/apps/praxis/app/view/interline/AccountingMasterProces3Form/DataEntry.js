Ext.define('Ext.Praxis.view.interline.AccountingMasterProces3Form.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryAccountingMasterProces3Form',

    controller: 'DataEntryAccountingMasterProces3Controller',

    requires:[
        'Ext.Praxis.controller.interline.AccountingMasterProces3.DataEntryAccountingMasterProces3Controller'
    ],
