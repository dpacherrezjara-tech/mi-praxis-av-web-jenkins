Ext.define('Ext.Praxis.view.interline.SPAProfitabilityForm.Prorrateo', {
                    ...
                    items: [
                        //<editor-fold defaultstate="collapsed" desc="Cabecera">
                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'button',
                                    id: prototype.id + '-btnSaveProrate',
                                    style: 'font-weight:bold;background:#22CE0B;',
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            xtype: 'textfield',
                                                            id: prototype.id + '-txtT_Endorsements',
                                                            fieldStyle: 'text-align:center;',
                                                            width: 228,
                                                            readOnly: true
                                                        }
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    items: [
                                                        ...
                                                        {
                                                            xtype: 'textfield',
                                                            id: prototype.id + '-txtT_conjunctions',
                                                            fieldStyle: 'text-align:center;',
                                                            width: 180,
                                                            readOnly: true
                                                        }
                                    ...
                                    items: [
                                        // <editor-fold defaultstate="collapsed" desc="gridEtktRout">
                                        {
                                            ...
                                            columns: {
                                                ...
                                                items: [
                                                    {
                                                        text: 'Cp', dataIndex: 'strCPN'//, width: 40,
                                                    },
                                                    {
                                                        text: 'X/O', dataIndex: 'strXO'//, width: 40,
                                                    },
                                                    {
                                                        text: 'From', dataIndex: 'strFROM',// width: 100,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                    ...
                                                    {
                                                        text: 'To', dataIndex: 'strTO',// width: 100,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                            var data = record.data;
                                                            metaData.style = "text-align:center;";
                                                    ...
                                                    {
                                                        text: 'Cr', dataIndex: 'strCR'//, width: 40,
                                                    },
                                                    {
                                                        text: 'Flight', dataIndex: 'strFLIGHT'//, width: 40,
                                                    },
                                                    {
                                                        text: 'Class', dataIndex: 'strCLASS'//, width: 40,
                                                    },
                                                    {
                                                        text: 'Date', dataIndex: 'strDATE'//, width: 40,
                                                    },
                                                    {
                                                        text: 'Time', dataIndex: 'strTIME'//, width: 40,
                                                    },
                                                    {
                                                        text: 'Fare Basis', dataIndex: 'strFAREBASIS'//, width: 40,
                                                    },
                                                    {
                                                        text: 'NVB', dataIndex: 'strNVB'//, width: 40,
                                                    },
                                                    {
                                                        text: 'NVA', dataIndex: 'strNVA'//, width: 40,
                                                    },
                                                    {
                                                        text: 'St', dataIndex: 'strST',// width: 100,
                                                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                    ...
                                    items: [
                                        ...
                                        //<editor-fold defaultstate="collapsed" desc="Columna 2">
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: 'textfield',
                                                    id: prototype.id + '-txtT_TotalTaxes',
                                                    fieldStyle: 'text-align:center;',
                                                    width: 690,
                                                    readOnly: true
                                                },
