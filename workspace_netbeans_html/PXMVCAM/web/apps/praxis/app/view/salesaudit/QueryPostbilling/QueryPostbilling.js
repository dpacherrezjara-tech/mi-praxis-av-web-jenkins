...
Ext.define('Ext.Praxis.view.salesaudit.QueryPostbilling.QueryPostbilling', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.QueryPostbilling',

    requires: [
        'Ext.Praxis.controller.salesaudit.QueryPostbilling.QueryPostbillingController',
    ...
    controller: 'QueryPostbillingController',
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            xtype: 'combo',
                                            id: prototype.id + '-CmbProcessstatus',
