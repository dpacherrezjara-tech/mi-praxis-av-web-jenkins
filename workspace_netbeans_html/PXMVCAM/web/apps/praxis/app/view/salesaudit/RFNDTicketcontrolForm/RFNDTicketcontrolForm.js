...
Ext.define('Ext.Praxis.view.salesaudit.RFNDTicketcontrolForm.RFNDTicketcontrolForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.RFNDTicketcontrolForm',

    requires: [
        'Ext.Praxis.controller.salesaudit.RFNDTicketcontrolForm.RFNDTicketcontrolFormController',
        'Ext.Praxis.view.salesaudit.RFNDTicketcontrolForm.DetailRFNDTicketcontrolTicket'
    ],

    controller: 'RFNDTicketcontrolFormController',
                    ...
                    items: [
                        {
                            ...
                            columns: {
                                items: [
                                    {text: 'System</br>date',dataIndex: 'A3648FREGI',width: 80},
                                    {text: 'Application</br>date',dataIndex: 'A3648FAPPI',width: 80},
                                    {text: 'Authorise/</br>Reject date',dataIndex: 'A3648FAUTO',width: 80},
                                    {text: 'Folio',dataIndex: 'A3648FOLIO',width: 100},
                                    {text: 'Ticket',dataIndex: 'A3648TKT',width: 100},
                                    {text: 'Auditor',dataIndex: 'A3648REGAS',width: 80},
                                    {
                                        text: 'Status',
                                        flex: 1,
                                        columns: [  {text: 'Sales audit',dataIndex: 'A3648FLAG',flex: 1,align: 'center'},
                                                    {text: 'Status RFND',dataIndex: 'A3648STATO',flex: 1,align: 'center'},
                                                    {text: 'Status Praxis',dataIndex: 'A3648STATU',flex: 1,align: 'center',renderer: 'onRendererColumnOnStatus'}
                                                 ]
                                    },
                                    {
                                        sortable: false,
