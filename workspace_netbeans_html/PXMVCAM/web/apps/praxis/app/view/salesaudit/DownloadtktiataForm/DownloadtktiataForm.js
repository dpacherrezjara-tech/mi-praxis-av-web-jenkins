...
prototype.idDownloadtktiataForm = 'DownloadtktiataForm';
prototype.url = CONTEXTPATH + '/DownloadtktiataForm';
prototype.widthWindow = 1366;
prototype.heightWindow = 768;

Ext.define('Ext.Praxis.view.salesaudit.DownloadtktiataForm.DownloadtktiataForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.DownloadtktiataForm',

    requires: [
        'Ext.Praxis.controller.salesaudit.DownloadtktiataForm.DownloadtktiataFormController',
    ],

    controller: 'DownloadtktiataFormController',

    id: prototype.idDownloadtktiataForm + '-Contenedor',
    ...
    items: [
        {
            xtype: 'panel',
            id: prototype.idDownloadtktiataForm + '-contenedor-form',
            width: prototype.widthWindow,
            items: [
                {
                    xtype: 'panel',
                    id: prototype.idDownloadtktiataForm + '-contenedor-options',
                    border: false,
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype: 'checkbox',
                                    id: prototype.idDownloadtktiataForm + '-pagination',
                                    boxLabel: 'Pagination?',
                                    checked: true,
                                    listeners: {
                                ...
                                {
                                    xtype: 'Paginator',
                                    id: prototype.idDownloadtktiataForm + '-pagginator-01',
                                    pagInfo: [
                                        prototype.idDownloadtktiataForm + '-lbl-currentPage',
                                        prototype.idDownloadtktiataForm + '-lbl-pageCount',
                                        prototype.idDownloadtktiataForm + '-lbl-total'
                                    ]
                                }
                            ]
                        },
                        {xtype: 'tbspacer', width: 50},
                        {
                            ...
                            items: [
                                {
                                    xtype: 'button',
                                    id: prototype.idDownloadtktiataForm + '-btn-search',
                                ...
                                {
                                    xtype: 'button',
                                    id: prototype.idDownloadtktiataForm + '-btn-filter',
                                ...
                                {
                                    xtype: 'button',
                                    id: prototype.idDownloadtktiataForm + '-btn-excel',
                                ...
                                {
                                    xtype: 'button',
                                    id: prototype.idDownloadtktiataForm + '-btn-clear',
                ...
                {
                    xtype: 'panel',
                    id: prototype.idDownloadtktiataForm + '-contenedor-filters',
                    ...
                    items: [
                        {
                            xtype: 'form',
                            id: prototype.idDownloadtktiataForm + '-contenedor-filters-form',
                            defaults: {
                                padding: '1px',
                                bodyStyle: 'background: transparent'
                            },
                            items: [
                                {
                                    xtype: 'panel',
                                    id: prototype.idDownloadtktiataForm + '-box-filter-01',
                                    layout: 'hbox',
                                    border: true,
                                    defaults: {
                                    ...
                                    items: [
                                        {
                                            ...
                                            id: prototype.idDownloadtktiataForm + '-search-type',
                                            labelAlign: 'left',
                                            queryMode: 'local',
                                            valueField: 'code',
                                            displayField: 'name',
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.idDownloadtktiataForm + '-txtIATA',
                                            width: 100,
                                            hideLabel: true,
                                            maskRe: /[0-9]/,
                                            maxLength: 8,
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.idDownloadtktiataForm + '-txtCia',
                                            hideLabel: true,
                                            width: 35,
                                            maskRe: /[0-9]/,
                                            maxLength: 2,
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.idDownloadtktiataForm + '-txtFrmaSerie',
                                            hideLabel: true,
                                            width: 80,
                                            maskRe: /[0-9]/,
                                            maxLength: 10,
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.idDownloadtktiataForm + '-txtSeq',
                                            hideLabel: true,
                                            width: 30,
                                            hidden: true
                                        },

                                        {
                                            xtype: 'combo',
                                            fieldLabel: 'Country',
                                            id: prototype.idDownloadtktiataForm + '-cmbcountry',
                                            labelAlign: 'left',
                                            queryMode: 'local',
                                            valueField: 'code',
                                            displayField: 'name',
                                        ...
                                        {
                                            xtype: 'datefield',
                                            id: prototype.idDownloadtktiataForm + '-txtFilterDateFrom',
                                            fieldLabel: 'From',
                                            format: 'Y/m/d',
                                        ...
                                        {
                                            xtype: 'datefield',
                                            id: prototype.idDownloadtktiataForm + '-txtFilterDateTo',
                                            fieldLabel: 'To',
                                            format: 'Y/m/d',
                                            maxValue: Ext.Date.format(new Date(), 'Y/m/d'),
                                            value: Ext.Date.format(new Date(), 'Y/m/d'),
                                        ...
                                        {xtype: 'tbspacer', width: 100},
                                        {
                                            ...
                                            id: prototype.idDownloadtktiataForm + '-btn-processingdata',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'grid',
                            id: prototype.idDownloadtktiataForm + '-gridsale',
                            columnLines: true,
                            autoScroll: true,
                            width: 1360,
                            height: 520,
                        ...
                        {
                            xtype: 'grid',
                            id: prototype.idDownloadtktiataForm + '-gridexch1',
                            columnLines: true,
                            autoScroll: true,
                            width: 1360,
                            height: 520,
                        ...
                        {
                            xtype: 'grid',
                            id: prototype.idDownloadtktiataForm + '-gridexch2',
                            columnLines: true,
                            autoScroll: true,
                            width: 1360,
                            height: 520,
                ...
                {
                    xtype: 'panel',
                    id: prototype.idDownloadtktiataForm + '-pagginator-legend',
                    layout: {
                        type: 'hbox',
                        pack: 'center'
                    },
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {
                                    id: prototype.idDownloadtktiataForm + '-lbl-currentPage',
                                    text: '1',
                                    width: 50
                                },
                                {
                                ...
                                {
                                    id: prototype.idDownloadtktiataForm + '-lbl-pageCount',
                                    text: '0',
                                    width: 50
                                },
                                {xtype: 'tbspacer', width: 100},
                                ...
                                {
                                    id: prototype.idDownloadtktiataForm + '-lbl-total',
                                    text: '0',
                                    width: 50
                                }
                            ]
