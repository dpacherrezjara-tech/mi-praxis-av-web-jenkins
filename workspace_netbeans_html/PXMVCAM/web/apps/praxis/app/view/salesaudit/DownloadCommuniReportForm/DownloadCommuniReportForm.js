...
Ext.define('Ext.Praxis.view.salesaudit.DownloadCommuniReportForm.DownloadCommuniReportForm', {
    ...
    alias: 'widget.DownloadCommuniReportForm',

    requires: [
        'Ext.Praxis.controller.salesaudit.DownloadCommuniReportForm.DownloadCommuniReportFormController',
    ],

    controller: 'DownloadCommuniReportFormController',
                            ...
                            items: [
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {text: 'System </br>date', dataIndex: 'A3455FREGI', width: 75},
                                            {text: 'Execution </br>date', dataIndex: 'A3455FDATE', width: 75},
                                            {text: 'Country', dataIndex: 'A3455PAIS', width: 80, align: 'center', renderer: 'onRendererColumnOnPais'},
                                            {text: 'Total', dataIndex: 'A3455COUNT', width: 120, align: 'right',
                                            ...
                                            {text: 'Processed', dataIndex: 'A3455COUNT', width: 100, align: 'right',
                                                summaryType: 'sum',
                                                summaryRenderer: function (value, summaryData, dataIndex) {
                                            ...
                                            {text: 'Status', dataIndex: 'A3455ESTAD', width: 200, sortable: false, align: 'right'},
                                ...
                                },
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            ...
                                            {text: 'Status', dataIndex: 'A3455ESTAD', width: 180, sortable: false, align: 'right'},
                                            {text: '', dataIndex: '', width: 60, renderer: 'onRendererColumnOnTime'}
