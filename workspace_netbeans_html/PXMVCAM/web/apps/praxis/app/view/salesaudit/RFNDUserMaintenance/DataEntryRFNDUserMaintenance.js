 ...
 * -------------------------------
 */
Ext.define('Ext.Praxis.view.salesaudit.RFNDUserMaintenance.DataEntryRFNDUserMaintenance',{
	extend: 'Ext.window.Window',
    alias: 'widget.DataEntryRFNDUserMaintenance',

    controller: 'DataEntryRFNDUserMaintenanceController',

    requires:[
        'Ext.Praxis.controller.salesaudit.RFNDUserMaintenance.DataEntryRFNDUserMaintenanceController',
    ],
