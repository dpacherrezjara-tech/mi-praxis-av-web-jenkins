 ...
 */
prototype.id = 'BsplinkRefundQueryRFND';
...
Ext.define('Ext.Praxis.view.salesaudit.BsplinkRefundQueryRFND.BsplinkRefundQueryRFND',{
    extend: 'Ext.panel.Panel',
    alias: 'widget.BsplinkRefundQueryRFND',

    requires:[
        'Ext.Praxis.controller.salesaudit.BsplinkRefundQueryRFND.BsplinkRefundQueryRFNDController',
        'Ext.Praxis.view.salesaudit.BsplinkRefundQueryRFND.DetailBsplinkRefundQueryRFND'
    ],

    controller: 'BsplinkRefundQueryRFNDController',
