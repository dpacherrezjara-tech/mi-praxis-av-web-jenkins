...
Ext.define('Ext.Praxis.view.salesaudit.ADMManualForm.ADMManualForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.ADMManualForm',

    requires: [
        'Ext.Praxis.controller.salesaudit.ADMManualForm.ADMManualFormController',
                            ...
                            selModel: {
                                ...
                                listeners: {
                                    beforeselect: function (grid, record, index, eOpts, metaData) {
                                        ...
                                        if (Ext.String.trim(record.get('A2548FLAG')) === 'Y' || Ext.String.trim(record.get('A2548FLAG')) === 'O' || Ext.String.trim(record.get('A2548FLAG')) === 'Q') {
                                            return true;
                                        } else {
                                            return false;
                                        }
