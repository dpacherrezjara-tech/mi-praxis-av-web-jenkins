...
Ext.define('Ext.Praxis.view.flown.ConciliationStatusForm.ConciliationStatusForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.ConciliationStatusForm',
    requires: [
        'Ext.Praxis.controller.flown.ConciliationStatusForm.ConciliationStatusFormController',
    ],
    controller: 'ConciliationStatusFormController',
                    ...
                    items: [
                        {
                            ...
                            id: prototype.id + '-pagginator-pri',
                            border: false,
                            defaults: {
