Ext.define('Ext.Praxis.view.flown.OCRLoadForm.Info', {
            ...
            items: [
                {
                    ...
                    columns: {
                        ...
                        items: [
                            {text: 'Ticket', width: 200, dataIndex: 'strTicket',
                            ...
                            },
                            {
                                ...
                                columns: [
                                    ...
                                    {text: 'Departure', dataIndex: 'CDEPART', width: 100,
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = "text-align:center;";
                                    ...
                                    {text: 'Arrival', dataIndex: 'CARRIVA', width: 100,
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = "text-align:center;";
