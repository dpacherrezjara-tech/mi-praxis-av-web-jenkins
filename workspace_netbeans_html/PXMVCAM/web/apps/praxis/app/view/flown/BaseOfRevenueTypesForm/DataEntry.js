Ext.define('Ext.Praxis.view.flown.BaseOfRevenueTypesForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryBaseOfRevenueTypesForm',

    controller: 'DataEntryBaseOfRevenueTypesController',

    requires:[
        'Ext.Praxis.controller.flown.BaseOfRevenueTypes.DataEntryBaseOfRevenueTypesController'
    ],

    title:'BaseOfRevenueTypes',
    header:true,
    height:280,
    width:400,
    border:false,
