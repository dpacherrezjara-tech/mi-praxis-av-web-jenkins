Ext.define('Ext.Praxis.view.flown.FlightClassificationForm.Info', {
            ...
            items: [
                {
                    ...
                    columns: {
                        ...
                        items: [
                            ...
                            {text: 'Flight Ranges', width: 150, dataIndex: 'A051COMENT',
                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    metaData.style = "text-align:center;";
                                    return value;
                                }
                            },
                            {text: 'Flight type', width: 250, dataIndex: 'A051DESCR1',
                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    metaData.style = "text-align:left;";
                                    return value;
                                }
                            },
                            {text: 'Flight Classification', width: 250, dataIndex: 'A051DESCR2',
                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    metaData.style = "text-align:left;";
                                    return value;
                                }
