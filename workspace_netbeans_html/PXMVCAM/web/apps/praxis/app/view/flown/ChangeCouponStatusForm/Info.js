...
Ext.define('Ext.Praxis.view.flown.ChangeCouponStatusForm.Info', {
            ...
            items: [
                {
                    ...
                    columns: {
                        ...
                        items: [
                            ...
                            {text: 'Status', width: 120, dataIndex: 'strFormatDate2'},
                            {text: 'Sale',
                                defaults: {
                                    menuDisabled: true,
                                    sortable: true,
                            ...
                            {text: 'Coupon',
                                ...
                                columns: [
                                    ...
                                    {text: 'Carrier', width: 55, dataIndex: 'CARR'},
                                    {text: 'Cabin', width: 50, dataIndex: 'CABI'},
                                    ...
                                    {text: 'MXN', width: 60, dataIndex: 'VCPMX',
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = 'text-align :right ; margin-right : 3px ';
                                            return Ext.util.Format.number(value, '0,000.00');
                                        }},
                                    {text: 'Rate', width: 55, dataIndex: 'TCMUS',
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = 'text-align :right ; margin-right : 3px ';
                                            return Ext.util.Format.number(value, '0,000.00');
                                        }},
                                    {text: 'USD', width: 60, dataIndex: 'VCPUS',
                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                            metaData.style = 'text-align :right ; margin-right : 3px ';
                                            return Ext.util.Format.number(value, '0,000.00');
                                        }}
                    ...
                    columns: {
                        ...
                        items: [
                            ...
                            {text: 'Status',
                                ...
                                columns: [
                                    {text: 'Original', width: 120, dataIndex: 'strDescSTVAL'},
                                    {text: 'new', width: 120, dataIndex: 'strDescSTNEW'}
                                ]
                            },
                            {text: 'Flight',
                                defaults: {
                            ...
                            {text: 'Batch', width: 100, dataIndex: 'BATCHP'},
                            {text: 'Creation',
                                defaults: {
                                    menuDisabled: true,
                                    sortable: true,
                                ...
                                columns: [
                                    {text: 'User', width: 90, dataIndex: 'USCR'},
