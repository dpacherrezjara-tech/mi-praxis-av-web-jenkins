...
Ext.define('Ext.Praxis.view.flown.ElectronicMiscellaneousForm.DeliveryInformation', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-deliveryInformation',
    controller: prototype.id + '-DeliveryController',
    requires: [
        'Ext.Praxis.controller.flown.ElectronicMiscellaneous.DeliveryController'
    ],
