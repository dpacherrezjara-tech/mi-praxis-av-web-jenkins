...
Ext.define('Ext.Praxis.view.flown.ChangeOfStatusForm.ChangeOfStatusForm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.ChangeOfStatusForm',
    requires: [
        'Ext.Praxis.controller.flown.ChangeOfStatusForm.ChangeOfStatusFormController',
    ],
    controller: 'ChangeOfStatusFormController',
