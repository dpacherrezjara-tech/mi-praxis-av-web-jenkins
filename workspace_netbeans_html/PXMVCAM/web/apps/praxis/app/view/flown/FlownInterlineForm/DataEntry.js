Ext.define('Ext.Praxis.view.flown.FlownInterlineForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryFlownInterlineForm',
    requires:[
        'Ext.Praxis.controller.flown.FlownInterline.DataEntryFlownInterlineController'
    ],
    controller: 'DataEntryFlownInterlineController',
