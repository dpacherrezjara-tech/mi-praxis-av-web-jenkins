Ext.define('Ext.Praxis.view.flown.Coupon409Form.Info', {
                        ...
                        // <editor-fold defaultstate="collapsed" desc="gridData">
                        {
                            ...
                            columns: {
                                ...
                                items: [
                                    ...
                                    {
                                        text: 'Processing Date', dataIndex: 'PRDA', width: 135,//text="{data.strFormatDate}"
                                    },
                                    {
                                        text: 'Ticket', dataIndex: 'SERIE', width: 100,//text="{data.CCIA + ' ' + data.FORMA + data.SERIE+' '+ data.CUPON}"
                                    },
                                    {
