Ext.define('Ext.Praxis.view.flown.FlightClassificationForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryFlightClassificationForm',

    controller: 'DataEntryFlightClassificationController',

    requires:[
        'Ext.Praxis.controller.flown.FlightClassification.DataEntryFlightClassificationController'
    ],

    title:'FlightClassification',
    header:true,
    height:280,
    width:400,
    border:false,
