Ext.define('Ext.Praxis.view.flown.IvaZoneForm.Info', {
            ...
            items: [
                {
                    ...
                    columns: {
                        ...
                        items: [
                            ...
                            {text: 'OD', width: 350, dataIndex: 'A051COMENT',
                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    metaData.style = "text-align:center;";
                                    return value;
                                }
                            },
                            {text: 'Account Type', hidden: true, width: 250, dataIndex: 'A051DESCR2',
                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    metaData.style = "text-align:left;";
                                    return value;
                                }
                            ...
                            {text: 'From', hidden: true, width: 80, dataIndex: 'A051FECHA1',
                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    metaData.style = "text-align:right;";
                                    return value;
                                }
                            },
                            {text: 'To', hidden: true, width: 80, dataIndex: 'A051FECHA2',
                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                    metaData.style = "text-align:right;";
                                    return value;
                                }
