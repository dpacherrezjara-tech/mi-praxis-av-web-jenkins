Ext.define('Ext.Praxis.view.flown.ItemForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryItemForm',

    controller: 'DataEntryItemController',

    requires:[
        'Ext.Praxis.controller.flown.Item.DataEntryItemController'
    ],
