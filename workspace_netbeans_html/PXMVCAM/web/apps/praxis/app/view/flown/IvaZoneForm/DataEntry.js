Ext.define('Ext.Praxis.view.flown.IvaZoneForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryIvaZoneForm',

    controller: 'DataEntryIvaZoneController',

    requires:[
        'Ext.Praxis.controller.flown.IvaZone.DataEntryIvaZoneController'
    ],
