...
Ext.define('Ext.Praxis.view.flown.PassengerConciliationForm.Options', {
//    xtype: 'panel',
    ...
    items: [
        {
            xtype: 'panel',
            id: prototype.id + '-panelPagination',
            width: 100,
            border: false,
            items: [
                {
...
//                        },
                        ...
                        {
                            xtype: 'button',
                            id: prototype.id + '-btnAccountingQuery',
                            icon: 'resources/img/botones/panel.png',
                            tooltip: 'Accounting Query',
                            listeners: {
                                click: 'btnAccountingQuery_click'
                            }
                        }
                    ]
                }
