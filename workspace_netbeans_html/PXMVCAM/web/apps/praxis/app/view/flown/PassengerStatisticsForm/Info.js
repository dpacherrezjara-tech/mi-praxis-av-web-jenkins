...
Ext.define('Ext.Praxis.view.flown.PassengerStatisticsForm.Info', {
...
//                                }
                                ...
                                //-----------------------------------------------------------------
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {text: 'Date', width: 90, dataIndex: 'fecha',
                                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                    metaData.style = ' color:#008FE3;text-align:center;';
                                                    return '<a href="#flown-passenger-statistics-form" style="color:#008FE3;">' + value + '</a>';
                                                }
//                                                ,
//                                                listeners: {
...
//                                                }
                                            ...
                                            {text: 'Flight ',
                                                ...
                                                columns: [
                                                    {text: 'Flight ', width: 100, dataIndex: 'QTYFLOW',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:0px;';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: 'Passenger ', width: 100, dataIndex: 'QTYPAX',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:0px;';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    ...
                                                    {text: 'Amount ', width: 100, dataIndex: 'AMOPAX',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:0px;';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                                            ...
                                            {text: 'Charter ',
                                                ...
                                                columns: [
                                                    {text: 'Flight ', width: 100, dataIndex: 'QTYFLOWC',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:0px;';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: 'Passenger ', width: 100, dataIndex: 'QTYPAXC',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:0px;';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    ...
                                                    {text: 'Currency ', width: 100, dataIndex: 'CURRENC'},
                                                    {text: 'Amount ', width: 100, dataIndex: 'AMOPAXC',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = 'text-align:right; margin-right:0px;';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                            ...
                            items: [
                                {
                                    ...
                                    items: [
                                        {
                                            xtype: 'checkboxfield',
                                            id: prototype.id + '-chkCtrlFlig',
                                            margin: '8 0 0 30',
                                            width: 150,
                                            boxLabel: 'Group by Month',
                                            inputValue: '1'
                                        },
                                        {
                                            xtype: 'combo',
                                            id: prototype.id + '-cmbMatch',
                                            fieldLabel: 'Search',
                                            queryMode: 'local',
                                            editable: false,
                                            triggerAction: 'all',
                                ...
                                // --------------------------   GRID PRAXIS VS ORACLE --------------
                                //-----------------------------------------------------------------
                                {
                                    xtype: 'grid',
                                    padding: '20 0 0 0',
                                    id: prototype.id + '-gridPraxisOracle',
                                    bodyStyle: 'background: transparent',
                                    height: 590,
                                    width: 603,
                                    columnLines: true,
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            ...
                                            {text: 'Carrier ', width: 100, dataIndex: 'CARRI',
                                                summaryRenderer: function(value, summaryData, dataIndex, metaData, record) {
                                                    return '<b><b>';
                                                }
                                            },
                                            {text: 'Currency ', width: 100, dataIndex: 'NFLIGHT', summaryRenderer: function(value, summaryData, dataIndex, metaData, record) {
                                                    return '<b><b>';
                                                }
                                            },
                                            {text: 'Original Currency -', id: prototype.id + '-hdPraOra',
                                                defaults: {
                                                    menuDisabled: true,
                                                    sortable: true,
                                                    align: 'center'
                                                ...
                                                columns: [
                                                    {text: '(Praxis vs Oracle Accounting Entry)', id: prototype.id + '-hdPraOra2',
                                                        defaults: {
                                                            menuDisabled: true,
                                                            sortable: true,
                                                            align: 'center'
                                                        ...
                                                        columns: [
                                                            {text: 'PRAXIS', width: 100, dataIndex: 'A1791VALOR', summaryRenderer: function(value, summaryData, dataIndex, metaData, record) {
                                                                    var data = Ext.getCmp(prototype.id + '-gridPraxisOracle').getStore().getData().items[0].data;
                                                                    metaData.style = 'text-align:right';
                                                                    return '<b>' + Ext.util.Format.number(data.totPRAXIS, '0,000') + '<b>';
                                                                },
                                                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            ...
                                                            {text: 'ORACLE ', width: 100, dataIndex: 'A1791ORAV', summaryRenderer: function(value, summaryData, dataIndex, metaData, record) {
                                                                    var data = Ext.getCmp(prototype.id + '-gridPraxisOracle').getStore().getData().items[0].data;
                                                                    metaData.style = 'text-align:right';
                                                                    return '<b>' + Ext.util.Format.number(data.totORACLE, '0,000.00') + '<b>';
                                                                },
                                                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = ' text-align:right; margin-right:3px ';
                                                                    return  Ext.util.Format.number(value, '0,000.00');
                                                            ...
                                                            {text: 'Difference ', width: 100, dataIndex: 'totDiff',
                                                                summaryRenderer: function(value, summaryData, dataIndex, metaData, record) {
                                                                    var data = Ext.getCmp(prototype.id + '-gridPraxisOracle').getStore().getData().items[0].data;
                                                                    metaData.style = 'text-align:right';
                                                                    return '<b>' + Ext.util.Format.number((data.totPRAXIS - data.totORACLE), '0,000.00') + '<b>';
                                                                },
                                                                renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    metaData.style = ' text-align:right; margin-right:3px ';
                                                                    return  Ext.util.Format.number(value, '0,000.00');
                                ...
                                //-----------------------------------------------------------------
                                {
                                    ...
                                    columns: {
                                        ...
                                        items: [
                                            {text: 'Flight <br> Date', width: 100, dataIndex: 'strFormatDate'},
                                            {text: 'Flight ', width: 100, dataIndex: 'NFLIGHT'},
                                            {text: 'Carrier ', width: 100, dataIndex: 'CARRI'},
                                            {text: 'Original Pax', // id: prototype.id + '-hdPraOra',
                                                defaults: {
                                                    menuDisabled: true,
                                                    sortable: true,
                                                    align: 'center'
                                                ...
                                                columns: [
                                                    {text: 'Flown', width: 100, dataIndex: 'lngQODS',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = ' text-align:right; margin-right:3px ';
                                                            return  Ext.util.Format.number(value, '0,000');
                                                        }
                                                    ...
                                                    {text: 'PRAXIS ', width: 100, dataIndex: 'lngQVCR',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = ' text-align:right; margin-right:3px ';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                                                    },
                                                    {text: 'Difference ', width: 100, dataIndex: 'lngQDIFF',
                                                        renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                                            metaData.style = ' text-align:right; margin-right:3px ';
                                                            return  Ext.util.Format.number(value, '0,000.00');
                                                        }
                                ...
                                {
                                    xtype: 'panel',
                                    id: prototype.id + '-panelDataControlSummary',
                                    width: 603,
                                    align: 'left',
                                    defaults: {
                                        xtype: 'label',
                                    ...
                                    items: [
                                        ...
                                        {width: 100},
                                        {width: 100},
                                        {width: 100, id: prototype.id + '-lngQSVOPEND'},
                                        {width: 100, id: prototype.id + '-lngQSVOPRO'},
                                        {width: 103, id: prototype.id + '-longDiference'}
