 ...
 *                                                                *
 * Project    : PRAXIS - RAVN                                     *
 * Document   : GridDataPraxisVsInteract                          *
 * Created on : 12-10-2016, 10:50:11                              *
...
Ext.define('PXMVCAMHome.model.sales.ConciliationASR.GridDataPraxisVsInteract', {
    extend: 'Ext.data.Model',
    fields: [
        {name: 'A1530AGENT', type: 'string'},
        {name: 'A1530FDESD', type: 'string'},
        {name: 'A1530MDA', type: 'string'},
        ...
        },
        {
            ...
            type: 'string',
            convert: function (value, record) {
                return (record.get('A1530USRAC') === '') ? record.get('A1530USRIN') : record.get('A1530USRAC');
            }
        },
        {
            name: 'dateLastModify',
            type: 'string',
            convert: function (value, record) {
                var datadateLastModify = (record.get('A1530FECAC') === '') ? record.get('A1530FECIN') : record.get('A1530FECAC');
