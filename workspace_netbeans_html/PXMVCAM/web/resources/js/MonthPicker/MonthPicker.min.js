!function(a, b, c, d) {
    ...
    function l(b, c) {
        ...
        try {
            ...
            for (var i in g)
                h[g[i]] = i;
            var j = e(new d);
            return j += parseInt(h.m, 10) || 0,
            j + 12 * (parseInt(h.y, 10) || 0)
        } catch (k) {
            return !1
        }
    }
    ...
    if (!(a && a.ui && a.ui.button && a.ui.datepicker))
        return void alert(r + "The jQuery UI button and datepicker plug-ins must be loaded.");
    ...
    a.widget("KidSysco.MonthPicker", {
        ...
        _destroy: function() {
            var b = this.element;
            a.mask && this.options.UseInputMask && (b.unmask(),
            this.GetSelectedDate() || b.val("")),
        ...
        _setOption: function(b, c) {
            ...
            return b in I && -1 === a.inArray(c, I[b]) ? void alert(E.replace(/%/, b) + I[b]) : (this._super(b, c),
            void (J[b] ? this[J[b]](c) : 0))
        },
        _create: function() {
            var b = this.element
              , e = this.options
            ...
            if (!a.mask && e.UseInputMask)
                return alert(r + "The UseInputMask option requires the Input Mask Plugin. Get it from digitalbush.com"),
                !1;
            if (null !== e.Position && !H)
                return alert(D),
                !1;
            for (var i in I)
                if (null !== e[i] && -1 === a.inArray(e[i], I[i]))
                    return alert(E.replace(/%/, i) + I[i]),
                    !1;
            this._isMonthInputType = "month" === b.attr("type"),
            this._isMonthInputType && (this.options.MonthFormat = this.MonthInputFormat,
            b.css("width", "auto"));
            ...
            this._prevButton = a(".month-picker-previous>a", k).jqueryUIButton({
                text: !1
            }).removeClass(A),
            this._nextButton = a(".month-picker-next>a", k).jqueryUIButton({
                text: !1
            }).removeClass(A),
            ...
            l ? this.Open() : (b.addClass(u),
            b.change(L(this._updateAlt, this)))
        },
        ...
        Validate: function() {
            var a = this.GetSelectedDate();
            return null === this.options.ValidationErrorMessage || this.options.Disabled || this._validationMessage.toggle(!a),
            a
        },
        ...
        Open: function(b) {
            ...
            if (!e.Disabled && !this._visible) {
                ...
                if (this._showMonths(),
                o(d))
                    f.css("position", "static").show(),
                    k("OnAfterMenuOpen", this)();
                else {
                    G && G.Close(b),
                    G = this,
                    a(c).on("mousedown" + t + this.uuid, L(this.Close, this)).on("keydown" + t + this.uuid, L(this._keyDown, this)),
                    d.off("blur" + t).focus();
        ...
        Close: function(b) {
            ...
            if (!o(d) && this._visible) {
                ...
                k("OnBeforeMenuClose", this)(b) === !1 || b.isDefaultPrevented())
                    return;
                this._backToYear && (this._applyJumpYearsHint(),
                this._backToYear = 0),
                this._visible = !1,
                G = null,
                a(c).off("keydown" + t + this.uuid).off("mousedown" + t + this.uuid),
                this.Validate(),
        ...
        _setSelectedMonth: function(a) {
            var b = j(this, a)
              , c = this.element;
            b ? c.val(this._formatMonth(new d(f(b),b % 12,1))) : c.val(""),
        ...
        _i18n: function(b) {
            return this.options.i18n[b] || a.MonthPicker.i18n[b]
        },
        ...
        _createButton: function() {
            ...
            if (!o(b)) {
                ...
                this._monthPickerButton = (f instanceof a ? f : a(f)).each(function() {
                    a.contains(c.body, this) || (h = !0,
                    a(this).insertAfter(b))
        ...
        _updateFieldEvents: function() {
            var a = N + " focus" + t;
            this.element.off(a),
            "both" !== this.options.ShowOn && this._monthPickerButton.length || this.element.on(a, L(this.Open, this))
        },
        ...
        : function(a) {
            ...
            return this.options.IsRTL ? c.left = b.offset().left - a.width() + b.width() + 7 + "px" : c.left = b.offset().left + "px",
            a.css(c)
        }
        ,
        ...
        _showYears: function() {
            ...
            for (var o = this.GetSelectedYear(), p = L(this._onYearClick, this), r = i(j, m, n), s = i(o, m, n), u = 0; 12 > u; u++) {
                ...
                s && o && o === v && (this._selectedBtn = h(w, !0)),
                c++
            }
        },
